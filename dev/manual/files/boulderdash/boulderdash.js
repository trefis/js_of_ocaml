...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _l_=caml_new_string("nth"),
     _m_=caml_new_string("List.nth"),
     _p_=caml_new_string("String.blit / Bytes.blit_string"),
     _o_=caml_new_string("Bytes.blit"),
     _n_=caml_new_string("String.sub / Bytes.sub"),
     _q_=caml_new_string("String.index_from / Bytes.index_from"),
     _r_=caml_new_string("Stdlib.Queue.Empty"),
     ...
     _S_=[0,caml_new_string("camlinternalFormat.ml"),846,23],
     _ab_=[0,caml_new_string("camlinternalFormat.ml"),810,21],
     _V_=[0,caml_new_string("camlinternalFormat.ml"),811,21],
     _ac_=[0,caml_new_string("camlinternalFormat.ml"),814,21],
     _W_=[0,caml_new_string("camlinternalFormat.ml"),815,21],
     _ad_=[0,caml_new_string("camlinternalFormat.ml"),818,19],
     _X_=[0,caml_new_string("camlinternalFormat.ml"),819,19],
     _ae_=[0,caml_new_string("camlinternalFormat.ml"),822,22],
     _Y_=[0,caml_new_string("camlinternalFormat.ml"),823,22],
     _af_=[0,caml_new_string("camlinternalFormat.ml"),827,30],
     _Z_=[0,caml_new_string("camlinternalFormat.ml"),828,30],
     _$_=[0,caml_new_string("camlinternalFormat.ml"),832,26],
     _T_=[0,caml_new_string("camlinternalFormat.ml"),833,26],
     _aa_=[0,caml_new_string("camlinternalFormat.ml"),842,28],
     _U_=[0,caml_new_string("camlinternalFormat.ml"),843,28],
     ___=[0,caml_new_string("camlinternalFormat.ml"),847,23],
     _bc_=caml_new_string("%u"),
     _ba_=[0,caml_new_string("camlinternalFormat.ml"),1525,4],
     _bb_=caml_new_string("Printf: bad conversion %["),
     _bd_=[0,caml_new_string("camlinternalFormat.ml"),1593,39],
     _be_=[0,caml_new_string("camlinternalFormat.ml"),1616,31],
     _bf_=[0,caml_new_string("camlinternalFormat.ml"),1617,31],
     ...
     _bK_=caml_new_string("[\\][()\\\\|+*.?{}^$]"),
     _bR_=caml_new_string("table"),
     _bQ_=caml_new_string("img"),
     _bP_=caml_new_string("br"),
     _bO_=caml_new_string("h1"),
     _bN_=caml_new_string("div"),
     _bM_=caml_new_string("select"),
     _bL_=caml_new_string("option"),
     ...
     _bX_=
      caml_new_string
       ("^([Ff][Ii][Ll][Ee])://([^\\?#]*)(\\?([^#]*))?(#(.*))?$"),
     _b1_=[0,caml_new_string("lib/js_of_ocaml/xmlHttpRequest.ml"),86,2],
     ...
     _cl_=caml_new_string("Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers"),
     _ct_=[0,[8,9,0,0,0],caml_new_string("%g")],
     _cu_=caml_new_string("malformed level"),
     _cv_=caml_new_string("Boulder Dash in Ocaml"),
     _cw_=caml_new_string("Elapsed time: "),
     _cx_=caml_new_string(" Remaining diamonds: "),
     _cy_=caml_new_string(" "),
     _cz_=caml_new_string("Choose a level"),
     _cr_=[0,caml_new_string("examples/boulderdash/boulderdash.ml"),322,72],
     _cs_=caml_new_string("--"),
     _cA_=caml_new_string("maps.txt"),
     _co_=
      [0,
       [4,0,[0,2,2],0,[12,58,[4,0,[0,2,2],0,[12,58,[4,0,[0,2,2],0,0]]]]],
       caml_new_string("%02d:%02d:%02d")],
     _cn_=caml_new_string("--:--:--"),
     _cm_=caml_new_string("LOADING..."),
     _cp_=caml_new_string("Boulderdash.Death"),
     _cq_=caml_new_string("Boulderdash.Eos");
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_hR_ = caml_wrap_exception(_hR_);
              if(_hR_[1] !== Sys_error)throw _hR_}
            var param$0=l;
            continue}
          return 0}}
    ...
    function map$0(f,a)
     {var l=a.length - 1;
      if(0 === l)return [0];
      var r=caml_make_vect(l,caml_call1(f,a[1])),_hP_=l - 1 | 0,_hO_=1;
      if(! (_hP_ < 1))
       {var i=_hO_;
        for(;;)
     ...
     {if(typeof formatting_lit === "number")
       ...
       switch(formatting_lit[0])
        {case 0:var str=formatting_lit[1];return str;
         ...
         default:var c=formatting_lit[1];return _a_(_A_,make$0(1,c))}}
       ...
       switch(ty1[0])
        {case 0:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_g6_,rest2)];
         ...
         case 1:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_g7_,rest2$0)];
         ...
         case 2:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_g8_,rest2$1)];
         ...
         case 3:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_g9_,rest2$2)];
         ...
         case 4:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_g__,rest2$3)];
         ...
         case 5:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_g$_,rest2$4)];
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_ha_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_hb_,rest2$6)];
         ...
         case 8:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_he_=trans(_hc_,rest2$7);
              return [8,trans(_hd_,ty2),_he_];
            ...
            {case 8:var switch$0=5,switch$10=0;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_hg_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_hh_,ty22,trans(_hf_,rest2$8)];
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_hi_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_hj_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_hk_,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_hl_,rest2$12)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$14=0;break;
             ...
             case 14:var rest2$13=match[1];return [14,trans(_hm_,rest2$13)];
        ...
        {case 0:
         ...
         case 2:
          ...
          if(typeof _gB_ !== "number" && 1 === _gB_[0])
           {var
             ...
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_gC_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _gD_=type_padding(pad$0,fmtty),
           _gE_=_gD_[2],
           _gF_=_gD_[1];
         ...
         case 4:
          var
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _gG_=type_padprec(pad$1,prec,fmtty),
           _gH_=_gG_[3],
           _gI_=_gG_[2],
           _gJ_=_gG_[1];
          if(typeof _gH_ !== "number" && 2 === _gH_[0])
           {var
             fmtty_rest$3=_gH_[1],
             match$3=type_format_gen(fmt_rest$3,fmtty_rest$3),
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_gJ_,_gI_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _gK_=type_padprec(pad$2,prec$0,fmtty),
           _gL_=_gK_[3],
           _gM_=_gK_[2],
           _gN_=_gK_[1];
          if(typeof _gL_ !== "number" && 3 === _gL_[0])
           {var
             fmtty_rest$4=_gL_[1],
             match$4=type_format_gen(fmt_rest$4,fmtty_rest$4),
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_gN_,_gM_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _gO_=type_padprec(pad$3,prec$1,fmtty),
           _gP_=_gO_[3],
           _gQ_=_gO_[2],
           _gR_=_gO_[1];
          if(typeof _gP_ !== "number" && 4 === _gP_[0])
           {var
             fmtty_rest$5=_gP_[1],
             match$5=type_format_gen(fmt_rest$5,fmtty_rest$5),
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_gR_,_gQ_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _gS_=type_padprec(pad$4,prec$2,fmtty),
           _gT_=_gS_[3],
           _gU_=_gS_[2],
           _gV_=_gS_[1];
          if(typeof _gT_ !== "number" && 5 === _gT_[0])
           {var
             ...
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_gV_,_gU_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _gW_=type_padprec(pad$5,prec$3,fmtty),
           _gX_=_gW_[3],
           _gY_=_gW_[2],
           _gZ_=_gW_[1];
          if(typeof _gX_ !== "number" && 6 === _gX_[0])
           {var
             fmtty_rest$7=_gX_[1],
             match$7=type_format_gen(fmt_rest$7,fmtty_rest$7),
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_gZ_,_gY_,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           pad$6=fmt[1],
           _g0_=type_padding(pad$6,fmtty),
           _g1_=_g0_[2],
           _g2_=_g0_[1];
          if(typeof _g1_ !== "number" && 7 === _g1_[0])
           {var
             fmtty_rest$8=_g1_[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _g3_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_g3_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _g4_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_g4_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_g4_[1];
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _gy_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_gy_))
             throw Type_mismatch;
            var _gz_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_gz_))
             throw Type_mismatch;
            var
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           _gv_=match$0 - 32 | 0,
           switch$0=
            59 < _gv_ >>> 0?33 < (_gv_ - 61 | 0) >>> 0?1:0:2 === _gv_?1:0;
            ...
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0);
              if(32 <= match)
               {var _gs_=match - 34 | 0;
                if(58 < _gs_ >>> 0)
                 if(93 <= _gs_)var switch$1=0,switch$2=0;else var switch$2=1;
                else
                 if(56 < (_gs_ - 1 | 0) >>> 0)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 0:var _gm_=_ah_;break;
        case 1:var _gm_=_ai_;break;
        case 2:var _gm_=_aj_;break;
        case 3:var _gm_=_ak_;break;
        case 4:var _gm_=_al_;break;
        case 5:var _gm_=_am_;break;
        case 6:var _gm_=_an_;break;
        case 7:var _gm_=_ao_;break;
        case 8:var _gm_=_ap_;break;
        case 9:var _gm_=_aq_;break;
        case 10:var _gm_=_ar_;break;
        case 11:var _gm_=_as_;break;
        default:var _gm_=_at_}
      return caml_format_int(_gm_,n)}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 0:var _gl_=_aH_;break;
        case 1:var _gl_=_aI_;break;
        case 2:var _gl_=_aJ_;break;
        case 3:var _gl_=_aK_;break;
        case 4:var _gl_=_aL_;break;
        case 5:var _gl_=_aM_;break;
        case 6:var _gl_=_aN_;break;
        case 7:var _gl_=_aO_;break;
        case 8:var _gl_=_aP_;break;
        case 9:var _gl_=_aQ_;break;
        case 10:var _gl_=_aR_;break;
        case 11:var _gl_=_aS_;break;
        default:var _gl_=_aT_}
      return caml_format_int(_gl_,n)}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 0:var _gk_=_aU_;break;
        case 1:var _gk_=_aV_;break;
        case 2:var _gk_=_aW_;break;
        case 3:var _gk_=_aX_;break;
        case 4:var _gk_=_aY_;break;
        case 5:var _gk_=_aZ_;break;
        case 6:var _gk_=_a0_;break;
        case 7:var _gk_=_a1_;break;
        case 8:var _gk_=_a2_;break;
        case 9:var _gk_=_a3_;break;
        case 10:var _gk_=_a4_;break;
        case 11:var _gk_=_a5_;break;
        default:var _gk_=_a6_}
      return caml_format_int(_gk_,n)}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 0:var _gj_=_au_;break;
        case 1:var _gj_=_av_;break;
        case 2:var _gj_=_aw_;break;
        case 3:var _gj_=_ax_;break;
        case 4:var _gj_=_ay_;break;
        case 5:var _gj_=_az_;break;
        case 6:var _gj_=_aA_;break;
        case 7:var _gj_=_aB_;break;
        case 8:var _gj_=_aC_;break;
        case 9:var _gj_=_aD_;break;
        case 10:var _gj_=_aE_;break;
        case 11:var _gj_=_aF_;break;
        default:var _gj_=_aG_}
      return caml_int64_format(_gj_,n)}
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,o,acc$0,rest$19,arity,_f5_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,o,acc$0,rest$19,arity,_f5_])}}
    ...
    function make_invalid_arg(counter,k,o,acc,fmt)
     {var _f2_=[8,acc,_bg_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_f2_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_f2_,fmt])}
    function make_custom$0(counter,k,o,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_f1_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_f1_,rest])}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_fW_=0;
      return make_printf
              (function(o,acc){output_acc(o,acc);return 0},oc,_fW_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bo_;
      ...
      return caml_call2(sprintf(_bp_),_fV_,_fU_)}
    function fields(x)
     {var match=x.length - 1;
      if(2 < match >>> 0)
       {var _fR_=other_fields(x,2),_fS_=field(x,1);
        return caml_call2(sprintf(_bq_),_fS_,_fR_)}
      switch(match)
       {case 0:return _br_;
        case 1:return _bs_;
        default:var _fT_=field(x,1);return caml_call1(sprintf(_bt_),_fT_)}}
           ...
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _fF_=slot[4],
              _fG_=slot[3],
              _fH_=slot[6]?_bD_:_bF_,
              _fI_=slot[2],
              _fJ_=info(slot[1]),
              match=
               [0,caml_call6(sprintf(_bE_),_fJ_,_fI_,_fH_,_fG_,_fF_,_fE_)];
            else
             if(slot[1])
              var match=0;
             else
              var _fK_=info(0),match=[0,caml_call1(sprintf(_bG_),_fK_)];
    ...
    function unsafeCreateElementEx(type,name,doc,elt)
     {for(;;)
       {if(0 === type)if(0 === name)return createElement(doc,elt);
        ...
        return res}}
    function createOption(doc){return unsafeCreateElement(doc,_bL_)}
    function createDiv(doc){return unsafeCreateElement(doc,_bN_)}
    ...
    _a_(s,_a_(_cB_,git_version));
    var Local_exn=[248,_bS_,caml_fresh_oo_id(0)],overflow_limit=2147483e3;
    ...
    if(x !== t37)
     ...
     var
      t29="",
      t40=function(param,_fx_){return 0},
      t39=function(param,_fw_){return 0},
    ...
    (function(param)
       {try
         {var _fu_=[0,caml_int_of_string(caml_js_to_byte_string(_bY_.port))];
          return _fu_}
        catch(_fv_)
         {_fv_ = caml_wrap_exception(_fv_);
          if(_fv_[1] === Failure)return 0;
          throw _fv_}}
      (_bZ_));
    var
     s$1=urldecode_js_string_string(_bY_.pathname),
     l=caml_ml_string_length(s$1);
    function aux(i)
     {try
       {var _fs_=index_from(s$1,i,47),j=_fs_}
      catch(_ft_)
         ...
         try
          {var
            ...
            _fl_=
             function(s)
              {function _fq_(param)
                {var y=param[2],x=param[1],_fr_=urldecode_js_string_string(y);
                 return [0,urldecode_js_string_string(x),_fr_]}
               var index=s.indexOf(make$0(1,61).toString());
               if(0 <= index)
                var
                 _fo_=s.slice(index + 1 | 0),
                 _fp_=[0,s.slice(0,index),_fo_];
               else
                var _fp_=t37;
               return case$1(_fp_,interrupt,_fq_)},
            _fm_=aux$0([0,case$1(arr[idx$0],interrupt,_fl_),acc],_fk_);
           return _fm_}
         catch(_fn_)
       ...
       {try
         ...
         {try
           ...
           {try
            ...
            catch(_fj_){throw [0,Assert_failure,_b1_]}}}}}
    var Empty$0=[248,_b2_,caml_fresh_oo_id(0)];
       ...
       {case 1:return [0,_eV_];
        ...
        default:
         ...
         return run_callback_or_defer_it
                 (_ce_,function(param){return caml_call1(f,v)},_eW_)}}
          ...
          _eS_=
           function(param)
            {var
             ...
             return [0,p,callback,p$0[1]]};
         return run_callback_or_defer_it
                 (_cg_,function(param){return caml_call1(h,exn)},_eS_);
        case 2:
         var
          p_callbacks=_eR_[1],
          match=create_result_promise_and_callback_if_deferred(0),
      ...
      switch(_eP_[0])
       {case 1:
        ...
        case 2:
         ...
         return 0;
        default:return 0}}
    var pause_hook=[0,function(_eO_){return 0}],s1=create$0(0),_cj_=[0,0];
    ...
    var Wrong_headers=[248,_cl_,caml_fresh_oo_id(0)],doc=window.document;
    ...
    var
     ...
     Death=[248,_cp_,caml_fresh_oo_id(0)];
     ...
     {var changed=[0,0],_ee_=state[1].length - 1 - 2 | 0;
      if(! (_ee_ < 1))
       {var y=_ee_;
        for(;;)
         {var
           _eh_=caml_check_bound(state[1],y)[y + 1].length - 1 - 2 | 0,
           _eg_=1;
          if(! (_eh_ < 1))
           {var x=_eg_;
            for(;;)
             {var
               ...
               _ek_=
                6
                 ===
                 caml_check_bound(caml_check_bound(state[1],_ej_)[_ej_ + 1],x)
                  [x + 1]
                 ?1
                 :0,
               sustaining=
               ...
               {var
                 ...
                 _eq_=
                  0
                   ===
                   caml_check_bound
                     (caml_check_bound(state[1],_ep_)[_ep_ + 1],x)
                    [x + 1]
                   ?1
                   :0;
                if(_eq_)
                 {var
                   ...
                   _es_=
                    3
                     ===
                     caml_check_bound(caml_check_bound(state[1],y)[y + 1],_er_)
                      [_er_ + 1]
                     ?1
                     :0;
                  if(_es_)
                   var
                    ...
                    _ev_=
                     3
                      ===
                      caml_check_bound
                        (caml_check_bound(state[1],_eu_)[_eu_ + 1],_et_)
                       [_et_ + 1]
                      ?1
                      :0;
                  else
               ...
               {var
                 ...
                 _ey_=
                  0
                   ===
                   caml_check_bound
                     (caml_check_bound(state[1],_ex_)[_ex_ + 1],x)
                    [x + 1]
                   ?1
                   :0;
                if(_ey_)
                 {var
                   ...
                   _eA_=
                    3
                     ===
                     caml_check_bound(caml_check_bound(state[1],y)[y + 1],_ez_)
                      [_ez_ + 1]
                     ?1
                     :0;
                  if(_eA_)
                   var
                    ...
                    _eD_=
                     3
                      ===
                      caml_check_bound
                        (caml_check_bound(state[1],_eC_)[_eC_ + 1],_eB_)
                       [_eB_ + 1]
                      ?1
                      :0;
                  else
               ...
               var
                ...
                _eG_=
                 6
                  ===
                  caml_check_bound
                    (caml_check_bound(state[1],_eF_)[_eF_ + 1],x)
                   [x + 1]
                  ?1
                  :0,
                _eH_=
       ...
       {var _dj_=state[1].length - 1 - 1 | 0,_di_=0;
        if(! (_dj_ < 0))
         {var y$0=_di_;
          for(;;)
           {var
             _dm_=caml_check_bound(state[1],y$0)[y$0 + 1].length - 1 - 1 | 0,
             _dl_=0;
            if(! (_dm_ < 0))
             {var x$0=_dl_;
              for(;;)
                     ...
                     {if
                      ...
                      function _d$_(param)
                       {function _ea_(param)
                        ...
                        return bind(fall(state),_ea_)}
                      return bind(sleep(0.05),_d$_)}
                    return bind(caml_call1(click_cont,0),_d__)}
                  return click},
                              ...
                              (function(param)
                                {function _d9_(param)
                                  {if
                                   ...
                                   state[3] = [0,x,y];
                                   return fall(state)}
                                 return bind(caml_call1(click_cont,0),_d9_)},
                               _d8_),
                             _d7_)}
                  return click},
       ...
       {var body=doc.getElementById("boulderdash");
         ...
         {var div=createDiv(doc);
          ...
          function _c2_(data)
           {function _c3_(res){removeChild(body,div);return return$0(res)}
            return bind(caml_call1(process,data),_c3_)}
          return bind(getfile(name),_c2_)}
        ...
        function _cD_(levels)
         {body.style.cssText
          ...
          var h1=unsafeCreateElement(doc,_bO_);
          append_text(h1,_cv_);
          appendChild(body,h1);
          var div=createDiv(doc);
          ...
          var
           select=unsafeCreateElementEx(0,0,doc,_bM_),
                 ...
                 {var l=levels,n=n$1;
                  for(;;)
                   {if(l)
                     ...
                     var _cJ_=failwith(_l_);
                    break}}
                else
                 var _cJ_=invalid_arg(_m_);
                var _cK_=_cJ_[1];
                load_data
                 (_cK_,
                  function(data)
                   {var
                    ...
                    function _cU_(c)
                     {var img=unsafeCreateElement(doc,_bQ_);
                      img.src = img_assoc(c);
                      return img}
                    var
                     ...
                     style$0=[0,style],
                     table=unsafeCreateElement(doc,_bR_);
                     ...
                     {var t0=caml_sys_time(0);
                      function fade(param)
                       {var t=caml_sys_time(0);
                        ...
                        function _cZ_(param)
                         {var _c0_=caml_call1(sprintf(_ct_),t - t0).toString();
