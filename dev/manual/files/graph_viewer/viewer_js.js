...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _b__=caml_new_string("canvas"),
     _b8_=caml_new_string("p"),
     _b7_=caml_new_string("div"),
     _b9_=caml_new_string("Js_of_ocaml__Dom_html.Canvas_not_available"),
     ...
     _ce_=
      caml_new_string
       ("^([Ff][Ii][Ll][Ee])://([^\\?#]*)(\\?([^#]*))?(#(.*))?$"),
     _ci_=[0,caml_new_string("lib/js_of_ocaml/xmlHttpRequest.ml"),86,2],
     _cu_=[0,0],
     _cv_=[0,1],
     _cs_=[0,0],
     _ct_=[0,1],
     ...
     _cy_=caml_new_string("Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers"),
     _cB_=[0,0,0],
     _cE_=[0,caml_new_string("examples/graph_viewer/viewer_common.ml"),290,10],
     _cF_=[0,caml_new_string("examples/graph_viewer/viewer_common.ml"),293,10],
     _cC_=[0,caml_new_string("examples/graph_viewer/viewer_common.ml"),297,8],
     _cD_=[0,caml_new_string("examples/graph_viewer/viewer_common.ml"),300,8],
     _cz_=[0,caml_new_string("examples/graph_viewer/viewer_common.ml"),152,65],
     _c6_=[0,[4,0,0,0,[11,caml_new_string("px"),0]],caml_new_string("%dpx")],
     _c2_=[0,0],
     _c3_=[0,0],
     _c4_=[0,1],
     _c5_=[0,20],
     _c7_=caml_new_string("scene.json"),
     _cG_=[0,caml_new_string("examples/graph_viewer/viewer_js.ml"),138,26];
     ...
     {function height(param){if(param){var h=param[5];return h}return 0}
      ...
      function max_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _hO_=param$0[4],_hP_=param$0[3],_hQ_=param$0[2];
      ...
      function max_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _hL_=param$0[4],_hM_=param$0[3],_hN_=param$0[2];
            if(_hL_){var param$0=_hL_;continue}
            return [0,[0,_hN_,_hM_]]}
          return 0}}
         ...
         {var _hK_=param[1];
          if(_hK_)
           {var r=param[4],d=param[3],v=param[2];
            return bal(remove_min_binding(_hK_),v,d,r)}
          var r$0=param[4];
          return r$0}
        return invalid_arg(_x_)}
      function _hn_(t,match)
       {if(t)
         {if(match)
        ...
        for(;;)
         {if(param$0)
           {var
            ...
            if(_hH_)
             {var _hI_=for_all(p,l);
              if(_hI_){var param$0=r;continue}
              var _hJ_=_hI_}
            else
             var _hJ_=_hH_;
            return _hJ_}
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _hE_=caml_call2(p,v,d);
            if(_hE_)
             var _hF_=_hE_;
            else
             {var _hG_=exists(p,l);
              if(! _hG_){var param$0=r;continue}
              var _hF_=_hG_}
            return _hF_}
          return 0}}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _hA_=merge(f,r1,r2),
             _hB_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_hB_,_hA_)}}
        else
         if(! s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _hC_=merge(f,r1$0,r2$0),
           _hD_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_hD_,_hC_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _hy_=concat(lf,rf);return [0,join(lt,v,d,rt),_hy_]}
          var _hz_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_hz_]}
        return _A_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _hv_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_hv_)
               {var _hw_=caml_call2(cmp,d1,d2);
                if(_hw_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_hu_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _hu_ | 0}
        return 0}
      ...
      function seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_hs_=cons_enum(t,rest);
          return [0,[0,k,v],function(_ht_){return seq_of_enum(_hs_,_ht_)}]}
        return 0}
      function to_seq(m)
       {var _hq_=cons_enum(m,0);
       ...
       {var m$0=m,c=0;
        for(;;)
         {if(m$0)
           ...
           var _ho_=c;
          return function(_hp_){return seq_of_enum(_ho_,_hp_)}}}
      return [0,
              empty,
              is_empty,
              mem,
    ...
    function add(x,q)
     {var cell=[0,x,0],_hm_=q[3];
      return _hm_
              ?(q[1] = q[1] + 1 | 0,_hm_[2] = cell,q[3] = cell,0)
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
         _gY_=function(param){return 0},
         _gZ_=function(param){return 0},
         _g0_=function(param){return 0};
        return [0,function(param){return 0},_g0_,_gZ_,_gY_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _g1_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_g1_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _g2_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _g3_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _g4_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _g5_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _g6_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _g7_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _g8_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _g9_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _g__=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _g$_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
       ...
       switch(ty1[0])
        {case 0:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_gF_,rest2)];
         ...
         case 1:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_gG_,rest2$0)];
         ...
         case 2:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_gH_,rest2$1)];
         ...
         case 3:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_gI_,rest2$2)];
         ...
         case 4:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_gJ_,rest2$3)];
         ...
         case 5:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_gK_,rest2$4)];
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_gL_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_gM_,rest2$6)];
          ...
          break;
         case 8:
          var _gN_=ty1[2],_gO_=ty1[1];
          if(typeof match === "number")
           var switch$9=1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_gP_=trans(_gN_,rest2$7);
              return [8,trans(_gO_,ty2),_gP_];
          ...
          break;
         case 9:
          var _gQ_=ty1[3],_gR_=ty1[2],_gS_=ty1[1];
          if(typeof match === "number")
           var switch$10=1;
          else
           switch(match[0])
            {case 8:var switch$0=5,switch$10=0;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_gR_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_gS_,ty22,trans(_gQ_,rest2$8)];
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_gT_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_gU_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_gV_,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_gW_,rest2$12)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$14=0;break;
             ...
             case 14:var rest2$13=match[1];return [14,trans(_gX_,rest2$13)];
      ...
      if(typeof prec === "number")
       {if(0 === prec)
        ...
        if(typeof _gE_ !== "number" && 2 === _gE_[0])
         {var rest$0=_gE_[1],pad$1=match[1];return [0,pad$1,1,rest$0]}
        throw Type_mismatch}
        ...
        {case 0:
         ...
         case 4:
          var
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _gf_=type_padprec(pad$1,prec,fmtty),
           _gg_=_gf_[3],
           _gh_=_gf_[2],
           _gi_=_gf_[1];
         ...
         case 5:
          var
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _gj_=type_padprec(pad$2,prec$0,fmtty),
           _gk_=_gj_[3],
           _gl_=_gj_[2],
           _gm_=_gj_[1];
         ...
         case 6:
          var
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _gn_=type_padprec(pad$3,prec$1,fmtty),
           _go_=_gn_[3],
           _gp_=_gn_[2],
           _gq_=_gn_[1];
         ...
         case 7:
          var
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _gr_=type_padprec(pad$4,prec$2,fmtty),
           _gs_=_gr_[3],
           _gt_=_gr_[2],
           _gu_=_gr_[1];
         ...
         case 8:
          var
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _gv_=type_padprec(pad$5,prec$3,fmtty),
           _gw_=_gv_[3],
           _gx_=_gv_[2],
           _gy_=_gv_[1];
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _gD_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_gD_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_gD_[1];
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _f9_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_f9_))
             throw Type_mismatch;
            var _f__=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_f__))
             throw Type_mismatch;
            var
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           _f6_=match$0 - 32 | 0,
           switch$0=
            59 < _f6_ >>> 0?33 < (_f6_ - 61 | 0) >>> 0?1:0:2 === _f6_?1:0;
            ...
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0);
              if(32 <= match)
               {var _f3_=match - 34 | 0;
                if(58 < _f3_ >>> 0)
                 if(93 <= _f3_)var switch$1=0,switch$2=0;else var switch$2=1;
                else
                 if(56 < (_f3_ - 1 | 0) >>> 0)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 0:var _fX_=_ar_;break;
        case 1:var _fX_=_as_;break;
        case 2:var _fX_=_at_;break;
        case 3:var _fX_=_au_;break;
        case 4:var _fX_=_av_;break;
        case 5:var _fX_=_aw_;break;
        case 6:var _fX_=_ax_;break;
        case 7:var _fX_=_ay_;break;
        case 8:var _fX_=_az_;break;
        case 9:var _fX_=_aA_;break;
        case 10:var _fX_=_aB_;break;
        case 11:var _fX_=_aC_;break;
        default:var _fX_=_aD_}
      return caml_format_int(_fX_,n)}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 0:var _fW_=_aR_;break;
        case 1:var _fW_=_aS_;break;
        case 2:var _fW_=_aT_;break;
        case 3:var _fW_=_aU_;break;
        case 4:var _fW_=_aV_;break;
        case 5:var _fW_=_aW_;break;
        case 6:var _fW_=_aX_;break;
        case 7:var _fW_=_aY_;break;
        case 8:var _fW_=_aZ_;break;
        case 9:var _fW_=_a0_;break;
        case 10:var _fW_=_a1_;break;
        case 11:var _fW_=_a2_;break;
        default:var _fW_=_a3_}
      return caml_format_int(_fW_,n)}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 0:var _fV_=_a4_;break;
        case 1:var _fV_=_a5_;break;
        case 2:var _fV_=_a6_;break;
        case 3:var _fV_=_a7_;break;
        case 4:var _fV_=_a8_;break;
        case 5:var _fV_=_a9_;break;
        case 6:var _fV_=_a__;break;
        case 7:var _fV_=_a$_;break;
        case 8:var _fV_=_ba_;break;
        case 9:var _fV_=_bb_;break;
        case 10:var _fV_=_bc_;break;
        case 11:var _fV_=_bd_;break;
        default:var _fV_=_be_}
      return caml_format_int(_fV_,n)}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 0:var _fU_=_aE_;break;
        case 1:var _fU_=_aF_;break;
        case 2:var _fU_=_aG_;break;
        case 3:var _fU_=_aH_;break;
        case 4:var _fU_=_aI_;break;
        case 5:var _fU_=_aJ_;break;
        case 6:var _fU_=_aK_;break;
        case 7:var _fU_=_aL_;break;
        case 8:var _fU_=_aM_;break;
        case 9:var _fU_=_aN_;break;
        case 10:var _fU_=_aO_;break;
        case 11:var _fU_=_aP_;break;
        default:var _fU_=_aQ_}
      return caml_int64_format(_fU_,n)}
     ...
     {if(16 <= fconv)
        ...
        if(19 <= fconv)
         {var s=caml_bytes_of_string(s$0),l=caml_ml_bytes_length(s);
          if(0 === l)
           ...
           {var r=caml_create_bytes(l),_fN_=l - 1 | 0,_fM_=0;
            if(! (_fN_ < 0))
             {var i=_fM_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s,i);
                if(97 <= c)
                 if(122 < c)
                  ...
                  var _fO_=c - 32 | 0,switch$1=1;
                else
                 var switch$1=0;
                if(! switch$1)var _fO_=c;
                caml_bytes_unsafe_set(r,i,_fO_);
                var _fP_=i + 1 | 0;
      ...
      if(15 === fconv)
       ...
       {var prec=abs(prec$0);
        ...
        var _fR_=buffer_contents(buf)}
      var str=caml_format_float(_fR_,x);
      if(15 === fconv)
        ...
        for(;;)
         {if(i$0 === len)
           ...
           {var
             ...
             _fS_=match - 46 | 0,
             switch$2=
              23 < _fS_ >>> 0?55 === _fS_?1:0:21 < (_fS_ - 1 | 0) >>> 0?1:0;
            if(! switch$2){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
            var _fT_=1}
          return _fT_?str:_a_(str,_bj_)}}
      return str}
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _fF_=pad$5[2],_fG_=pad$5[1];
               if(typeof prec$3 === "number")
                return 0 === prec$3
                        ?function(x)
                          {var
                            str=convert_float(fconv,default_float_precision,x),
                            str$0=fix_padding(_fG_,_fF_,str);
                           return make_printf(k$0,o,[4,acc$0,str$0],rest$7)}
                        :function(p,x)
                          {var str=fix_padding(_fG_,_fF_,convert_float(fconv,p,x));
                           return make_printf(k$0,o,[4,acc$0,str],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_fG_,_fF_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,o,[4,acc$0,str],rest$7)}}
             var _fH_=pad$5[1];
             if(typeof prec$3 === "number")
              return 0 === prec$3
                      ?function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision,x),
                          str$0=fix_padding(_fH_,w,str);
                         return make_printf(k$0,o,[4,acc$0,str$0],rest$7)}
                      :function(w,p,x)
                        {var str=fix_padding(_fH_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,o,[4,acc$0,str],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_fH_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,o,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _fI_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _fI_[2] === "number")
              {var fmt=_fI_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,o,acc$0,rest$19,arity,_fE_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,o,acc$0,rest$19,arity,_fE_])}}
    ...
    function make_invalid_arg(counter,k,o,acc,fmt)
     {var _fB_=[8,acc,_bq_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_fB_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_fB_,fmt])}
    function make_custom$0(counter,k,o,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_fA_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_fA_,rest])}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_fv_=0;
      return make_printf
              (function(o,acc){output_acc(o,acc);return 0},oc,_fv_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _by_;
      var _ft_=other_fields(x,i + 1 | 0),_fu_=field(x,i);
      return caml_call2(sprintf(_bz_),_fu_,_ft_)}
    function fields(x)
     {var match=x.length - 1;
      if(2 < match >>> 0)
       {var _fq_=other_fields(x,2),_fr_=field(x,1);
        return caml_call2(sprintf(_bA_),_fr_,_fq_)}
      switch(match)
       {case 0:return _bB_;
        case 1:return _bC_;
        default:var _fs_=field(x,1);return caml_call1(sprintf(_bD_),_fs_)}}
        ...
        for(;;)
         {if(param$0)
           {var tl=param$0[2],hd=param$0[1];
            try {var _fo_=caml_call1(hd,x),_fn_=_fo_}catch(_fp_){var _fn_=0}
            if(_fn_){var s=_fn_[1];return s}
            var param$0=tl;
            continue}
    ...
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _fl_=a.length - 1 - 1 | 0,_fk_=0;
        if(! (_fl_ < 0))
         {var i=_fk_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _fe_=slot[4],
              _ff_=slot[3],
              _fg_=slot[6]?_bN_:_bP_,
              _fh_=slot[2],
              _fi_=info(slot[1]),
              match=
               [0,caml_call6(sprintf(_bO_),_fi_,_fh_,_fg_,_ff_,_fe_,_fd_)];
            else
             if(slot[1])
              var match=0;
             else
              var _fj_=info(0),match=[0,caml_call1(sprintf(_bQ_),_fj_)];
    ...
    function f(s)
     {var accu=[0,0],_fa_=caml_ml_string_length(s) - 1 | 0,_e$_=0;
      if(! (_fa_ < 0))
       {var i=_e$_;
        for(;;)
         {var _fb_=caml_string_get(s,i);
          accu[1] = (223 * accu[1] | 0) + _fb_ | 0;
          var _fc_=i + 1 | 0;
    ...
    function new_table(pub_labels)
     {table_count[1]++;
      ...
      var _e5_=((fit_size(len) * 32 | 0) / 8 | 0) - 1 | 0;
      caml_check_bound(methods,1)[2] = _e5_;
      var _e7_=len - 1 | 0,_e6_=0;
      if(! (_e7_ < 0))
       {var i=_e6_;
        for(;;)
         {var
           _e9_=(i * 2 | 0) + 3 | 0,
           _e8_=caml_check_bound(pub_labels,i)[i + 1];
          caml_check_bound(methods,_e9_)[_e9_ + 1] = _e8_;
          var _e__=i + 1 | 0;
          if(_e7_ !== i){var i=_e__;continue}
          break}}
      return [0,initial_object_size,methods,Meths[1],Labs[1],0,0,Vars[1],0]}
    function resize$0(array,new_size)
     {var len=array[2].length - 1,_e2_=len < new_size?1:0;
      if(_e2_)
       {var
         ...
         switch$0=
          0 <= len
           ?(_e3_.length - 1 - len | 0) < 0
             ?0
             :(a2.length - 1 - len | 0) < 0
               ?0
               :(caml_array_blit(_e3_,0,a2,0,len),1)
           :0;
    ...
    function get_method_label(table,name)
     {try
       {var _e0_=caml_call2(Meths[27],name,table[3]);return _e0_}
      catch(_e1_)
    ...
    function new_variable(table,name)
     {try
       {var _eY_=caml_call2(Vars[27],name,table[7]);return _eY_}
      catch(_eZ_)
     ...
     {if(e.addEventListener === t37)
       {var
         ...
         callback=
          function(e)
           {var _eV_=[0,h,e,[0]];
            return function(_eW_,_eX_){return caml_js_call(_eV_,_eW_,_eX_)}};
    ...
    function createDiv(doc){return unsafeCreateElement(doc,_b7_)}
    var Canvas_not_available=[248,_b9_,caml_fresh_oo_id(0)];
    function createCanvas(doc)
     {var c=unsafeCreateElement(doc,_b__);
         ...
         {var
          ...
          try
           {var
             ...
             _eT_=function(callback){return req(callback)};
            return _eT_}
          catch(_eU_)
    ...
    _a_(s$0,_a_(_c8_,git_version));
    var Local_exn=[248,_b$_,caml_fresh_oo_id(0)],overflow_limit=2147483e3;
    function interrupt(param){throw Local_exn}
    regexp
     (caml_js_to_byte_string
       (caml_jsbytes_of_string(s$1).replace(quote_re,"\\$&")));
    ...
    if(test$0(window.location))
     ...
     var
      t29="",
      t40=function(param,_eS_){return 0},
      t39=function(param,_eR_){return 0},
    ...
    (function(param)
       {try
         {var _eP_=[0,caml_int_of_string(caml_js_to_byte_string(_cf_.port))];
          return _eP_}
        catch(_eQ_)
         {_eQ_ = caml_wrap_exception(_eQ_);
          if(_eQ_[1] === Failure)return 0;
          throw _eQ_}}
      (_cg_));
    var
     s$2=urldecode_js_string_string(_cf_.pathname),
     l$0=caml_ml_string_length(s$2);
    function aux(i)
     {try
       {var _eN_=index_from(s$2,i,47),j=_eN_}
      catch(_eO_)
         ...
         try
          {var
            ...
            _eG_=
             function(s)
              {function _eL_(param)
                {var y=param[2],x=param[1],_eM_=urldecode_js_string_string(y);
                 return [0,urldecode_js_string_string(x),_eM_]}
               var index=s.indexOf(make$0(1,61).toString());
               if(0 <= index)
                var
                 _eJ_=s.slice(index + 1 | 0),
                 _eK_=[0,s.slice(0,index),_eJ_];
               else
                var _eK_=t37;
               return case$1(_eK_,interrupt,_eL_)},
            _eH_=aux$0([0,case$1(arr[idx$0],interrupt,_eG_),acc],_eF_);
           return _eH_}
         catch(_eI_)
    ...
    function create(param)
     {var
      ...
      try
       {var _eA_=new xmlHttpRequest();return _eA_}
      catch(_eB_)
       {try
         {var _ez_=new activeXObject("Msxml2.XMLHTTP");return _ez_}
        catch(_eC_)
         {try
           {var _ey_=new activeXObject("Msxml3.XMLHTTP");return _ey_}
          catch(_eD_)
           {try
             {var _ex_=new activeXObject("Microsoft.XMLHTTP");return _ex_}
            catch(_eE_){throw [0,Assert_failure,_ci_]}}}}}
    caml_fresh_oo_id(0);
    function create$0(param)
     {var seq=[];caml_update_dummy(seq,[0,seq,seq]);return seq}
    var compare$2=caml_compare,Storage_map=_B_([0,compare$2]);
    ...
    function handle_with_async_exception_hook(f,v)
     {try
       {var _ev_=caml_call1(f,v);return _ev_}
      catch(exn)
    ...
    function run_callbacks(callbacks,result)
     {if(1 === result[0])
       var _et_=result[1] === Canceled?1:0,is_canceled=_et_;
      else
       var is_canceled=0;
      if(is_canceled)
       {var
        ...
        iter_callback_list(_er_,0)}
      var _es_=callbacks[1];
      ...
      return iter_callback_list$0(_es_,0)}
    var
      ...
      if(1 === current_callback_nesting_depth[1])
       for(;;)
        {if(0 !== deferred_callbacks[1])
          {var _eo_=deferred_callbacks[2];
           if(_eo_)
            {var _ep_=_eo_[1],_eq_=_eo_[2];
             if(_eq_)
              {deferred_callbacks[1] = deferred_callbacks[1] - 1 | 0;
               deferred_callbacks[2] = _eq_}
             else
              {deferred_callbacks[1] = 0;
               deferred_callbacks[2] = 0;
               deferred_callbacks[3] = 0}
             var result=_ep_[2],callbacks=_ep_[1];
    ...
    function wakeup_general(api_function_name,p,result)
     {var p$0=underlying(p),_en_=p$0[1];
      switch(_en_[0])
       {case 1:
         return _en_[1] === Canceled
                 ?0
      ...
      switch(_em_[0])
       {case 1:return resolve(_cr_,0,outer_promise,p[1]);
        case 2:
         ...
         var
          _ek_=p_callbacks[2],
          _el_=outer_callbacks[2],
          cancel_callbacks=
           typeof _el_ === "number"
            ?_ek_
            :typeof _ek_ === "number"?_el_:[0,_el_,_ek_];
       ...
       {var p=new_pending([0,p$0]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
          ...
          try
           {var _ej_=caml_call1(f,v),p$0=_ej_}
       ...
       {case 1:return [0,_eh_];
        case 2:
         var
          ...
          node$0=[1,callback],
          _eg_=p_callbacks[1],
          node=typeof _eg_ === "number"?node$0:[0,node$0,_eg_];
         p_callbacks[1] = node;
         return p$1;
        default:
         var
         ...
         return run_callback_or_defer_it
                 (_ct_,function(param){return caml_call1(f,v)},_ei_)}}
    function on_cancel(p,f)
     {var p$0=underlying(p),_ee_=p$0[1];
      switch(_ee_[0])
       {case 1:
         if(_ee_[1] === Canceled)
          {var
        ...
        case 2:
         ...
         return 0;
        default:return 0}}
    var pause_hook=[0,function(_ed_){return 0}],s1=create$0(0),_cw_=[0,0];
    ...
    var Wrong_headers=[248,_cy_,caml_fresh_oo_id(0)],white="white";
    ...
    function put_pixmap(param,x,y,xsrc,ysrc,width,height,_eb_)
     {var p=_eb_[1],c=param[2];
      return c.drawImage(p,xsrc,ysrc,width,height,x,y,width,height)}
    function get_pixmap(pm)
     {var _ea_=pm[1];
      if(_ea_){var p=_ea_[1];return p}
    ...
    function _cA_(st,scale,x$2,y$2,x$1,y$1,w,h)
     {var ctx=get_pixmap(st[8])[2];
      ctx.save();
      var
       _d7_=0 === st[1].length - 1?1:0,
       _d8_=_d7_?0 < st[2].length - 1?1:0:_d7_;
      if(_d8_)throw [0,Assert_failure,_cG_];
      ctx.beginPath();
       ...
       {var i$0=_d9_;
        for(;;)
         {var
           ...
           _d3_=x1$0 <= x4?1:0;
          if(_d3_)
           {var _d4_=y1$0 <= y4?1:0;
            if(_d4_)
             var _d5_=x3$0 <= x2$0?1:0,_d6_=_d5_?y3$0 <= y2$0?1:0:_d5_;
            else
             var _d6_=_d4_}
          else
           var _d6_=_d3_;
          ...
          var _d$_=i$0 + 1 | 0;
          if(_d__ !== i$0){var i$0=_d$_;continue}
          break}}
      return ctx.restore()}
    var json=JSON;
      ...
      for(;;)
       {if(param)
        ...
        var
         headers$0=
          function(s)
           {function _dY_(v){return [0,caml_js_to_string(v)]}
            function _dZ_(param){return 0}
            return case$0
                    (req.getResponseHeader(caml_jsbytes_of_string(s)),_dZ_,_dY_)},
         st=[0,382334108],
         do_check_headers=
          function(param)
           {if(382334108 === st[1])
                  ...
                  _dV_=
                   function(param)
                    {var x=req.responseXML;
                     function _dX_(x){return [0,x]}
                     var match=case$0(x,function(param){return 0},_dX_);
                     if(match)
                      {var doc=match[1];
    ...
    if(public_methods === 0)
     ...
     {var l=public_methods.length - 1;
      if(0 === l)
       ...
       {var r=caml_make_vect(l,f(public_methods[1])),_r_=l - 1 | 0,_q_=1;
        if(! (_r_ < 1))
         {var i=_q_;
          for(;;)
           {r[i + 1] = f(public_methods[i + 1]);
            var _s_=i + 1 | 0;
    ...
    if(! (_bV_ < 0))
     {var i$1=_bU_;
      for(;;)
       {var
         _b1_=
          get_method_label(table$0,caml_check_bound(meths,i$1)[i$1 + 1]);
        caml_check_bound(res,i$1)[i$1 + 1] = _b1_;
        var _b2_=i$1 + 1 | 0;
    ...
    if(! (_bX_ < 0))
     {var i$0=_bW_;
      for(;;)
       {var
         _bZ_=i$0 + nmeths | 0,
         _bY_=new_variable(table$0,caml_check_bound(vals,i$0)[i$0 + 1]);
        caml_check_bound(res,_bZ_)[_bZ_ + 1] = _bY_;
        var _b0_=i$0 + 1 | 0;
    ...
    function _cV_(self_1,lower,upper,step_incr,page_incr,page_size,param)
     {if(lower){var v=lower[1];self_1[_cQ_ + 1] = v}
      if(upper){var v$0=upper[1];self_1[_cR_ + 1] = v$0}
      if(step_incr){var v$1=step_incr[1];self_1[_cS_ + 1] = v$1}
      if(page_incr){var v$2=page_incr[1];self_1[_cT_ + 1] = v$2}
      if(page_size){var v$3=page_size[1];self_1[_cU_ + 1] = v$3;return 0}
      return 0}
    function _cW_(self_1,v){self_1[_cP_ + 1] = v;return 0}
    function _cX_(self_1){return self_1[_cU_ + 1]}
    function _cY_(self_1){return self_1[_cT_ + 1]}
    function _cZ_(self_1){return self_1[_cS_ + 1]}
    function _c0_(self_1){return self_1[_cR_ + 1]}
    function _c1_(self_1){return self_1[_cQ_ + 1]}
    var
     methods=
      [0,
       _cH_,
       function(self_1){return self_1[_cP_ + 1]},
       _cO_,
       _c1_,
       _cI_,
       _c0_,
    ...
    for(;;)
     {if(i$2[1] < len)
       {var
         _b4_=i$2[1],
         label=caml_check_bound(methods,_b4_)[_b4_ + 1],
         next=
          function(param)
           {i$2[1]++;
            var _dQ_=i$2[1];
            return caml_check_bound(methods,_dQ_)[_dQ_ + 1]},
         clo=next(0);
           ...
           case 19:
            var
             ...
             clo$0=
              function(n,m)
                {return function(obj)
                  {var _dO_=caml_call1(obj[1][m + 1],obj);
                   return caml_call2(obj[1][n + 1],obj,_dO_)}}
               (n$15,m$1);
            break;
           case 20:
            var
           ...
           default:
            var
             ...
             clo$0=
              function(m,n,c)
                {return function(obj)
                  {var _dP_=caml_call1(obj[1][n + 1],obj);
                        ...
                        (doc,
                         ...
                         handler
                          (function(param)
                            {f$11(c1);
                             var _dJ_=c2[1];
                             if(1 - (_dJ_ == no_handler?1:0))f$11(_dJ_);
        ...
        handler
         (function(param)
           {var page=doc.documentElement;
            ...
            var started=[0,0],p=unsafeCreateElement(doc,_b8_);
            ...
            on_cancel
             (t,
              function(param)
               {var _dG_=id[1];
                if(_dG_)
                 {var x=_dG_[1];id[1] = 0;return window.clearTimeout(x)}
                return 0});
            bind(t,_c9_);
            function _c__(s)
             {var
               _c$_=json.parse(s.toString()),
               scene=_c$_[3],
               bboxes=_c$_[2],
               match=_c$_[1],
               y2=match[4],
              ...
              function get_scale(param)
               {var _dF_=st[3];
                return Math.pow
                        (2,
                         caml_call1(caml_get_public_method(sadj,834174833,366),sadj)
                         /
                         8)
                       /
                       _dF_}
              ...
              function update_view(force)
               {var
                 ...
                 _dq_=[0,min(aw,st[6])];
                caml_call7
                 (caml_get_public_method(hadj,-635267918,367),
                  hadj,
                  0,
                  [0,st[6]],
                  [0,aw / 20],
                ...
                var
                 _dr_=
                  caml_call1(caml_get_public_method(hadj,307110897,368),hadj),
                 mv=st[6] - _dr_;
                if
                 (caml_call1(caml_get_public_method(hadj,834174833,369),hadj)
                  ...
                  0)
                 caml_call2
                  (caml_get_public_method(hadj,-659372076,370),hadj,0);
                if
                 (mv
                  <
                  caml_call1(caml_get_public_method(hadj,834174833,371),hadj))
                 caml_call2
                  (caml_get_public_method(hadj,-659372076,372),hadj,mv);
                var _ds_=[0,min(ah,st[7])];
                caml_call7
                 (caml_get_public_method(vadj,-635267918,373),
                  vadj,
                  0,
                  [0,st[7]],
                  [0,ah / 20],
                ...
                if
                 (caml_call1(caml_get_public_method(vadj,834174833,375),vadj)
                  ...
                  0)
                 caml_call2
                  (caml_get_public_method(vadj,-659372076,376),vadj,0);
                if
                 (mv$0
                  <
                  caml_call1(caml_get_public_method(vadj,834174833,377),vadj))
                 caml_call2
                  (caml_get_public_method(vadj,-659372076,378),vadj,mv$0);
              ...
              caml_call7
               (caml_get_public_method(sadj,-635267918,365),
                sadj,
                0,
                [0,count],
                0,
              ...
              function rescale(x,y)
               {var
                 ...
                 _do_=
                  caml_call1(caml_get_public_method(hadj,307110897,381),hadj)
                  *
                  r
                  *
                  x;
                caml_call2
                 (caml_get_public_method(hadj,-659372076,383),
                  hadj,
                  caml_call1(caml_get_public_method(hadj,834174833,382),hadj)
                  +
                  _do_);
                var
                 _dp_=
                  caml_call1(caml_get_public_method(vadj,307110897,384),vadj)
                  *
                  r
                  *
                  y;
                caml_call2
                 (caml_get_public_method(vadj,-659372076,386),
                  vadj,
              ...
              function points(d)
               {return caml_call1(sprintf(_c6_),d).toString()}
              var
               size_px=points(size),
               pos=[0,height],
               thumb=createDiv(doc),
               ...
               {var _dm_=pos$0 !== pos[1]?1:0;
                if(_dm_)
                 {var _dn_=points(pos$0);
                  ...
                  pos[1] = pos$0;
                  caml_call2
                   (caml_get_public_method(sadj,-659372076,407),
                    sadj,
                    (284 - pos$0 | 0)
                    *
                    caml_call1(caml_get_public_method(sadj,675223906,406),sadj)
                    /
                    284);
               ...
               (window$0,
                function(dx,dy)
                 {var scale=get_scale(0);
                  function offset(a,d)
                   {var
                     _dk_=caml_call1(caml_get_public_method(a,307110897,420),a),
                     _dl_=
                      caml_call1(caml_get_public_method(a,675223906,421),a)
                      -
                      _dk_;
                    return caml_call2
                            (caml_get_public_method(a,-659372076,423),
                             a,
                             min
                              (caml_call1(caml_get_public_method(a,834174833,422),a)
                               -
                               d
                               /
                               scale,
              ...
              function bump_scale(x,y,v)
               {var
                 ...
                 y$0=y / a[4],
                 prev=
                  caml_call1(caml_get_public_method(sadj,834174833,424),sadj),
                 _di_=
                  prev
                  +
                  v
                  *
                  caml_call1(caml_get_public_method(sadj,-292814788,425),sadj),
                 _dj_=
                  max
                   (caml_call1
                     (caml_get_public_method(sadj,-117442047,426),sadj),
                    _di_),
                 vl=
                  min
                   (caml_call1(caml_get_public_method(sadj,675223906,427),sadj),
                    _dj_);
                if(vl != prev)
                 {caml_call2
                   (caml_get_public_method(sadj,-659372076,428),sadj,vl);
                  var
                   _dg_=
                   ...
                   pos$0=
                    284
                    -
                    (caml_call1(caml_get_public_method(sadj,834174833,411),sadj)
                     *
                     284
                     /
                     _dg_
               ...
               {var match=ev.keyCode,switcher=match - 37 | 0;
                ...
                switch(switcher)
                 {case 0:
                   var
                    _da_=
                     caml_call1(caml_get_public_method(hadj,-292814788,432),hadj);
                   caml_call2
                    (caml_get_public_method(hadj,-659372076,434),
                     hadj,
                     caml_call1(caml_get_public_method(hadj,834174833,433),hadj)
                     -
                     _da_);
                   update_view(0);
                   return false$0;
                  case 1:
                   var
                    _db_=
                     caml_call1(caml_get_public_method(vadj,-292814788,435),vadj);
                   caml_call2
                    (caml_get_public_method(vadj,-659372076,437),
                     vadj,
                     caml_call1(caml_get_public_method(vadj,834174833,436),vadj)
                     -
                     _db_);
                   update_view(0);
                   return false$0;
