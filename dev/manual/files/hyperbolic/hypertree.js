// Generated by js_of_ocaml 3.3.0+git-917b14cc4
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     s$0=caml_new_string("3.3.0"),
     git_version=caml_new_string("917b14cc4"),
     names=
      [0,
    ...
    var
     ...
     _ak_=[0,caml_new_string("camlinternalFormat.ml"),810,21],
     _ac_=[0,caml_new_string("camlinternalFormat.ml"),811,21],
     _al_=[0,caml_new_string("camlinternalFormat.ml"),814,21],
     _ad_=[0,caml_new_string("camlinternalFormat.ml"),815,21],
     _am_=[0,caml_new_string("camlinternalFormat.ml"),818,19],
     _ae_=[0,caml_new_string("camlinternalFormat.ml"),819,19],
     _an_=[0,caml_new_string("camlinternalFormat.ml"),822,22],
     _af_=[0,caml_new_string("camlinternalFormat.ml"),823,22],
     _ao_=[0,caml_new_string("camlinternalFormat.ml"),827,30],
     _ag_=[0,caml_new_string("camlinternalFormat.ml"),828,30],
     _ai_=[0,caml_new_string("camlinternalFormat.ml"),832,26],
     _aa_=[0,caml_new_string("camlinternalFormat.ml"),833,26],
     _aj_=[0,caml_new_string("camlinternalFormat.ml"),842,28],
     ...
     _bj_=[0,caml_new_string("camlinternalFormat.ml"),1525,4],
     _bk_=caml_new_string("Printf: bad conversion %["),
     _bm_=[0,caml_new_string("camlinternalFormat.ml"),1593,39],
     _bn_=[0,caml_new_string("camlinternalFormat.ml"),1616,31],
     _bo_=[0,caml_new_string("camlinternalFormat.ml"),1617,31],
     ...
     _b7_=caml_new_string("dt"),
     _b6_=caml_new_string("dd"),
     _b5_=caml_new_string("img"),
     _b4_=caml_new_string("a"),
     _b3_=caml_new_string("div"),
     _b2_=caml_new_string("li"),
     _b1_=caml_new_string("dl"),
     _b0_=caml_new_string("ul"),
     _bZ_=caml_new_string("button"),
     ...
     _ce_=
      caml_new_string
       ("^([Ff][Ii][Ll][Ee])://([^\\?#]*)(\\?([^#]*))?(#(.*))?$"),
     _ch_=[0,caml_new_string("lib/js_of_ocaml/xmlHttpRequest.ml"),86,2],
     _ct_=[0,0],
     _cu_=[0,1],
     _cr_=[0,0],
     _cs_=[0,1],
     ...
     _cK_=[0,0,0,0],
     _cL_=[254,-1,0],
     _cJ_=[0,caml_new_string("examples/hyperbolic/hypertree.ml"),970,2],
     _cI_=caml_new_string("<TITLE>"),
     _cH_=caml_new_string(""),
     _cC_=caml_new_string(".jpg"),
     _cD_=caml_new_string("thumbnails/"),
     _cA_=caml_new_string("messages.json"),
     _cy_=caml_new_string("icons/"),
    ...
    function iter$0(f,a)
     {var _lp_=a.length - 1 - 1 | 0,_lo_=0;
      if(! (_lp_ < 0))
       {var i=_lo_;
        for(;;)
         {caml_call1(f,a[i + 1]);
    ...
    function map(f,a)
     {var l=a.length - 1;
      if(0 === l)return [0];
      var r=caml_make_vect(l,caml_call1(f,a[1])),_lm_=l - 1 | 0,_ll_=1;
      if(! (_lm_ < 1))
       {var i=_ll_;
        for(;;)
    ...
    function fold_left(f,x,a)
     {var r=[0,x],_lj_=a.length - 1 - 1 | 0,_li_=0;
      if(! (_lj_ < 0))
       {var i=_li_;
        for(;;)
         {r[1] = caml_call2(f,r[1],a[i + 1]);
          var _lk_=i + 1 | 0;
          if(_lj_ !== i){var i=_lk_;continue}
          break}}
      return r[1]}
    caml_fresh_oo_id(0);
    function _z_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_lh_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_lc_=height(lr);
            if(_lc_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _ld_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_ld_)}
            return invalid_arg(_r_)}
          return invalid_arg(_s_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_le_=height(rl);
            if(_le_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _lf_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_lf_)}
            return invalid_arg(_t_)}
          return invalid_arg(_u_)}
        var _lg_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_lg_]}
      var empty=0;
      ...
      function min_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _k$_=param$0[1];
            if(_k$_){var param$0=_k$_;continue}
            var d=param$0[3],v=param$0[2];
            return [0,[0,v,d]]}
          return 0}}
      function max_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _k8_=param$0[4],_k9_=param$0[3],_k__=param$0[2];
      ...
      function max_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _k5_=param$0[4],_k6_=param$0[3],_k7_=param$0[2];
            if(_k5_){var param$0=_k5_;continue}
            return [0,[0,_k7_,_k6_]]}
          return 0}}
         ...
         {var _k4_=param[1];
          if(_k4_)
           {var r=param[4],d=param[3],v=param[2];
            return bal(remove_min_binding(_k4_),v,d,r)}
          var r$0=param[4];
          return r$0}
        return invalid_arg(_v_)}
      function _kH_(t,match)
       {if(t)
         {if(match)
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _k1_=caml_call2(p,v,d);
            if(_k1_)
             {var _k2_=for_all(p,l);
         ...
         {if(param$0)
           {var
            ...
            if(_kY_)
             ...
             {var _k0_=exists(p,l);
              if(! _k0_){var param$0=r;continue}
              var _kZ_=_k0_}
            return _kZ_}
          return 0}}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _kU_=merge(f,r1,r2),
             _kV_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_kV_,_kU_)}}
        else
         if(! s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _kW_=merge(f,r1$0,r2$0),
           _kX_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_kX_,_kW_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _kS_=concat(lf,rf);return [0,join(lt,v,d,rt),_kS_]}
          var _kT_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_kT_]}
        return _y_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _kP_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_kP_)
               {var _kQ_=caml_call2(cmp,d1,d2);
                if(_kQ_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_kO_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _kO_ | 0}
        return 0}
      ...
      function seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_kM_=cons_enum(t,rest);
          return [0,[0,k,v],function(_kN_){return seq_of_enum(_kM_,_kN_)}]}
        return 0}
      function to_seq(m)
       {var _kK_=cons_enum(m,0);
        return function(_kL_){return seq_of_enum(_kK_,_kL_)}}
       ...
       {var m$0=m,c=0;
        for(;;)
         {if(m$0)
           ...
           var _kI_=c;
          return function(_kJ_){return seq_of_enum(_kI_,_kJ_)}}}
      return [0,
              empty,
              is_empty,
              mem,
    ...
    function add(x,q)
     {var cell=[0,x,0],_kG_=q[3];
      return _kG_
              ?(q[1] = q[1] + 1 | 0,_kG_[2] = cell,q[3] = cell,0)
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
         _kg_=function(param){return 0},
         _kh_=function(param){return 0},
         _ki_=function(param){return 0};
        return [0,function(param){return 0},_ki_,_kh_,_kg_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _kj_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_kj_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _kk_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _kl_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _km_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _kn_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _ko_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _kp_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _kq_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _kr_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _ks_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _kt_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _ku_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _kv_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _kw_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _kx_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _ky_=function(param){caml_call1(de$12,0);return 0},
           _kz_=function(param){caml_call1(ed$12,0);return 0},
       ...
       switch(ty1[0])
        {case 0:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_jZ_,rest2)];
         ...
         case 1:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_j0_,rest2$0)];
         ...
         case 2:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_j1_,rest2$1)];
         ...
         case 3:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_j2_,rest2$2)];
         ...
         case 4:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_j3_,rest2$3)];
         ...
         case 5:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_j4_,rest2$4)];
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_j5_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_j6_,rest2$6)];
          ...
          break;
         case 8:
          var _j7_=ty1[2],_j8_=ty1[1];
          if(typeof match === "number")
           var switch$9=1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_j9_=trans(_j7_,rest2$7);
              return [8,trans(_j8_,ty2),_j9_];
          ...
          break;
         case 9:
          var _j__=ty1[3],_j$_=ty1[2],_ka_=ty1[1];
          if(typeof match === "number")
           var switch$10=1;
          else
           switch(match[0])
            {case 8:var switch$0=5,switch$10=0;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_j$_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_ka_,ty22,trans(_j__,rest2$8)];
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_kb_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_kc_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_kd_,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_ke_,rest2$12)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$14=0;break;
             ...
             case 14:var rest2$13=match[1];return [14,trans(_kf_,rest2$13)];
     ...
     {var match=type_padding(pad,fmtty);
      if(typeof prec === "number")
       {if(0 === prec)
        ...
        var _jY_=match[2];
        if(typeof _jY_ !== "number" && 2 === _jY_[0])
         {var rest$0=_jY_[1],pad$1=match[1];return [0,pad$1,1,rest$0]}
        throw Type_mismatch}
        ...
        {case 0:
         ...
         case 2:
          ...
          if(typeof _ju_ !== "number" && 1 === _ju_[0])
           {var
             ...
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_jv_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _jw_=type_padding(pad$0,fmtty),
           _jx_=_jw_[2],
           _jy_=_jw_[1];
         ...
         case 4:
          var
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _jz_=type_padprec(pad$1,prec,fmtty),
           _jA_=_jz_[3],
           _jB_=_jz_[2],
           _jC_=_jz_[1];
          if(typeof _jA_ !== "number" && 2 === _jA_[0])
           {var
             ...
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_jC_,_jB_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _jD_=type_padprec(pad$2,prec$0,fmtty),
           _jE_=_jD_[3],
           _jF_=_jD_[2],
           _jG_=_jD_[1];
          if(typeof _jE_ !== "number" && 3 === _jE_[0])
           {var
             ...
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_jG_,_jF_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _jH_=type_padprec(pad$3,prec$1,fmtty),
           _jI_=_jH_[3],
           _jJ_=_jH_[2],
           _jK_=_jH_[1];
          if(typeof _jI_ !== "number" && 4 === _jI_[0])
           {var
             fmtty_rest$5=_jI_[1],
             match$5=type_format_gen(fmt_rest$5,fmtty_rest$5),
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_jK_,_jJ_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _jL_=type_padprec(pad$4,prec$2,fmtty),
           _jM_=_jL_[3],
           _jN_=_jL_[2],
           _jO_=_jL_[1];
          if(typeof _jM_ !== "number" && 5 === _jM_[0])
           {var
             ...
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_jO_,_jN_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _jP_=type_padprec(pad$5,prec$3,fmtty),
           _jQ_=_jP_[3],
           _jR_=_jP_[2],
           _jS_=_jP_[1];
          if(typeof _jQ_ !== "number" && 6 === _jQ_[0])
           {var
             fmtty_rest$7=_jQ_[1],
             match$7=type_format_gen(fmt_rest$7,fmtty_rest$7),
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_jS_,_jR_,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           pad$6=fmt[1],
           _jT_=type_padding(pad$6,fmtty),
           _jU_=_jT_[2],
           _jV_=_jT_[1];
          if(typeof _jU_ !== "number" && 7 === _jU_[0])
           {var
             fmtty_rest$8=_jU_[1],
             match$8=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$8[2],
             fmt$9=match$8[1];
            return [0,[9,_jV_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _jW_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_jW_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _jX_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_jX_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_jX_[1];
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _jr_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_jr_))
             throw Type_mismatch;
            var _js_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_js_))
             throw Type_mismatch;
            var
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _jq_=2 === padty$0?48:32,res=make(width$0,_jq_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           _jo_=match$0 - 32 | 0,
           switch$0=
            59 < _jo_ >>> 0?33 < (_jo_ - 61 | 0) >>> 0?1:0:2 === _jo_?1:0;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _jh_=caml_ml_bytes_length(s$0) - 1 | 0,
           _jg_=0;
          if(! (_jh_ < 0))
           {var i$0=_jg_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0);
              if(32 <= match)
               {var _jl_=match - 34 | 0;
                if(58 < _jl_ >>> 0)
                 if(93 <= _jl_)var switch$1=0,switch$2=0;else var switch$2=1;
                else
                 if(56 < (_jl_ - 1 | 0) >>> 0)
                  var switch$1=1,switch$2=0;
                 else
                  var switch$2=1;
                if(switch$2)var _jm_=1,switch$1=2}
              else
               var switch$1=11 <= match?13 === match?1:0:8 <= match?1:0;
              switch(switch$1)
               {case 0:var _jm_=4;break;case 1:var _jm_=2;break}
              n[1] = n[1] + _jm_ | 0;
              var _jn_=i$0 + 1 | 0;
              if(_jh_ !== i$0){var i$0=_jn_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _jj_=caml_ml_bytes_length(s$0) - 1 | 0,_ji_=0;
            if(! (_jj_ < 0))
             {var i=_ji_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i);
                ...
                break}}
            var _jp_=s}
          var str$0=caml_string_of_bytes(_jp_)}
        var l=caml_ml_string_length(str$0),res=make(l + 2 | 0,34);
        caml_blit_string(str$0,0,res,1,l);
        return caml_string_of_bytes(res)}}
    function convert_int(iconv,n)
     {switch(iconv)
       {case 0:var _jf_=_aq_;break;
        case 1:var _jf_=_ar_;break;
        case 2:var _jf_=_as_;break;
        case 3:var _jf_=_at_;break;
        case 4:var _jf_=_au_;break;
        case 5:var _jf_=_av_;break;
        case 6:var _jf_=_aw_;break;
        case 7:var _jf_=_ax_;break;
        case 8:var _jf_=_ay_;break;
        case 9:var _jf_=_az_;break;
        case 10:var _jf_=_aA_;break;
        case 11:var _jf_=_aB_;break;
        default:var _jf_=_aC_}
      return caml_format_int(_jf_,n)}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 0:var _je_=_aQ_;break;
        case 1:var _je_=_aR_;break;
        case 2:var _je_=_aS_;break;
        case 3:var _je_=_aT_;break;
        case 4:var _je_=_aU_;break;
        case 5:var _je_=_aV_;break;
        case 6:var _je_=_aW_;break;
        case 7:var _je_=_aX_;break;
        case 8:var _je_=_aY_;break;
        case 9:var _je_=_aZ_;break;
        case 10:var _je_=_a0_;break;
        case 11:var _je_=_a1_;break;
        default:var _je_=_a2_}
      return caml_format_int(_je_,n)}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 0:var _jd_=_a3_;break;
        case 1:var _jd_=_a4_;break;
        case 2:var _jd_=_a5_;break;
        case 3:var _jd_=_a6_;break;
        case 4:var _jd_=_a7_;break;
        case 5:var _jd_=_a8_;break;
        case 6:var _jd_=_a9_;break;
        case 7:var _jd_=_a__;break;
        case 8:var _jd_=_a$_;break;
        case 9:var _jd_=_ba_;break;
        case 10:var _jd_=_bb_;break;
        case 11:var _jd_=_bc_;break;
        default:var _jd_=_bd_}
      return caml_format_int(_jd_,n)}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 0:var _jc_=_aD_;break;
        case 1:var _jc_=_aE_;break;
        case 2:var _jc_=_aF_;break;
        case 3:var _jc_=_aG_;break;
        case 4:var _jc_=_aH_;break;
        case 5:var _jc_=_aI_;break;
        case 6:var _jc_=_aJ_;break;
        case 7:var _jc_=_aK_;break;
        case 8:var _jc_=_aL_;break;
        case 9:var _jc_=_aM_;break;
        case 10:var _jc_=_aN_;break;
        case 11:var _jc_=_aO_;break;
        default:var _jc_=_aP_}
      return caml_int64_format(_jc_,n)}
     ...
     {if(16 <= fconv)
               ...
               {var c=caml_bytes_unsafe_get(s,i);
                if(97 <= c)
                 if(122 < c)
                  ...
                  var _i8_=c - 32 | 0,switch$1=1;
                else
                 var switch$1=0;
                if(! switch$1)var _i8_=c;
      ...
      if(15 === fconv)
       ...
       {var prec=abs(prec$0);
        ...
        var _i$_=buffer_contents(buf)}
      var str=caml_format_float(_i$_,x);
      if(15 === fconv)
        ...
        for(;;)
         {if(i$0 === len)
           ...
           {var
             ...
             _ja_=match - 46 | 0,
             switch$2=
              23 < _ja_ >>> 0?55 === _ja_?1:0:21 < (_ja_ - 1 | 0) >>> 0?1:0;
            if(! switch$2){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
            var _jb_=1}
          return _jb_?str:_a_(str,_bi_)}}
      return str}
    function make_int_padding_precision(k,o,acc,fmt,pad,match,trans,iconv)
     {if(typeof pad === "number")
       ...
       {if(0 === pad[0])
         {var _i3_=pad[2],_i4_=pad[1];
          if(typeof match === "number")
           return 0 === match
                   ?function(x)
                     {var str=fix_padding(_i4_,_i3_,caml_call2(trans,iconv,x));
                      return make_printf(k,o,[4,acc,str],fmt)}
                   :function(p,x)
                     {var
                       str=
                        fix_padding
                         (_i4_,_i3_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,o,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_i4_,_i3_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,o,[4,acc,str],fmt)}}
        var _i5_=pad[1];
        if(typeof match === "number")
         return 0 === match
                 ?function(w,x)
                   {var str=fix_padding(_i5_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,o,[4,acc,str],fmt)}
                 :function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_i5_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,o,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_i5_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,o,[4,acc,str],fmt)}}}
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _iZ_=pad$5[2],_i0_=pad$5[1];
               if(typeof prec$3 === "number")
                return 0 === prec$3
                        ?function(x)
                          {var
                            str=convert_float(fconv,default_float_precision,x),
                            str$0=fix_padding(_i0_,_iZ_,str);
                           return make_printf(k$0,o,[4,acc$0,str$0],rest$7)}
                        :function(p,x)
                          {var str=fix_padding(_i0_,_iZ_,convert_float(fconv,p,x));
                           return make_printf(k$0,o,[4,acc$0,str],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_i0_,_iZ_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,o,[4,acc$0,str],rest$7)}}
             var _i1_=pad$5[1];
             if(typeof prec$3 === "number")
              return 0 === prec$3
                      ?function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision,x),
                          str$0=fix_padding(_i1_,w,str);
                         return make_printf(k$0,o,[4,acc$0,str$0],rest$7)}
                      :function(w,p,x)
                        {var str=fix_padding(_i1_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,o,[4,acc$0,str],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_i1_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,o,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _i2_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _i2_[2] === "number")
              {var fmt=_i2_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,o,acc$0,rest$19,arity,_iY_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,o,acc$0,rest$19,arity,_iY_])}}
    ...
    function make_invalid_arg(counter,k,o,acc,fmt)
     {var _iV_=[8,acc,_bp_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_iV_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_iV_,fmt])}
    function make_custom$0(counter,k,o,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_iU_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_iU_,rest])}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_iP_=0;
      return make_printf
              (function(o,acc){output_acc(o,acc);return 0},oc,_iP_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bx_;
      ...
      return caml_call2(sprintf(_by_),_iO_,_iN_)}
    function fields(x)
     {var match=x.length - 1;
      if(2 < match >>> 0)
       {var _iK_=other_fields(x,2),_iL_=field(x,1);
        return caml_call2(sprintf(_bz_),_iL_,_iK_)}
      switch(match)
       {case 0:return _bA_;
        case 1:return _bB_;
        default:var _iM_=field(x,1);return caml_call1(sprintf(_bC_),_iM_)}}
        ...
        for(;;)
         {if(param$0)
           {var tl=param$0[2],hd=param$0[1];
            try {var _iI_=caml_call1(hd,x),_iH_=_iI_}catch(_iJ_){var _iH_=0}
            if(_iH_){var s=_iH_[1];return s}
            var param$0=tl;
            continue}
    ...
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _iF_=a.length - 1 - 1 | 0,_iE_=0;
        if(! (_iF_ < 0))
         {var i=_iE_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _iy_=slot[4],
              _iz_=slot[3],
              _iA_=slot[6]?_bM_:_bO_,
              _iB_=slot[2],
              _iC_=info(slot[1]),
              match=
               [0,caml_call6(sprintf(_bN_),_iC_,_iB_,_iA_,_iz_,_iy_,_ix_)];
            else
             if(slot[1])
              var match=0;
             else
              var _iD_=info(0),match=[0,caml_call1(sprintf(_bP_),_iD_)];
        ...
        {var
         ...
         for(;;)
          {caml_check_bound(result[1],i$0)[i$0 + 1] = i$0;
           var _it_=i$0 + 1 | 0;
           if(54 !== i$0){var i$0=_it_;continue}
           var accu=[0,_bS_],_ip_=54 + max(55,l) | 0,_io_=0;
           if(! (_ip_ < 0))
            {var i=_io_;
             for(;;)
              {var
               ...
               var
                _iq_=accu[1],
                _ik_=caml_string_get(_iq_,3) << 24,
                _il_=caml_string_get(_iq_,2) << 16,
                _im_=caml_string_get(_iq_,1) << 8,
                _in_=
                 ((caml_string_get(_iq_,0) + _im_ | 0) + _il_ | 0)
                 +
                 _ik_
                 |
                 0,
                _ir_=
                 (caml_check_bound(result[1],j)[j + 1] ^ _in_)
                 &
                 1073741823;
               caml_check_bound(result[1],j)[j + 1] = _ir_;
               var _is_=i + 1 | 0;
               if(_ip_ !== i){var i=_is_;continue}
               break}}
           result[2] = 0;
           return result}}];
     ...
     {if(opt)var sth=opt[1],random=sth;else var random=randomized_default;
      ...
      for(;;)
       {if(! (initial_size <= x))
        ...
        if(random)
         {var
           _ii_=caml_obj_tag(prng),
           _ij_=250 === _ii_?prng[1]:246 === _ii_?force_lazy_block(prng):prng;
          _ij_[2] = (_ij_[2] + 1 | 0) % 55 | 0;
          var
           _if_=_ij_[2],
           curval=caml_check_bound(_ij_[1],_if_)[_if_ + 1],
           _ig_=(_ij_[2] + 24 | 0) % 55 | 0,
           newval=
            caml_check_bound(_ij_[1],_ig_)[_ig_ + 1]
            +
           ...
           _ih_=_ij_[2];
          caml_check_bound(_ij_[1],_ih_)[_ih_ + 1] = newval30;
          var seed=newval30}
        else
         var seed=0;
    ...
    function find$0(h,key)
     {var _ie_=indexfun(h,key),match=caml_check_bound(h[2],_ie_)[_ie_ + 1];
      if(match)
    ...
    function public_method_label(s)
     {var accu=[0,0],_ib_=caml_ml_string_length(s) - 1 | 0,_ia_=0;
      if(! (_ib_ < 0))
       {var i=_ia_;
        for(;;)
         {var _ic_=caml_string_get(s,i);
          accu[1] = (223 * accu[1] | 0) + _ic_ | 0;
          var _id_=i + 1 | 0;
          if(_ib_ !== i){var i=_id_;continue}
          break}}
    ...
    function new_table(pub_labels)
     {table_count[1]++;
      ...
      var _h6_=((fit_size(len) * 32 | 0) / 8 | 0) - 1 | 0;
      caml_check_bound(methods,1)[2] = _h6_;
      var _h8_=len - 1 | 0,_h7_=0;
      if(! (_h8_ < 0))
       {var i=_h7_;
        for(;;)
         {var
           _h__=(i * 2 | 0) + 3 | 0,
           _h9_=caml_check_bound(pub_labels,i)[i + 1];
          caml_check_bound(methods,_h__)[_h__ + 1] = _h9_;
          var _h$_=i + 1 | 0;
          if(_h8_ !== i){var i=_h$_;continue}
          break}}
      return [0,initial_object_size,methods,Meths[1],Labs[1],0,0,Vars[1],0]}
    function resize$0(array,new_size)
     {var len=array[2].length - 1,_h3_=len < new_size?1:0;
      if(_h3_)
       {var
         ...
         switch$0=
          0 <= len
           ?(_h4_.length - 1 - len | 0) < 0
             ?0
             :(a2.length - 1 - len | 0) < 0
               ?0
               :(caml_array_blit(_h4_,0,a2,0,len),1)
           :0;
    ...
    function get_method_label(table,name)
     {try
       {var _h1_=caml_call2(Meths[27],name,table[3]);return _h1_}
      catch(_h2_)
    ...
    function new_variable(table,name)
     {try
       {var _hZ_=caml_call2(Vars[27],name,table[7]);return _hZ_}
      catch(_h0_)
    ...
    function iter$1(x,f)
     {var _hY_=1 - (x == no_handler?1:0);return _hY_?caml_call1(f,x):_hY_}
    function case$0(x,f,g)
     {return x == no_handler?caml_call1(f,0):caml_call1(g,x)}
    function test$0(x){return x !== undefined$0?1:0}
    function iter$2(x,f)
     {var _hX_=x !== undefined$0?1:0;return _hX_?caml_call1(f,x):_hX_}
     ...
     {if(e.addEventListener === undefined$0)
       {var
         ...
         callback=
          function(e)
           {var _hU_=[0,h,e,[0]];
            return function(_hV_,_hW_){return caml_js_call(_hU_,_hV_,_hW_)}};
    ...
    function unsafeCreateElementEx(type,name,doc,elt)
     {for(;;)
       {if(0 === type)if(0 === name)return createElement(doc,elt);
        var _hO_=createElementSyntax[1];
        if(785140586 === _hO_)
         {try
           {var
             el=document.createElement('<input name="x">'),
             _hR_=el.tagName.toLowerCase() === "input"?1:0,
             _hS_=_hR_?el.name === "x"?1:0:_hR_,
             _hP_=_hS_}
          catch(_hT_){var _hP_=0}
          var _hQ_=_hP_?982028505:-1003883683;
          createElementSyntax[1] = _hQ_;
          continue}
        if(982028505 <= _hO_)
    ...
    function createButton(type,name,doc)
     {return unsafeCreateElementEx(type,name,doc,_bZ_)}
    function createUl(doc){return unsafeCreateElement(doc,_b0_)}
    function createDl(doc){return unsafeCreateElement(doc,_b1_)}
    function createLi(doc){return unsafeCreateElement(doc,_b2_)}
    function createDiv(doc){return unsafeCreateElement(doc,_b3_)}
    function createA(doc){return unsafeCreateElement(doc,_b4_)}
    function createImg(doc){return unsafeCreateElement(doc,_b5_)}
    function createDd(doc){return createElement(doc,_b6_)}
    function createDt(doc){return createElement(doc,_b7_)}
    ...
    function stopPropagation(ev)
     {function _hM_(param){return ev.stopPropagation()}
      function _hN_(param){return ev.cancelBubble = true$0}
      return case$1(ev.stopPropagation,_hN_,_hM_)}
    var
         ...
         {var
          ...
          try
           {var
             ...
             _hK_=function(callback){return req(callback)};
            return _hK_}
          catch(_hL_)
    ...
    _a_(s$0,_a_(_dg_,git_version));
    var Local_exn=[248,_b__,caml_fresh_oo_id(0)],overflow_limit=2147483e3;
    ...
    function path_of_path_string(s)
     {var l=caml_ml_string_length(s);
      function aux(i)
       {try
         {var _hI_=index_from(s,i,47),j=_hI_}
        catch(_hJ_)
      ...
      if(a)
       if(! caml_string_notequal(a[1],_ca_))
        {var _hH_=a[2];
         if(! _hH_)return 0;
         if(! caml_string_notequal(_hH_[1],_cb_))if(! _hH_[2])return _cc_}
      return a}
               ...
               function(s)
                {function _hF_(param)
                  {var
                    y=param[2],
                    x=param[1],
                    _hG_=urldecode_js_string_string(y);
                   return [0,urldecode_js_string_string(x),_hG_]}
                 var index=s.indexOf(make$0(1,61).toString());
                 if(0 <= index)
                  var
                   _hD_=s.slice(index + 1 | 0),
                   _hE_=[0,s.slice(0,index),_hD_];
                 else
                  var _hE_=undefined$0;
                 return case$1(_hE_,interrupt,_hF_)},
              _hB_=aux([0,case$1(arr[idx$0],interrupt,_hA_),acc],_hz_);
             return _hB_}
           catch(_hC_)
     ...
     var
      ...
      _db_=
       function
        ...
        {if(! _da_[1])
          {if(public_methods === 0)
            var _g3_=new_table([0]);
           else
            {var
              tags=map(public_method_label,public_methods),
              table=new_table(tags),
              _gZ_=public_methods.length - 1 - 1 | 0,
              _gY_=0;
             if(! (_gZ_ < 0))
              {var i=_gY_;
               for(;;)
             ...
             var _g3_=table}
           var
            _g4_=new_variable(_g3_,_dc_),
            _g1_=map(function(_hy_){return get_method_label(_g3_,_hy_)},names),
            _g5_=_g1_[1],
            _g6_=_g1_[2],
            _g7_=_g1_[3],
            _g8_=_g1_[4],
            ...
            _hf_=
             function(self_1)
              {var env=self_1[_g4_ + 1];return caml_call1(env[2],env[1])},
            _hg_=
             function(self_1)
              {var env=self_1[_g4_ + 1];return caml_call1(env[3],env[1])},
            _hh_=
             function(self_1)
              {var env=self_1[_g4_ + 1];return caml_call1(env[4],env[1])},
            _hi_=function(self_1){var env=self_1[_g4_ + 1];return env[5]},
            _hj_=function(self_1){var env=self_1[_g4_ + 1];return env[6]},
            _hk_=function(self_1){var env=self_1[_g4_ + 1];return env[7]},
            _hl_=function(self_1){var env=self_1[_g4_ + 1];return env[8]},
            _hm_=function(self_1){var env=self_1[_g4_ + 1];return env[9]},
            _hn_=function(self_1){var env=self_1[_g4_ + 1];return env[10]},
            _ho_=function(self_1){var env=self_1[_g4_ + 1];return env[11]},
            _hp_=function(self_1){var env=self_1[_g4_ + 1];return env[12]},
            methods=
             [0,
              _ha_,
              function(self_1){var env=self_1[_g4_ + 1];return env[13]},
              _g8_,
              _hp_,
              _hc_,
              _ho_,
           ...
           for(;;)
            {if(i$0[1] < len)
              {var
                _g2_=i$0[1],
                label=caml_check_bound(methods,_g2_)[_g2_ + 1],
                next=
                 function(param)
                  {i$0[1]++;
                   var _hx_=i$0[1];
                   return caml_check_bound(methods,_hx_)[_hx_ + 1]},
                clo=next(0);
                  ...
                  case 19:
                   var
                    ...
                    clo$0=
                     function(n,m)
                       {return function(obj)
                         {var _hv_=caml_call1(obj[1][m + 1],obj);
                          return caml_call2(obj[1][n + 1],obj,_hv_)}}
                      (n$15,m$1);
                   break;
                  case 20:
                   var
                   ...
                   var
                    ...
                    clo$0=
                     function(m,n,c)
                       {return function(obj)
                         {var _hu_=obj[n + 1];
                          return caml_call2(caml_get_public_method(_hu_,m,0),_hu_,c)}}
                      (m$3,n$16,c$0);
                   break;
                  case 22:
                   var
                    ...
                    clo$0=
                     function(m,e,n,c)
                       {return function(obj)
                         {var _ht_=obj[e + 1][n + 1];
                          return caml_call2(caml_get_public_method(_ht_,m,0),_ht_,c)}}
                      (m$4,e$4,n$17,c$1);
                   break;
                  default:
                   var
                    ...
                    clo$0=
                     function(m,n,c)
                       {return function(obj)
                         {var _hw_=caml_call1(obj[1][n + 1],obj);
                          return caml_call2(caml_get_public_method(_hw_,m,0),_hw_,c)}}
                      (m$5,n$18,c$2)}
               else
                var clo$0=clo;
               method_count[1]++;
               if(caml_call2(Labs[27],label,_g3_[4]))
                {resize$0(_g3_,label + 1 | 0);
                 caml_check_bound(_g3_[2],label)[label + 1] = clo$0}
               else
                _g3_[6] = [0,[0,label,clo$0],_g3_[6]];
               i$0[1]++;
               continue}
             var
              _hq_=
               function(_hs_)
                {var obj=caml_obj_block(248,_g3_[1]);
                 obj[1] = _g3_[2];
                 var _hr_=caml_set_oo_id(obj);
                 _hr_[_g4_ + 1] = _hs_;
                 return _hr_};
             inst_var_count[1] = (inst_var_count[1] + _g3_[1] | 0) - 1 | 0;
             var l1=_g3_[8],l2=0;
             for(;;)
              {if(l1)
               ...
               resize$0
                (_g3_,
                 3 + ((caml_check_bound(_g3_[2],1)[2] * 16 | 0) / 32 | 0) | 0);
               _da_[1] = _hq_;
               break}
             break}}
         return caml_call1
                 (_da_[1],
                  [0,
                   ...
                   protocol,
                   href])},
      _dd_=function(param,_gX_){return 0},
      _de_=function(param,_gW_){return 0},
       ...
       {try
         ...
         {try
           ...
           {try
            ...
            catch(_gU_){throw [0,Assert_failure,_ch_]}}}}}
    caml_fresh_oo_id(0);
      ...
      if(1 === current_callback_nesting_depth[1])
       for(;;)
        {if(0 !== q[1])
          {var _gD_=q[2];
           if(_gD_)
            {var _gE_=_gD_[1],_gF_=_gD_[2];
             if(_gF_)
              {q[1] = q[1] - 1 | 0;q[2] = _gF_}
             else
              {q[1] = 0;q[2] = 0;q[3] = 0}
             var result=_gE_[2],callbacks=_gE_[1];
    ...
    function wakeup_general(api_function_name,p,result)
     {var p$0=underlying(p),_gC_=p$0[1];
      switch(_gC_[0])
       {case 1:
         return _gC_[1] === Canceled
                 ?0
        ...
        case 2:
         ...
         var
          ...
          cancel_callbacks=
           typeof _gA_ === "number"
            ?_gz_
            :typeof _gz_ === "number"?_gA_:[0,_gA_,_gz_];
       ...
       {var p=new_pending([0,p$0]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
          ...
          try
           {var _gy_=caml_call1(f,v),p$0=_gy_}
       ...
       {case 1:return [0,_gw_];
        ...
        default:
         ...
         return run_callback_or_defer_it
                 (_cs_,function(param){return caml_call1(f,v)},_gx_)}}
    function on_cancel(p,f)
     {var p$0=underlying(p),_gu_=p$0[1];
      switch(_gu_[0])
       {case 1:
         if(_gu_[1] === Canceled)
          {var
        ...
        default:return 0}}
    function poll(p)
     {var _gt_=underlying(p)[1];
      switch(_gt_[0])
       {case 1:var e=_gt_[1];throw e;
        case 2:return 0;
        default:var v=_gt_[1];return [0,v]}}
    var pause_hook=[0,function(_gs_){return 0}],s1=create$2(0),_cv_=[0,0];
    ...
    function yield$0(param)
     {var match=task(0),w=match[2],t=match[1],d=0;
      function callback(_gq_){return wakeup(w,_gq_)}
      var id=[0,0];
      function loop(step,param)
       {if(2147483e3 < step)
        ...
        var cb=remain == 0?callback:function(_gp_){return loop(remain,_gp_)};
      ...
      on_cancel
       (t,
        function(param)
         {var _go_=id[1];
          if(_go_){var x=_go_[1];id[1] = 0;return window.clearTimeout(x)}
          return 0});
      return t}
    ...
    function icon(nm){return _a_(_cy_,nm).toString()}
    ...
    function transf(a,b,c,d,z)
     {var _gn_=add_mul(c,z,d);return div(add_mul(a,z,b),_gn_)}
    function transl(p)
     {var c=mul(conj(p),t);return function(z){return transf(t,p,c,t,z)}}
    function compose(param,_gl_)
     {var
       t2=_gl_[2],
       p2=_gl_[1],
       t1=param[2],
       ...
       _gm_=div(conj(den),den),
       c=mul(mul(t1,t2),_gm_),
       _gk_=sdiv(c,norm(c));
      return [0,div(add$0(t2p1,p2),den),_gk_]}
    function compute_translation(z0,z1)
     {var dz=sub$1(z1,z0),z0z1=mul(z0,z1),_gj_=1 - sq_norm(z0z1);
      return sdiv(add$0(mul(z0z1,conj(dz)),dz),_gj_)}
    var json=JSON;
    function http_get(url)
     {var opt=[0,0];
      ...
      function headers$0(s)
       {function _gh_(v){return [0,caml_js_to_string(v)]}
        function _gi_(param){return 0}
        return case$0
                (req.getResponseHeader(caml_jsbytes_of_string(s)),_gi_,_gh_)}
      var st=[0,382334108];
      ...
      caml_js_wrap_callback
       (function(param)
         {var match=req.readyState;
                ...
                _ge_=
                 function(param)
                  {var x=req.responseXML;
                   ...
                   var match=case$0(x,function(param){return 0},_gg_);
                   if(match)
                    {var doc=match[1];
          ...
          return 0});
      function _gb_(upload){return 0}
      iter$2(req.upload,_gb_);
      req.send(no_handler);
      on_cancel(res,function(param){return req.abort()});
      return bind(res,_gd_)}
    function getfile(f)
     {try
       {var _f$_=return$0(caml_read_file_content(f));return _f$_}
      catch(_ga_)
    ...
    function load_image(src)
     {var img=createImg(document);
      function _f__(param){return return$0(img)}
    ...
    function f(param)
     {function _f7_(param)
       {function _f8_(param){return "en"}
        return get(window.navigator.userLanguage,_f8_)}
      return get(window.navigator.language,_f7_).substring(0,2)}
    function _cz_(st)
    ...
    function load_messages(param)
     {function _f6_(s){return return$0(json.parse(s.toString()))}
      return bind(getfile(_cA_),_f6_)}
    function local_messages(msgs){return option(msgs[language[1]])}
    function screen_transform(canvas)
     {var
       _f5_=opt_style(style.padding,0),
       offset=opt_style(style.border,0.5) + _f5_,
       w=canvas.width,
       h=canvas.height,
       rx=w / 2,
       ry=h / 2,
    ...
    function ellipse_arc(c,cx,cy,rx,ry,start,fin,clock_wise)
     {c.save();
      ...
      return c.restore()}
    function _cB_(x,f){return caml_call1(f,x)}
    function tree_vertice_count(n)
     {var l=n[2],_f4_=1;
      return fold_left
              (function(s,n){return s + tree_vertice_count(n) | 0},_f4_,l)}
    ...
    function randomize_tree(n)
     {var ch=n[2],_f0_=ch.length - 1 - 1 | 0;
      if(! (_f0_ < 0))
       {var i=_f0_;
        for(;;)
         {var
           ...
           _f1_=caml_check_bound(ch,j)[j + 1];
          caml_check_bound(ch,i)[i + 1] = _f1_;
          caml_check_bound(ch,j)[j + 1] = v;
          var _f2_=i - 1 | 0;
          if(0 !== i){var i=_f2_;continue}
          break}}
    ...
    function compute_text_nodes(node_names,nodes)
     {try
      ...
      if(! (_fK_ < 0))
       {var i=_fJ_;
        for(;;)
         {var _fL_=caml_check_bound(nodes,i)[i + 1],_fM_=_fL_[2],_fN_=_fL_[1];
    ...
    function load_tree(param)
     {function _eV_(s)
       {var
        ...
        var
         node_names$0=
          _cB_(_cB_(node_names,function(_ft_){return map(_e0_,_ft_)}),to_list);
                 ...
                 function(_fq_)
                  {function _fr_(param)
                    {function _fs_(img){schedule_redraw(0);return return$0(img)}
                     return bind
                             (load_image(_a_(_cD_,_a_(img,_cC_)).toString()),_fs_)}
                   return bind(yield$0(0),_fr_)}],
                img]];
           else
        ...
        function layout_rec
         ...
         {var
          ...
          vi[1]++;
          var _fn_=transf[1];
          caml_check_bound(vertices,i$0)[i$0 + 1] = _fn_;
          var l$0=ch.length - 1;
          if(0 === l$0)
           var ch$0=[0];
          else
             ...
             {var
              ...
              if(! (_fj_ < 1))
               {var i=_fi_;
                for(;;)
                 {var
                   _fk_=caml_check_bound(ch_weights,i)[i + 1],
                   _fl_=f(caml_check_bound(ch,i)[i + 1],_fk_);
                  caml_check_bound(r,i)[i + 1] = _fl_;
                  var _fm_=i + 1 | 0;
        ...
        function compute_frontiers(node)
         {var l=node[2],i=node[1];
          ...
          if(0 === l.length - 1)
           ...
           var
            _fd_=l.length - 1 - 1 | 0,
            _fe_=caml_check_bound(l,_fd_)[_fd_ + 1][1],
            _ff_=caml_check_bound(frontiers,_fe_)[_fe_ + 1][2],
            _fg_=caml_check_bound(l,0)[1][1],
            _fc_=[0,caml_check_bound(frontiers,_fg_)[_fg_ + 1][1],_ff_];
          return caml_check_bound(frontiers,i)[i + 1] = _fc_}
        ...
        function compute_neigh(node,parent,lft,rght)
         {var
          ...
          caml_check_bound(neighboors,i)[i + 1] = _e1_;
          var
           ...
           {var j=_e2_;
            for(;;)
             {if(0 < j)
               var
                _e4_=j - 1 | 0,
                _e5_=caml_check_bound(ch,_e4_)[_e4_ + 1][1],
                lft$0=caml_check_bound(frontiers,_e5_)[_e5_ + 1][2];
              else
               if(is_root)
                var
                 _e$_=n - 1 | 0,
                 _fa_=caml_check_bound(ch,_e$_)[_e$_ + 1][1],
              ...
              if(j < (n - 1 | 0))
               var
                _e6_=j + 1 | 0,
                _e7_=caml_check_bound(ch,_e6_)[_e6_ + 1][1],
                rght$0=caml_check_bound(frontiers,_e7_)[_e7_ + 1][1];
              else
               if(is_root)
                var
                 _e__=caml_check_bound(ch,0)[1][1],
                 rght$0=caml_check_bound(frontiers,_e__)[_e__ + 1][1];
               else
                var rght$0=rght;
              var _e8_=[0,status(i)];
              compute_neigh(caml_check_bound(ch,j)[j + 1],_e8_,lft$0,rght$0);
              var _e9_=j + 1 | 0;
         ...
         {var i=_eW_;
          for(;;)
           {var
             ...
             info=match[2],
             _eY_=[0,caml_check_bound(neighboors,i)[i + 1],info];
            caml_check_bound(nodes,i)[i + 1] = _eY_;
            var _eZ_=i + 1 | 0;
    ...
    function img_button(href,h,src)
     {function decoration(over)
       {var img=createImg(document);
        ...
        var _eQ_=_a_(caml_new_string("" + max(38,h)),_cP_).toString();
         ...
         _eR_=
          _a_
            (caml_new_string("" + (extra / 2 | 0)),
             _a_
              (_cR_,
               _a_(caml_new_string("" + (extra - (extra / 2 | 0) | 0)),_cQ_))).toString
           ();
        div.style.padding = _eR_;
        var _eS_=over?_cS_:_cU_;
        div.className = _a_(_cT_,_eS_).toString();
        appendChild(div,img);
        return div}
      var button=createDiv(document);
      button.className = "button";
      button.style.width = "48px";
      var _eP_=_a_(caml_new_string("" + (8 + max(38,h) | 0)),_cV_).toString();
               ...
               function(image_info)
                {var
                 ...
                 if(0 <= i[1])
                  {var
                    _eD_=i[1],
                    info=caml_check_bound(image_info,_eD_)[_eD_ + 1];
                    ...
                    wrap=
                     function(elt)
                      {var w=createDiv(document);
                       ...
                       w.style.right = "0";
                       w.style.margin = "auto";
                       var _eN_=_a_(caml_new_string("" + info[5]),_cW_).toString();
                   ...
                   if(_eG_)
                    ...
                    var url$0=_a_(_c5_,_a_(name,_c4_)).toString();
                   img.src = url$0;
                   img.width = info[4];
                   img.height = info[5];
                   ...
                   var
                    suffix=
                     language[1] === "en"
                      ?_cX_
                      :_a_(_c3_,caml_js_to_string(language[1])),
                    url$1=_a_(_cY_,_a_(caml_js_to_string(info[2]),suffix)),
                             ...
                             var
                              ...
                              _eM_=
                               0 === caml_ml_string_length(refer$0)
                                ...
                                :refer$0,
                              url=_a_(_c2_,_a_(caml_js_to_string(lang),_a_(_c1_,_eM_)));
                             a.href = url.toString();
                          ...
                          {var i=_d4_;
                           for(;;)
                            {var
                             ...
                             caml_check_bound(vertices$0,i)[i + 1] = _d6_;
                             var _d7_=i + 1 | 0;
                                        ...
                                        {var i=_er_;
                                         for(;;)
                                          {var
                                            ...
                                            _et_=z[1],
                                            sx=
                                             Math.abs(caml_check_bound(vertices$0,j)[j + 1][1] - _et_)
                                             /
                                             w,
                                            _eu_=z[2],
                                            sy=
                                             Math.abs(caml_check_bound(vertices$0,j)[j + 1][2] - _eu_)
                                             /
                                             h,
                                            s$1=sy < sx?sx:sy,
                       ...
                       function find_box(boxes,x,y)
                        {var p=[0,-1],_dX_=boxes[3].length - 1 - 1 | 0,_dW_=0;
                         if(! (_dX_ < 0))
                          {var i=_dW_;
                           for(;;)
                            {var _dY_=0 < boxes[3][i + 1]?1:0;
                             if(_dY_)
                              var
                               _dZ_=Math.abs(x - boxes[1][i + 1]) < boxes[3][i + 1]?1:0,
                               _d0_=
                                _dZ_
                                ...
                                {removeEventListener(c1);
                                 ...
                                 if(started[1])
                                  ...
                                  {var
                                   ...
                                   if(0 < i)
                                    {var _dO_=caml_check_bound(nodes,i)[i + 1][2];
