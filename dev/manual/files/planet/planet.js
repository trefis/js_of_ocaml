...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _cr_=caml_new_string("OCAMLRUNPARAM"),
     _cp_=caml_new_string("CAMLRUNPARAM"),
     _bP_=caml_new_string(""),
     _bR_=caml_new_string("Js_of_ocaml__Js.Error"),
     _bS_=caml_new_string("jsError"),
     _b2_=caml_new_string("canvas"),
     _b0_=caml_new_string("img"),
     _bZ_=caml_new_string("br"),
     _bY_=caml_new_string("p"),
     _bX_=caml_new_string("div"),
     _bW_=caml_new_string("label"),
     _bV_=caml_new_string("input"),
     _bU_=caml_new_string("select"),
     _bT_=caml_new_string("option"),
     _b1_=caml_new_string("Js_of_ocaml__Dom_html.Canvas_not_available"),
     _ca_=[0,0],
     _cb_=[0,1],
     _b__=[0,0],
     _b$_=[0,1],
     ...
     _co_=[0,[8,0,0,[0,2],0],caml_new_string("%.2f")],
     _ci_=caml_new_string("Resume"),
     _cj_=caml_new_string("Pause"),
     _ck_=caml_new_string("Fixed position"),
     _cl_=caml_new_string("Follow rotation"),
     _cm_=caml_new_string("Lighting"),
     _cn_=caml_new_string("Clip"),
     _ch_=[0,caml_new_string("examples/planet/planet.ml"),416,2],
     _cg_=[0,caml_new_string("examples/planet/planet.ml"),417,2],
     _cf_=[0,caml_new_string("examples/planet/planet.ml"),418,2],
     _ce_=[0,caml_new_string("examples/planet/planet.ml"),419,2];
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_gC_ = caml_wrap_exception(_gC_);
              if(_gC_[1] !== Sys_error)throw _gC_}
            var param$0=l;
            continue}
          return 0}}
       ...
       if(0 <= len)
        if((caml_ml_bytes_length(b) - len | 0) < ofs)
         ...
         {var r=caml_create_bytes(len);
          ...
          var _gB_=r,switch$0=1}
       else
        var switch$0=0;
      else
       var switch$0=0;
      if(! switch$0)var _gB_=invalid_arg(_l_);
      return caml_string_of_bytes(_gB_)}
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i)
       if(! (l < i))
        try
         {index_rec(s,l,i,c);var _gz_=1;return _gz_}
        catch(_gA_)
         {_gA_ = caml_wrap_exception(_gA_);
          if(_gA_ === Not_found)return 0;
          throw _gA_}
    ...
    function map(f,a)
     {var l=a.length - 1;
      if(0 === l)return [0];
      var r=caml_make_vect(l,caml_call1(f,a[1])),_gx_=l - 1 | 0,_gw_=1;
      if(! (_gx_ < 1))
       {var i=_gw_;
        for(;;)
    ...
    function _x_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_gv_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_gv_]}
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_gq_=height(lr);
            if(_gq_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _gr_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_gr_)}
            return invalid_arg(_p_)}
          return invalid_arg(_q_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_gs_=height(rl);
            if(_gs_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _gt_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_gt_)}
            return invalid_arg(_r_)}
          return invalid_arg(_s_)}
        var _gu_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_gu_]}
      var empty=0;
      ...
      function min_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _go_=param$0[1];
            if(_go_){var param$0=_go_;continue}
      ...
      function min_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _gn_=param$0[1];
            if(_gn_){var param$0=_gn_;continue}
            var d=param$0[3],v=param$0[2];
            return [0,[0,v,d]]}
          return 0}}
      function max_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _gk_=param$0[4],_gl_=param$0[3],_gm_=param$0[2];
            if(_gk_){var param$0=_gk_;continue}
            return [0,_gm_,_gl_]}
          throw Not_found}}
      function max_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _gh_=param$0[4],_gi_=param$0[3],_gj_=param$0[2];
            if(_gh_){var param$0=_gh_;continue}
            return [0,[0,_gj_,_gi_]]}
          return 0}}
         ...
         {var _gg_=param[1];
          if(_gg_)
           {var r=param[4],d=param[3],v=param[2];
            return bal(remove_min_binding(_gg_),v,d,r)}
          var r$0=param[4];
          return r$0}
        return invalid_arg(_t_)}
      function _fV_(t,match)
       {if(t)
         {if(match)
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _gd_=caml_call2(p,v,d);
            if(_gd_)
             {var _ge_=for_all(p,l);
              if(_ge_){var param$0=r;continue}
              var _gf_=_ge_}
            else
             var _gf_=_gd_;
            return _gf_}
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _ga_=caml_call2(p,v,d);
            if(_ga_)
             var _gb_=_ga_;
            else
             {var _gc_=exists(p,l);
              if(! _gc_){var param$0=r;continue}
              var _gb_=_gc_}
            return _gb_}
          return 0}}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _f8_=merge(f,r1,r2),
             _f9_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_f9_,_f8_)}}
        else
         if(! s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _f__=merge(f,r1$0,r2$0),
           _f$_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_f$_,_f__)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _f6_=concat(lf,rf);return [0,join(lt,v,d,rt),_f6_]}
          var _f7_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_f7_]}
        return _w_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _f3_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_f3_)
               {var _f4_=caml_call2(cmp,d1,d2);
                if(_f4_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_f2_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _f2_ | 0}
        return 0}
      ...
      function seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_f0_=cons_enum(t,rest);
          return [0,[0,k,v],function(_f1_){return seq_of_enum(_f0_,_f1_)}]}
        return 0}
      function to_seq(m)
       {var _fY_=cons_enum(m,0);
        return function(_fZ_){return seq_of_enum(_fY_,_fZ_)}}
       ...
       {var m$0=m,c=0;
        for(;;)
         {if(m$0)
           ...
           var _fW_=c;
          return function(_fX_){return seq_of_enum(_fW_,_fX_)}}}
      return [0,
              empty,
              is_empty,
              mem,
    ...
    function add(x,q)
     {var cell=[0,x,0],_fU_=q[3];
      return _fU_
              ?(q[1] = q[1] + 1 | 0,_fU_[2] = cell,q[3] = cell,0)
        ...
        {case 0:
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _fA_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _fB_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _fC_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _fD_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _fE_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _fF_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _fG_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _fH_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _fI_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _fJ_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _fK_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _fL_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _fM_=function(param){caml_call1(de$12,0);return 0},
           _fN_=function(param){caml_call1(ed$12,0);return 0},
           _fO_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _fP_=function(param){caml_call1(de$13,0);return 0},
           _fQ_=function(param){caml_call1(ed$13,0);return 0},
           _fR_=function(param){caml_call1(af$13,0);return 0};
          return [0,
        ...
        {case 0:
         ...
         case 2:
          ...
          if(typeof _eI_ !== "number" && 1 === _eI_[0])
           {var
             ...
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_eJ_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _eK_=type_padding(pad$0,fmtty),
           _eL_=_eK_[2],
           _eM_=_eK_[1];
         ...
         case 4:
          var
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _eN_=type_padprec(pad$1,prec,fmtty),
           _eO_=_eN_[3],
           _eP_=_eN_[2],
           _eQ_=_eN_[1];
          if(typeof _eO_ !== "number" && 2 === _eO_[0])
           {var
             fmtty_rest$3=_eO_[1],
             match$3=type_format_gen(fmt_rest$3,fmtty_rest$3),
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_eQ_,_eP_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _eR_=type_padprec(pad$2,prec$0,fmtty),
           _eS_=_eR_[3],
           _eT_=_eR_[2],
           _eU_=_eR_[1];
          if(typeof _eS_ !== "number" && 3 === _eS_[0])
           {var
             fmtty_rest$4=_eS_[1],
             match$4=type_format_gen(fmt_rest$4,fmtty_rest$4),
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_eU_,_eT_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _eV_=type_padprec(pad$3,prec$1,fmtty),
           _eW_=_eV_[3],
           _eX_=_eV_[2],
           _eY_=_eV_[1];
          if(typeof _eW_ !== "number" && 4 === _eW_[0])
           {var
             fmtty_rest$5=_eW_[1],
             match$5=type_format_gen(fmt_rest$5,fmtty_rest$5),
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_eY_,_eX_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _eZ_=type_padprec(pad$4,prec$2,fmtty),
           _e0_=_eZ_[3],
           _e1_=_eZ_[2],
           _e2_=_eZ_[1];
          if(typeof _e0_ !== "number" && 5 === _e0_[0])
           {var
             fmtty_rest$6=_e0_[1],
             match$6=type_format_gen(fmt_rest$6,fmtty_rest$6),
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_e2_,_e1_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _e3_=type_padprec(pad$5,prec$3,fmtty),
           _e4_=_e3_[3],
           _e5_=_e3_[2],
           _e6_=_e3_[1];
          if(typeof _e4_ !== "number" && 6 === _e4_[0])
           {var
             fmtty_rest$7=_e4_[1],
             match$7=type_format_gen(fmt_rest$7,fmtty_rest$7),
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_e6_,_e5_,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           pad$6=fmt[1],
           _e7_=type_padding(pad$6,fmtty),
           _e8_=_e7_[2],
           _e9_=_e7_[1];
          if(typeof _e8_ !== "number" && 7 === _e8_[0])
           {var
             fmtty_rest$8=_e8_[1],
             match$8=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$8[2],
             fmt$9=match$8[1];
            return [0,[9,_e9_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _e__=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_e__))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _e$_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_e$_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_e$_[1];
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _eF_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_eF_))
             throw Type_mismatch;
            var _eG_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_eG_))
             throw Type_mismatch;
            var
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _eE_=2 === padty$0?48:32,res=make(width$0,_eE_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           _eC_=match$0 - 32 | 0,
           switch$0=
            59 < _eC_ >>> 0?33 < (_eC_ - 61 | 0) >>> 0?1:0:2 === _eC_?1:0;
               ...
               {var _ez_=match - 34 | 0;
                if(58 < _ez_ >>> 0)
                 ...
                 if(56 < (_ez_ - 1 | 0) >>> 0)
                  ...
                  var switch$2=1;
                if(switch$2)var _eA_=1,switch$1=2}
              else
               var switch$1=11 <= match?13 === match?1:0:8 <= match?1:0;
              switch(switch$1)
               {case 0:var _eA_=4;break;case 1:var _eA_=2;break}
              n[1] = n[1] + _eA_ | 0;
              var _eB_=i$0 + 1 | 0;
              if(_ev_ !== i$0){var i$0=_eB_;continue}
              break}}
             ...
             {var i=_ew_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i);
                ...
                break}}
            var _eD_=s}
          var str$0=caml_string_of_bytes(_eD_)}
        var l=caml_ml_string_length(str$0),res=make(l + 2 | 0,34);
        caml_blit_string(str$0,0,res,1,l);
        return caml_string_of_bytes(res)}}
    function convert_int(iconv,n)
     {switch(iconv)
       {case 0:var _et_=_an_;break;
        case 1:var _et_=_ao_;break;
        case 2:var _et_=_ap_;break;
        case 3:var _et_=_aq_;break;
        case 4:var _et_=_ar_;break;
        case 5:var _et_=_as_;break;
        case 6:var _et_=_at_;break;
        case 7:var _et_=_au_;break;
        case 8:var _et_=_av_;break;
        case 9:var _et_=_aw_;break;
        case 10:var _et_=_ax_;break;
        case 11:var _et_=_ay_;break;
        default:var _et_=_az_}
      return caml_format_int(_et_,n)}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 0:var _es_=_aN_;break;
        case 1:var _es_=_aO_;break;
        case 2:var _es_=_aP_;break;
        case 3:var _es_=_aQ_;break;
        case 4:var _es_=_aR_;break;
        case 5:var _es_=_aS_;break;
        case 6:var _es_=_aT_;break;
        case 7:var _es_=_aU_;break;
        case 8:var _es_=_aV_;break;
        case 9:var _es_=_aW_;break;
        case 10:var _es_=_aX_;break;
        case 11:var _es_=_aY_;break;
        default:var _es_=_aZ_}
      return caml_format_int(_es_,n)}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 0:var _er_=_a0_;break;
        case 1:var _er_=_a1_;break;
        case 2:var _er_=_a2_;break;
        case 3:var _er_=_a3_;break;
        case 4:var _er_=_a4_;break;
        case 5:var _er_=_a5_;break;
        case 6:var _er_=_a6_;break;
        case 7:var _er_=_a7_;break;
        case 8:var _er_=_a8_;break;
        case 9:var _er_=_a9_;break;
        case 10:var _er_=_a__;break;
        case 11:var _er_=_a$_;break;
        default:var _er_=_ba_}
      return caml_format_int(_er_,n)}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 0:var _eq_=_aA_;break;
        case 1:var _eq_=_aB_;break;
        case 2:var _eq_=_aC_;break;
        case 3:var _eq_=_aD_;break;
        case 4:var _eq_=_aE_;break;
        case 5:var _eq_=_aF_;break;
        case 6:var _eq_=_aG_;break;
        case 7:var _eq_=_aH_;break;
        case 8:var _eq_=_aI_;break;
        case 9:var _eq_=_aJ_;break;
        case 10:var _eq_=_aK_;break;
        case 11:var _eq_=_aL_;break;
        default:var _eq_=_aM_}
      return caml_int64_format(_eq_,n)}
     ...
     {if(16 <= fconv)
        ...
        if(19 <= fconv)
         {var s=caml_bytes_of_string(s$0),l=caml_ml_bytes_length(s);
          if(0 === l)
           ...
           {var r=caml_create_bytes(l),_ej_=l - 1 | 0,_ei_=0;
            if(! (_ej_ < 0))
             {var i=_ei_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s,i);
                if(97 <= c)
                 if(122 < c)
                  ...
                  var _ek_=c - 32 | 0,switch$1=1;
                else
                 var switch$1=0;
                if(! switch$1)var _ek_=c;
                caml_bytes_unsafe_set(r,i,_ek_);
                var _el_=i + 1 | 0;
      ...
      if(15 === fconv)
       ...
       {var prec=abs(prec$0);
        ...
        var _en_=buffer_contents(buf)}
      var str=caml_format_float(_en_,x);
      if(15 === fconv)
        ...
        for(;;)
         {if(i$0 === len)
           ...
           {var
             ...
             _eo_=match - 46 | 0,
             switch$2=
              23 < _eo_ >>> 0?55 === _eo_?1:0:21 < (_eo_ - 1 | 0) >>> 0?1:0;
            if(! switch$2){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
            var _ep_=1}
          return _ep_?str:_a_(str,_bf_)}}
      return str}
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _eb_=pad$5[2],_ec_=pad$5[1];
               if(typeof prec$3 === "number")
                return 0 === prec$3
                        ?function(x)
                          {var
                            str=convert_float(fconv,default_float_precision,x),
                            str$0=fix_padding(_ec_,_eb_,str);
                           return make_printf(k$0,o,[4,acc$0,str$0],rest$7)}
                        :function(p,x)
                          {var str=fix_padding(_ec_,_eb_,convert_float(fconv,p,x));
                           return make_printf(k$0,o,[4,acc$0,str],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_ec_,_eb_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,o,[4,acc$0,str],rest$7)}}
             var _ed_=pad$5[1];
             if(typeof prec$3 === "number")
              return 0 === prec$3
                      ?function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision,x),
                          str$0=fix_padding(_ed_,w,str);
                         return make_printf(k$0,o,[4,acc$0,str$0],rest$7)}
                      :function(w,p,x)
                        {var str=fix_padding(_ed_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,o,[4,acc$0,str],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_ed_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,o,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _ee_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _ee_[2] === "number")
              {var fmt=_ee_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,o,acc$0,rest$19,arity,_ea_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,o,acc$0,rest$19,arity,_ea_])}}
    ...
    function make_invalid_arg(counter,k,o,acc,fmt)
     {var _d9_=[8,acc,_bm_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_d9_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_d9_,fmt])}
    function make_custom$0(counter,k,o,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_d8_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_d8_,rest])}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_d3_=0;
      return make_printf
              (function(o,acc){output_acc(o,acc);return 0},oc,_d3_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bu_;
      var _d1_=other_fields(x,i + 1 | 0),_d2_=field(x,i);
      return caml_call2(sprintf(_bv_),_d2_,_d1_)}
    function fields(x)
     {var match=x.length - 1;
      if(2 < match >>> 0)
       {var _dY_=other_fields(x,2),_dZ_=field(x,1);
        return caml_call2(sprintf(_bw_),_dZ_,_dY_)}
      switch(match)
       {case 0:return _bx_;
        case 1:return _by_;
        default:var _d0_=field(x,1);return caml_call1(sprintf(_bz_),_d0_)}}
        ...
        for(;;)
         {if(param$0)
           {var tl=param$0[2],hd=param$0[1];
            try {var _dW_=caml_call1(hd,x),_dV_=_dW_}catch(_dX_){var _dV_=0}
            if(_dV_){var s=_dV_[1];return s}
            var param$0=tl;
            continue}
           ...
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _dM_=slot[4],
              _dN_=slot[3],
              _dO_=slot[6]?_bJ_:_bL_,
              _dP_=slot[2],
              _dQ_=info(slot[1]),
              match=
               [0,caml_call6(sprintf(_bK_),_dQ_,_dP_,_dO_,_dN_,_dM_,_dL_)];
            else
             if(slot[1])
              var match=0;
             else
     ...
     {if(e.addEventListener === undefined$0)
       {var
         ...
         callback=
          function(e)
           {var _dG_=[0,h,e,[0]];
            return function(_dH_,_dI_){return caml_js_call(_dG_,_dH_,_dI_)}};
    ...
    function unsafeCreateElementEx(type,name,doc$0,elt)
     {for(;;)
       {if(0 === type)if(0 === name)return createElement(doc$0,elt);
        var _dA_=createElementSyntax[1];
        if(785140586 === _dA_)
         {try
           {var
             el=doc.createElement('<input name="x">'),
             _dD_=el.tagName.toLowerCase() === "input"?1:0,
             _dE_=_dD_?el.name === "x"?1:0:_dD_,
             _dB_=_dE_}
          catch(_dF_){var _dB_=0}
          var _dC_=_dB_?982028505:-1003883683;
          createElementSyntax[1] = _dC_;
          continue}
        if(982028505 <= _dA_)
    ...
    function add_implicitly_removed_callback(callbacks,f)
     {var
       node$0=[1,f],
       _dy_=callbacks[1],
       node=typeof _dy_ === "number"?node$0:[0,node$0,_dy_];
      callbacks[1] = node;
      return 0}
    var
    ...
    function handle_with_async_exception_hook(f,v)
     {try
       {var _dx_=caml_call1(f,v);return _dx_}
      catch(exn)
    ...
    function run_callbacks(callbacks,result)
     {if(1 === result[0])
       var _dv_=result[1] === Canceled?1:0,is_canceled=_dv_;
      else
       var is_canceled=0;
      if(is_canceled)
       {var
        ...
        iter_callback_list(_dt_,0)}
      var _du_=callbacks[1];
      ...
      return iter_callback_list$0(_du_,0)}
    var
      ...
      if(1 === current_callback_nesting_depth[1])
       for(;;)
        {if(0 !== q[1])
          {var _dq_=q[2];
           if(_dq_)
            {var _dr_=_dq_[1],_ds_=_dq_[2];
             if(_ds_)
              {q[1] = q[1] - 1 | 0;q[2] = _ds_}
             else
              {q[1] = 0;q[2] = 0;q[3] = 0}
             ...
             {var
              ...
              if(0 === j)
               {var
                ...
                caml_check_bound(faces,_c0_)[_c0_ + 1] = _cZ_;
                var
                 _c2_=(2 * k | 0) + 1 | 0,
                 _c1_=
                  [0,
                   ...
                   (k + t_div | 0) - 1 | 0];
                caml_check_bound(faces,_c2_)[_c2_ + 1] = _c1_}
              else
               {var
                 _c5_=2 * k | 0,
                 _c4_=[0,k,caml_mod(k + t_div | 0,north),k - 1 | 0];
                caml_check_bound(faces,_c5_)[_c5_ + 1] = _c4_;
                var
                 _c6_=caml_mod((k + t_div | 0) - 1 | 0,north),
                 _c8_=(2 * k | 0) + 1 | 0,
                 _c7_=[0,k - 1 | 0,caml_mod(k + t_div | 0,north),_c6_];
                caml_check_bound(faces,_c8_)[_c8_ + 1] = _c7_}
              var _c3_=j + 1 | 0;
    ...
    function create_canvas(w,h)
     {var c=unsafeCreateElement(doc,_b2_);
    ...
    function start(param$0)
     {function _cv_(texture)
       {var
        ...
        function update_texture(lighting,phi)
         {if(lighting)
          ...
          var
           ...
           _cJ_=_cI_?(ctx$0.drawImage(texture,0,0),no_lighting[1] = 1,0):_cI_;
          return _cJ_}
        var
        ...
        function br(param){return unsafeCreateElement(doc,_bZ_)}
        add$0
        ...
        var s=unsafeCreateElementEx(0,0,doc,_bU_),param$0=param;
        for(;;)
         {if(param$0)
           {var l=param$0[2],a=param$0[1],o$0=unsafeCreateElement(doc,_bT_);
          ...
          add$0(ctrl,form$0);
          add$0(doc.body,ctrl);
          var p=unsafeCreateElement(doc,_bY_);
          p.innerHTML
          =
               ...
               (doc,
                ...
                handler
                 (function(param)
                   {f(c1);
                    var _cF_=c2[1];
                    if(1 - (_cF_ == no_handler?1:0))f(_cF_);
                    return true$0}),
                true$0);
              return false$0});
          var
           ...
           loop=
            function(t,phi)
             {var rotation=xz_rotation(phi - phi_rot[1]);
              ...
              try {ctx$1.getImageData(0,0,1,1)}catch(_cE_){}
              var
              ...
              fps[1] = hz$0;
              var _cA_=fps[1];
              rateText.data = caml_call1(sprintf(_co_),_cA_).toString();
              ti[1] = t$0;
              function _cB_(param)
               {var
                 t$0=new date_ms().getTime(),
              ...
              return bind(sleep(0.01),_cB_)};
          return loop(new date_ms().getTime(),0)}}
      var v$0=unsafeCreateElement(doc,_b0_);
      ...
      v$0.src = src;
      var p=bind(bind(t,_cu_),_cv_),_ct_=underlying(p)[1];
      switch(_ct_[0])
