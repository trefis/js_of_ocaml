...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _z_=[0,caml_new_string("buffer.ml"),93,2],
     _y_=[0,caml_new_string("buffer.ml"),94,2],
     ...
     _bg_=[0,caml_new_string("camlinternalFormat.ml"),1555,4],
     _bh_=caml_new_string("Printf: bad conversion %["),
     _bj_=[0,caml_new_string("camlinternalFormat.ml"),1623,39],
     _bk_=[0,caml_new_string("camlinternalFormat.ml"),1646,31],
     ...
     _co_=[0,[8,[0,0,0],0,[0,2],0],caml_new_string("%.2f")],
     ...
     _ch_=[0,caml_new_string("examples/planet/planet.ml"),440,2],
     _cg_=[0,caml_new_string("examples/planet/planet.ml"),441,2],
     _cf_=[0,caml_new_string("examples/planet/planet.ml"),442,2],
     _ce_=[0,caml_new_string("examples/planet/planet.ml"),443,2];
       ...
       if(0 <= len)
        if((caml_ml_bytes_length(b) - len | 0) < ofs)
         ...
         {var r=caml_create_bytes(len);
          ...
          var _gF_=r,switch$0=1}
       else
        var switch$0=0;
      else
       var switch$0=0;
      if(! switch$0)var _gF_=invalid_arg(_k_);
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i)
       if(! (l < i))
        try
         {index_rec(s,l,i,c);var _gD_=1;return _gD_}
        catch(_gE_)
         {_gE_ = caml_wrap_exception(_gE_);
          if(_gE_ === Not_found)return 0;
          throw _gE_}
    ...
    function map(f,a)
     {var l=a.length - 1;
      if(0 === l)return [0];
      var r=caml_make_vect(l,caml_call1(f,a[1])),_gB_=l - 1 | 0,_gA_=1;
      if(! (_gB_ < 1))
       {var i=_gA_;
        for(;;)
    ...
    function _w_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_gz_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_gu_=height(lr);
            if(_gu_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _gv_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_gv_)}
            return invalid_arg(_o_)}
          return invalid_arg(_p_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_gw_=height(rl);
            if(_gw_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _gx_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_gx_)}
            return invalid_arg(_q_)}
          return invalid_arg(_r_)}
        var _gy_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_gy_]}
      var empty=0;
      ...
      function max_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _go_=param$0[4],_gp_=param$0[3],_gq_=param$0[2];
      ...
      function max_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _gl_=param$0[4],_gm_=param$0[3],_gn_=param$0[2];
            if(_gl_){var param$0=_gl_;continue}
            return [0,[0,_gn_,_gm_]]}
          return 0}}
         ...
         {var _gk_=param[1];
          if(_gk_)
           {var r=param[4],d=param[3],v=param[2];
            return bal(remove_min_binding(_gk_),v,d,r)}
          var r$0=param[4];
          return r$0}
        return invalid_arg(_s_)}
      function _fZ_(t,match)
       {if(t)
         {if(match)
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _gh_=caml_call2(p,v,d);
            if(_gh_)
             {var _gi_=for_all(p,l);
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _ge_=caml_call2(p,v,d);
            if(_ge_)
             var _gf_=_ge_;
            else
             {var _gg_=exists(p,l);
              if(! _gg_){var param$0=r;continue}
              var _gf_=_gg_}
            return _gf_}
          return 0}}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _ga_=merge(f,r1,r2),
             _gb_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_gb_,_ga_)}}
        else
         if(! s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _gc_=merge(f,r1$0,r2$0),
           _gd_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_gd_,_gc_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _f__=concat(lf,rf);return [0,join(lt,v,d,rt),_f__]}
          var _f$_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_f$_]}
        return _v_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _f7_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_f7_)
               {var _f8_=caml_call2(cmp,d1,d2);
                if(_f8_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_f6_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _f6_ | 0}
        return 0}
      ...
      function seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_f4_=cons_enum(t,rest);
          return [0,[0,k,v],function(_f5_){return seq_of_enum(_f4_,_f5_)}]}
        return 0}
      function to_seq(m)
       {var _f2_=cons_enum(m,0);
        return function(_f3_){return seq_of_enum(_f2_,_f3_)}}
       ...
       {var m$0=m,c=0;
        for(;;)
         {if(m$0)
           ...
           var _f0_=c;
          return function(_f1_){return seq_of_enum(_f0_,_f1_)}}}
      return [0,
              empty,
              is_empty,
              mem,
    ...
    function add(x,q)
     {var cell=[0,x,0],_fY_=q[3];
      return _fY_
              ?(q[1] = q[1] + 1 | 0,_fY_[2] = cell,q[3] = cell,0)
       ...
       switch(ty1[0])
        {case 0:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_ff_,rest2)];
         ...
         case 1:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_fg_,rest2$0)];
         ...
         case 2:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_fh_,rest2$1)];
         ...
         case 3:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_fi_,rest2$2)];
         ...
         case 4:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_fj_,rest2$3)];
         ...
         case 5:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_fk_,rest2$4)];
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_fl_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_fm_,rest2$6)];
          ...
          break;
         case 8:
          var _fn_=ty1[2],_fo_=ty1[1];
          if(typeof match === "number")
           var switch$9=1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_fp_=trans(_fn_,rest2$7);
              return [8,trans(_fo_,ty2),_fp_];
          ...
          break;
         case 9:
          var _fq_=ty1[3],_fr_=ty1[2],_fs_=ty1[1];
          if(typeof match === "number")
           var switch$10=1;
          else
           switch(match[0])
            {case 8:var switch$0=5,switch$10=0;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_fr_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_fs_,ty22,trans(_fq_,rest2$8)];
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_ft_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_fu_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_fv_,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_fw_,rest2$12)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$14=0;break;
             ...
             case 14:var rest2$13=match[1];return [14,trans(_fx_,rest2$13)];
     ...
     {var match=type_padding(pad,fmtty);
      if(typeof prec === "number")
       {if(0 === prec)
        ...
        var _fe_=match[2];
        if(typeof _fe_ !== "number" && 2 === _fe_[0])
         {var rest$0=_fe_[1],pad$1=match[1];return [0,pad$1,1,rest$0]}
        throw Type_mismatch}
        ...
        {case 0:
         ...
         case 2:
          ...
          if(typeof _eM_ !== "number" && 1 === _eM_[0])
           {var
             ...
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_eN_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _eO_=type_padding(pad$0,fmtty),
           _eP_=_eO_[2],
           _eQ_=_eO_[1];
         ...
         case 4:
          var
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _eR_=type_padprec(pad$1,prec,fmtty),
           _eS_=_eR_[3],
           _eT_=_eR_[2],
           _eU_=_eR_[1];
          if(typeof _eS_ !== "number" && 2 === _eS_[0])
           {var
             fmtty_rest$3=_eS_[1],
             match$3=type_format_gen(fmt_rest$3,fmtty_rest$3),
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_eU_,_eT_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _eV_=type_padprec(pad$2,prec$0,fmtty),
           _eW_=_eV_[3],
           _eX_=_eV_[2],
           _eY_=_eV_[1];
          if(typeof _eW_ !== "number" && 3 === _eW_[0])
           {var
             fmtty_rest$4=_eW_[1],
             match$4=type_format_gen(fmt_rest$4,fmtty_rest$4),
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_eY_,_eX_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _eZ_=type_padprec(pad$3,prec$1,fmtty),
           _e0_=_eZ_[3],
           _e1_=_eZ_[2],
           _e2_=_eZ_[1];
          if(typeof _e0_ !== "number" && 4 === _e0_[0])
           {var
             fmtty_rest$5=_e0_[1],
             match$5=type_format_gen(fmt_rest$5,fmtty_rest$5),
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_e2_,_e1_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _e3_=type_padprec(pad$4,prec$2,fmtty),
           _e4_=_e3_[3],
           _e5_=_e3_[2],
           _e6_=_e3_[1];
          if(typeof _e4_ !== "number" && 5 === _e4_[0])
           {var
             fmtty_rest$6=_e4_[1],
             match$6=type_format_gen(fmt_rest$6,fmtty_rest$6),
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_e6_,_e5_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _e7_=type_padprec(pad$5,prec$3,fmtty),
           _e8_=_e7_[3],
           _e9_=_e7_[2],
           _e__=_e7_[1];
          if(typeof _e8_ !== "number" && 6 === _e8_[0])
           {var
             fmtty_rest$7=_e8_[1],
             match$7=type_format_gen(fmt_rest$7,fmtty_rest$7),
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_e__,_e9_,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           pad$6=fmt[1],
           _e$_=type_padding(pad$6,fmtty),
           _fa_=_e$_[2],
           _fb_=_e$_[1];
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _fc_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_fc_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _fd_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_fd_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_fd_[1];
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _eJ_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_eJ_))
             throw Type_mismatch;
            var _eK_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_eK_))
             throw Type_mismatch;
            var
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _eI_=2 === padty$0?48:32,res=make(width$0,_eI_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           _eG_=match$0 - 32 | 0,
           switch$0=
            59 < _eG_ >>> 0?33 < (_eG_ - 61 | 0) >>> 0?1:0:2 === _eG_?1:0;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _ez_=caml_ml_bytes_length(s$0) - 1 | 0,
           _ey_=0;
          if(! (_ez_ < 0))
           {var i$0=_ey_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0);
              if(32 <= match)
               {var _eD_=match - 34 | 0;
                if(58 < _eD_ >>> 0)
                 if(93 <= _eD_)var switch$1=0,switch$2=0;else var switch$2=1;
                else
                 if(56 < (_eD_ - 1 | 0) >>> 0)
                  var switch$1=1,switch$2=0;
                 else
                  var switch$2=1;
                if(switch$2)var _eE_=1,switch$1=2}
              else
               var switch$1=11 <= match?13 === match?1:0:8 <= match?1:0;
              switch(switch$1)
               {case 0:var _eE_=4;break;case 1:var _eE_=2;break}
              n[1] = n[1] + _eE_ | 0;
              var _eF_=i$0 + 1 | 0;
              if(_ez_ !== i$0){var i$0=_eF_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _eB_=caml_ml_bytes_length(s$0) - 1 | 0,_eA_=0;
            if(! (_eB_ < 0))
             {var i=_eA_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i);
                ...
                break}}
            var _eH_=s}
          var str$0=caml_string_of_bytes(_eH_)}
        var l=caml_ml_string_length(str$0),res=make(l + 2 | 0,34);
        caml_blit_string(str$0,0,res,1,l);
        return caml_string_of_bytes(res)}}
    function transform_int_alt(iconv,s)
     {if(13 <= iconv)
       {var n=[0,0],_et_=caml_ml_string_length(s) - 1 | 0,_es_=0;
        if(! (_et_ < 0))
         {var i$0=_es_;
          for(;;)
           {var match=caml_string_unsafe_get(s,i$0),switcher$0=match - 48 | 0;
            ...
            var _ex_=i$0 + 1 | 0;
            if(_et_ !== i$0){var i$0=_ex_;continue}
            break}}
        var
         digits=n[1],
         buf=
         ...
         _ev_=caml_ml_string_length(s) - 1 | 0,
         _eu_=0;
        if(! (_ev_ < 0))
         {var i=_eu_;
          for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _er_=_ap_;break;
        ...
        default:var _er_=_aA_}
      return transform_int_alt(iconv,caml_format_int(_er_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _eq_=_aP_;break;
        case 2:var _eq_=_aQ_;break;
        case 4:var _eq_=_aS_;break;
        case 5:var _eq_=_aT_;break;
        case 6:var _eq_=_aU_;break;
        case 7:var _eq_=_aV_;break;
        case 8:var _eq_=_aW_;break;
        case 9:var _eq_=_aX_;break;
        case 10:var _eq_=_aY_;break;
        case 11:var _eq_=_aZ_;break;
        case 0:
        case 13:var _eq_=_aO_;break;
        case 3:
        case 14:var _eq_=_aR_;break;
        default:var _eq_=_a0_}
      return transform_int_alt(iconv,caml_format_int(_eq_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _ep_=_a2_;break;
        case 2:var _ep_=_a3_;break;
        case 4:var _ep_=_a5_;break;
        case 5:var _ep_=_a6_;break;
        case 6:var _ep_=_a7_;break;
        case 7:var _ep_=_a8_;break;
        case 8:var _ep_=_a9_;break;
        case 9:var _ep_=_a__;break;
        case 10:var _ep_=_a$_;break;
        case 11:var _ep_=_ba_;break;
        case 0:
        case 13:var _ep_=_a1_;break;
        case 3:
        case 14:var _ep_=_a4_;break;
        default:var _ep_=_bb_}
      return transform_int_alt(iconv,caml_format_int(_ep_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _eo_=_aC_;break;
        case 2:var _eo_=_aD_;break;
        case 4:var _eo_=_aF_;break;
        case 5:var _eo_=_aG_;break;
        case 6:var _eo_=_aH_;break;
        case 7:var _eo_=_aI_;break;
        case 8:var _eo_=_aJ_;break;
        case 9:var _eo_=_aK_;break;
        case 10:var _eo_=_aL_;break;
        case 11:var _eo_=_aM_;break;
        case 0:
        case 13:var _eo_=_aB_;break;
        case 3:
        case 14:var _eo_=_aE_;break;
        default:var _eo_=_aN_}
      return transform_int_alt(iconv,caml_int64_format(_eo_,n))}
               ...
               {var c=caml_bytes_unsafe_get(s,i);
                if(97 <= c)
                 if(122 < c)
                  ...
                  var _ej_=c - 32 | 0,switch$0=1;
                else
                 var switch$0=0;
                if(! switch$0)var _ej_=c;
        ...
        for(;;)
         {if(i$0 === len)
           ...
           {var
            ...
            var _en_=1}
          return _en_?str:symbol(str,_bf_)}}
      return str}
        ...
        function update_texture(lighting,phi)
         {if(lighting)
          ...
          var
           ...
           _cJ_=
            _cI_?(ctx$0.drawImage(texture,0.,0.),no_lighting[1] = 1,0):_cI_;
          return _cJ_}
        var
