...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _ak_=[0,caml_new_string("camlinternalFormat.ml"),811,21],
     _ac_=[0,caml_new_string("camlinternalFormat.ml"),812,21],
     _al_=[0,caml_new_string("camlinternalFormat.ml"),815,21],
     _ad_=[0,caml_new_string("camlinternalFormat.ml"),816,21],
     _am_=[0,caml_new_string("camlinternalFormat.ml"),819,19],
     _ae_=[0,caml_new_string("camlinternalFormat.ml"),820,19],
     _an_=[0,caml_new_string("camlinternalFormat.ml"),823,22],
     _af_=[0,caml_new_string("camlinternalFormat.ml"),824,22],
     _ao_=[0,caml_new_string("camlinternalFormat.ml"),828,30],
     _ag_=[0,caml_new_string("camlinternalFormat.ml"),829,30],
     _ai_=[0,caml_new_string("camlinternalFormat.ml"),833,26],
     _aa_=[0,caml_new_string("camlinternalFormat.ml"),834,26],
     _aj_=[0,caml_new_string("camlinternalFormat.ml"),843,28],
     _ab_=[0,caml_new_string("camlinternalFormat.ml"),844,28],
     _ah_=[0,caml_new_string("camlinternalFormat.ml"),848,23],
     _bl_=caml_new_string("%u"),
     _bj_=[0,caml_new_string("camlinternalFormat.ml"),1556,4],
     _bk_=caml_new_string("Printf: bad conversion %["),
     _bm_=[0,caml_new_string("camlinternalFormat.ml"),1624,39],
     _bn_=[0,caml_new_string("camlinternalFormat.ml"),1647,31],
     _bo_=[0,caml_new_string("camlinternalFormat.ml"),1648,31],
     ...
     _bS_=caml_new_string(""),
     _b4_=caml_new_string("Js.Error"),
     _b8_=caml_new_string("canvas"),
     _b6_=caml_new_string("p"),
     _b5_=caml_new_string("div"),
     _b7_=caml_new_string("Dom_html.Canvas_not_available"),
     _b9_=[0,caml_new_string("lib/js_of_ocaml/xmlHttpRequest.ml"),128,75],
     _b__=caml_new_string("[\\][()\\\\|+*.?{}^$]"),
     _ca_=caml_new_string(""),
     _cc_=caml_new_string(""),
     _b$_=caml_new_string("Url.Local_exn"),
     _cd_=
      caml_new_string
     ...
     _cA_=[0,0,0],
     _cD_=[0,caml_new_string("examples/graph_viewer/viewer_common.ml"),296,10],
     _cE_=[0,caml_new_string("examples/graph_viewer/viewer_common.ml"),299,10],
     _cB_=[0,caml_new_string("examples/graph_viewer/viewer_common.ml"),303,8],
     _cC_=[0,caml_new_string("examples/graph_viewer/viewer_common.ml"),306,8],
     _cy_=[0,caml_new_string("examples/graph_viewer/viewer_common.ml"),155,14],
     _c5_=[0,[4,0,0,0,[11,caml_new_string("px"),0]],caml_new_string("%dpx")],
     _c1_=[0,0.],
     _c2_=[0,0.],
     _c3_=[0,1.],
     _c4_=[0,20.],
     _c6_=caml_new_string("scene.json"),
     _cF_=[0,caml_new_string("examples/graph_viewer/viewer_js.ml"),145,26];
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_h9_ = caml_wrap_exception(_h9_);
              if(_h9_[1] !== Sys_error)throw _h9_;
              var _h8_=_h9_}
            var param$0=l;
            continue}
          return 0}}
    ...
    function iteri(f,a)
     {var _h6_=a.length - 1 - 1 | 0,_h5_=0;
      if(! (_h6_ < 0))
       {var i=_h5_;
        for(;;)
         {caml_call2(f,i,a[1 + i]);
          var _h7_=i + 1 | 0;
          if(_h6_ !== i){var i=_h7_;continue}
          break}}
      return 0}
    caml_fresh_oo_id(0);
    function _A_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_h4_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_h4_]}
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_hZ_=height(lr);
            if(_hZ_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _h0_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_h0_)}
            return invalid_arg(_s_)}
          return invalid_arg(_t_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_h1_=height(rl);
            if(_h1_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _h2_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_h2_)}
            return invalid_arg(_u_)}
          return invalid_arg(_v_)}
        var _h3_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_h3_]}
      var empty=0;
      ...
      function min_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _hW_=param$0[1];
            if(_hW_){var param$0=_hW_;continue}
            var d=param$0[3],v=param$0[2];
            return [0,[0,v,d]]}
          return 0}}
      function max_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _hT_=param$0[4],_hU_=param$0[3],_hV_=param$0[2];
            if(_hT_){var param$0=_hT_;continue}
            return [0,_hV_,_hU_]}
          throw Not_found}}
      function max_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _hQ_=param$0[4],_hR_=param$0[3],_hS_=param$0[2];
            if(_hQ_){var param$0=_hQ_;continue}
            return [0,[0,_hS_,_hR_]]}
          return 0}}
    ...
    function add(x,q)
     {var cell=[0,x,0],_hr_=q[3];
      return _hr_
              ?(q[1] = q[1] + 1 | 0,_hr_[2] = cell,q[3] = cell,0)
     ...
     {if(typeof formatting_lit === "number")
       ...
       switch(formatting_lit[0])
        {case 0:var str=formatting_lit[1];return str;
         ...
         default:var c=formatting_lit[1];return symbol(_J_,make$0(1,c))}}
       ...
       switch(ty1[0])
        {case 0:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_gK_,rest2)];
         ...
         case 1:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_gL_,rest2$0)];
         ...
         case 2:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_gM_,rest2$1)];
         ...
         case 3:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_gN_,rest2$2)];
         ...
         case 4:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_gO_,rest2$3)];
         ...
         case 5:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_gP_,rest2$4)];
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_gQ_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_gR_,rest2$6)];
          ...
          break;
         case 8:
          var _gS_=ty1[2],_gT_=ty1[1];
          if(typeof match === "number")
           var switch$9=1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_gU_=trans(_gS_,rest2$7);
              return [8,trans(_gT_,ty2),_gU_];
          ...
          break;
         case 9:
          var _gV_=ty1[3],_gW_=ty1[2],_gX_=ty1[1];
          if(typeof match === "number")
           var switch$10=1;
          else
           switch(match[0])
            {case 8:var switch$0=5,switch$10=0;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_gW_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_gX_,ty22,trans(_gV_,rest2$8)];
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_gY_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_gZ_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_g0_,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_g1_,rest2$12)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$14=0;break;
             ...
             case 14:var rest2$13=match[1];return [14,trans(_g2_,rest2$13)];
      ...
      if(typeof prec === "number")
       {if(0 === prec)
        ...
        if(typeof _gJ_ !== "number" && 2 === _gJ_[0])
         {var rest$0=_gJ_[1],pad$1=match[1];return [0,pad$1,1,rest$0]}
        throw Type_mismatch}
        ...
        {case 0:
         ...
         case 2:
          ...
          if(typeof _gf_ !== "number" && 1 === _gf_[0])
           {var
             ...
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_gg_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _gh_=type_padding(pad$0,fmtty),
           _gi_=_gh_[2],
           _gj_=_gh_[1];
         ...
         case 4:
          var
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _gk_=type_padprec(pad$1,prec,fmtty),
           _gl_=_gk_[3],
           _gm_=_gk_[2],
           _gn_=_gk_[1];
          if(typeof _gl_ !== "number" && 2 === _gl_[0])
           {var
             ...
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_gn_,_gm_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _go_=type_padprec(pad$2,prec$0,fmtty),
           _gp_=_go_[3],
           _gq_=_go_[2],
           _gr_=_go_[1];
          if(typeof _gp_ !== "number" && 3 === _gp_[0])
           {var
             ...
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_gr_,_gq_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _gs_=type_padprec(pad$3,prec$1,fmtty),
           _gt_=_gs_[3],
           _gu_=_gs_[2],
           _gv_=_gs_[1];
          if(typeof _gt_ !== "number" && 4 === _gt_[0])
           {var
             fmtty_rest$5=_gt_[1],
             match$5=type_format_gen(fmt_rest$5,fmtty_rest$5),
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_gv_,_gu_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _gw_=type_padprec(pad$4,prec$2,fmtty),
           _gx_=_gw_[3],
           _gy_=_gw_[2],
           _gz_=_gw_[1];
          if(typeof _gx_ !== "number" && 5 === _gx_[0])
           {var
             ...
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_gz_,_gy_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _gA_=type_padprec(pad$5,prec$3,fmtty),
           _gB_=_gA_[3],
           _gC_=_gA_[2],
           _gD_=_gA_[1];
          if(typeof _gB_ !== "number" && 6 === _gB_[0])
           {var
             fmtty_rest$7=_gB_[1],
             match$7=type_format_gen(fmt_rest$7,fmtty_rest$7),
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_gD_,_gC_,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           pad$6=fmt[1],
           _gE_=type_padding(pad$6,fmtty),
           _gF_=_gE_[2],
           _gG_=_gE_[1];
          if(typeof _gF_ !== "number" && 7 === _gF_[0])
           {var
             fmtty_rest$8=_gF_[1],
             match$8=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$8[2],
             fmt$9=match$8[1];
            return [0,[9,_gG_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _gH_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_gH_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _gI_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_gI_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_gI_[1];
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _gc_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_gc_))
             throw Type_mismatch;
            var _gd_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_gd_))
             throw Type_mismatch;
            var
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _gb_=2 === padty$0?48:32,res=make(width$0,_gb_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           _f$_=match$0 - 32 | 0,
           switch$0=
            59 < _f$_ >>> 0?33 < (_f$_ - 61 | 0) >>> 0?1:0:2 === _f$_?1:0;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _f4_=caml_ml_bytes_length(s$0) - 1 | 0,
           _f3_=0;
          if(! (_f4_ < 0))
           {var i$0=_f3_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0);
              if(32 <= match)
               {var _f8_=match - 34 | 0;
                if(58 < _f8_ >>> 0)
                 if(93 <= _f8_)var switch$1=0,switch$2=0;else var switch$2=1;
                else
                 if(56 < (_f8_ - 1 | 0) >>> 0)
                  var switch$1=1,switch$2=0;
                 else
                  var switch$2=1;
                if(switch$2)var _f9_=1,switch$1=2}
              else
               var switch$1=11 <= match?13 === match?1:0:8 <= match?1:0;
              switch(switch$1)
               {case 0:var _f9_=4;break;case 1:var _f9_=2;break}
              n[1] = n[1] + _f9_ | 0;
              var _f__=i$0 + 1 | 0;
              if(_f4_ !== i$0){var i$0=_f__;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _f6_=caml_ml_bytes_length(s$0) - 1 | 0,_f5_=0;
            if(! (_f6_ < 0))
             {var i=_f5_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i);
                ...
                n[1]++;
                var _f7_=i + 1 | 0;
                if(_f6_ !== i){var i=_f7_;continue}
                break}}
            var _ga_=s}
          var str$0=caml_string_of_bytes(_ga_)}
        var l=caml_ml_string_length(str$0),res=make(l + 2 | 0,34);
        caml_blit_string(str$0,0,res,1,l);
        return caml_string_of_bytes(res)}}
    function transform_int_alt(iconv,s)
     {if(13 <= iconv)
       {var n=[0,0],_fY_=caml_ml_string_length(s) - 1 | 0,_fX_=0;
        if(! (_fY_ < 0))
         {var i$0=_fX_;
          for(;;)
        ...
        var
         ...
         _f0_=caml_ml_string_length(s) - 1 | 0,
         _fZ_=0;
        if(! (_f0_ < 0))
         {var i=_fZ_;
          for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _fW_=_ar_;break;
        case 2:var _fW_=_as_;break;
        case 4:var _fW_=_au_;break;
        case 5:var _fW_=_av_;break;
        case 6:var _fW_=_aw_;break;
        case 7:var _fW_=_ax_;break;
        case 8:var _fW_=_ay_;break;
        case 9:var _fW_=_az_;break;
        case 10:var _fW_=_aA_;break;
        case 11:var _fW_=_aB_;break;
        case 0:
        case 13:var _fW_=_aq_;break;
        case 3:
        case 14:var _fW_=_at_;break;
        default:var _fW_=_aC_}
      return transform_int_alt(iconv,caml_format_int(_fW_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _fV_=_aR_;break;
        case 2:var _fV_=_aS_;break;
        case 4:var _fV_=_aU_;break;
        case 5:var _fV_=_aV_;break;
        case 6:var _fV_=_aW_;break;
        case 7:var _fV_=_aX_;break;
        case 8:var _fV_=_aY_;break;
        case 9:var _fV_=_aZ_;break;
        case 10:var _fV_=_a0_;break;
        case 11:var _fV_=_a1_;break;
        case 0:
        case 13:var _fV_=_aQ_;break;
        case 3:
        case 14:var _fV_=_aT_;break;
        default:var _fV_=_a2_}
      return transform_int_alt(iconv,caml_format_int(_fV_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _fU_=_a4_;break;
        case 2:var _fU_=_a5_;break;
        case 4:var _fU_=_a7_;break;
        case 5:var _fU_=_a8_;break;
        case 6:var _fU_=_a9_;break;
        case 7:var _fU_=_a__;break;
        case 8:var _fU_=_a$_;break;
        case 9:var _fU_=_ba_;break;
        case 10:var _fU_=_bb_;break;
        case 11:var _fU_=_bc_;break;
        case 0:
        case 13:var _fU_=_a3_;break;
        case 3:
        case 14:var _fU_=_a6_;break;
        default:var _fU_=_bd_}
      return transform_int_alt(iconv,caml_format_int(_fU_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _fT_=_aE_;break;
        case 2:var _fT_=_aF_;break;
        case 4:var _fT_=_aH_;break;
        case 5:var _fT_=_aI_;break;
        case 6:var _fT_=_aJ_;break;
        case 7:var _fT_=_aK_;break;
        case 8:var _fT_=_aL_;break;
        case 9:var _fT_=_aM_;break;
        case 10:var _fT_=_aN_;break;
        case 11:var _fT_=_aO_;break;
        case 0:
        case 13:var _fT_=_aD_;break;
        case 3:
        case 14:var _fT_=_aG_;break;
        default:var _fT_=_aP_}
      return transform_int_alt(iconv,caml_int64_format(_fT_,n))}
     ...
     {if(16 <= fconv)
        ...
        if(19 <= fconv)
         {var s=caml_bytes_of_string(s$0),l=caml_ml_bytes_length(s);
          if(0 === l)
           ...
           {var r=caml_create_bytes(l),_fM_=l - 1 | 0,_fL_=0;
            if(! (_fM_ < 0))
             {var i=_fL_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s,i);
                if(97 <= c)
                 if(122 < c)
                  ...
                  var _fN_=c - 32 | 0,switch$1=1;
                else
                 var switch$1=0;
                if(! switch$1)var _fN_=c;
                caml_bytes_unsafe_set(r,i,_fN_);
                var _fO_=i + 1 | 0;
      ...
      if(15 === fconv)
       ...
       {var prec=abs(prec$0);
        ...
        var _fQ_=buffer_contents(buf)}
      var str=caml_format_float(_fQ_,x);
      if(15 === fconv)
        ...
        for(;;)
         {if(i$0 === len)
           ...
           {var
             ...
             _fR_=match - 46 | 0,
             switch$2=
              23 < _fR_ >>> 0?55 === _fR_?1:0:21 < (_fR_ - 1 | 0) >>> 0?1:0;
            if(! switch$2){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
            var _fS_=1}
          return _fS_?str:symbol(str,_bi_)}}
      return str}
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _fE_=pad$5[2],_fF_=pad$5[1];
               if(typeof prec$3 === "number")
                return 0 === prec$3
                        ?function(x)
                          {var
                            str=convert_float(fconv,default_float_precision,x),
                            str$0=fix_padding(_fF_,_fE_,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)}
                        :function(p,x)
                          {var str=fix_padding(_fF_,_fE_,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_fF_,_fE_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _fG_=pad$5[1];
             if(typeof prec$3 === "number")
              return 0 === prec$3
                      ?function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision,x),
                          str$0=fix_padding(_fG_,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)}
                      :function(w,p,x)
                        {var str=fix_padding(_fG_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_fG_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _fH_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _fH_[2] === "number")
              {var fmt=_fH_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_fD_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_fD_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _fA_=[8,acc,_bp_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_fA_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_fA_,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_fz_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_fz_,rest])}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_fu_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_fu_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bx_;
      var _fs_=other_fields(x,i + 1 | 0),_ft_=field(x,i);
      return caml_call2(sprintf(_by_),_ft_,_fs_)}
    function fields(x)
     {var match=x.length - 1;
      if(2 < match >>> 0)
       {var _fp_=other_fields(x,2),_fq_=field(x,1);
        return caml_call2(sprintf(_bz_),_fq_,_fp_)}
      switch(match)
       {case 0:return _bA_;
        case 1:return _bB_;
        default:var _fr_=field(x,1);return caml_call1(sprintf(_bC_),_fr_)}}
        ...
        for(;;)
         {if(param$0)
           {var tl=param$0[2],hd=param$0[1];
            try {var _fn_=caml_call1(hd,x),_fm_=_fn_}catch(_fo_){var _fm_=0}
            if(_fm_){var s=_fm_[1];return s}
            var param$0=tl;
            continue}
    ...
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _fk_=a.length - 1 - 1 | 0,_fj_=0;
        if(! (_fk_ < 0))
         {var i=_fj_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _fd_=slot[4],
              _fe_=slot[3],
              _ff_=slot[6]?_bM_:_bO_,
              _fg_=slot[2],
              _fh_=info(slot[1]),
              match=
               [0,caml_call6(sprintf(_bN_),_fh_,_fg_,_ff_,_fe_,_fd_,_fc_)];
            else
             if(slot[1])
              var match=0;
             else
              var _fi_=info(0),match=[0,caml_call1(sprintf(_bP_),_fi_)];
    ...
    function f(s)
     {var accu=[0,0],_e$_=caml_ml_string_length(s) - 1 | 0,_e__=0;
      if(! (_e$_ < 0))
       {var i=_e__;
        for(;;)
         {var _fa_=caml_string_get(s,i);
          accu[1] = (223 * accu[1] | 0) + _fa_ | 0;
          var _fb_=i + 1 | 0;
    ...
    function new_table(pub_labels)
     {table_count[1]++;
      ...
      var _e4_=((fit_size(len) * 32 | 0) / 8 | 0) - 1 | 0;
      caml_check_bound(methods,1)[2] = _e4_;
      var _e6_=len - 1 | 0,_e5_=0;
      if(! (_e6_ < 0))
       {var i=_e5_;
        for(;;)
         {var
           _e8_=(i * 2 | 0) + 3 | 0,
           _e7_=caml_check_bound(pub_labels,i)[1 + i];
          caml_check_bound(methods,_e8_)[1 + _e8_] = _e7_;
          var _e9_=i + 1 | 0;
          if(_e6_ !== i){var i=_e9_;continue}
          break}}
      return [0,initial_object_size,methods,Meths[1],Labs[1],0,0,Vars[1],0]}
    function resize$0(array,new_size)
     {var len=array[2].length - 1,_e1_=len < new_size?1:0;
      if(_e1_)
       {var
         ...
         switch$0=
          0 <= len
           ?(_e2_.length - 1 - len | 0) < 0
             ?0
             :(a2.length - 1 - len | 0) < 0
               ?0
               :(caml_array_blit(_e2_,0,a2,0,len),1)
           :0;
    ...
    function get_method_label(table,name)
     {try
       {var _eZ_=caml_call2(Meths[27],name,table[3]);return _eZ_}
      catch(_e0_)
    ...
    function new_variable(table,name)
     {try
       {var _eX_=caml_call2(Vars[27],name,table[7]);return _eX_}
      catch(_eY_)
       {_eY_ = caml_wrap_exception(_eY_);
        if(_eY_ === Not_found)
         {var index=new_slot(table);
          if(caml_string_notequal(name,_bS_))
    ...
    var
     ...
     date_ms=window.Date,
     Error$0=[248,_b4_,caml_fresh_oo_id(0)],
     exn=[0,Error$0,{}],
      ...
      if(e.addEventListener === t37)
       {var
         ...
         callback=
          function(e)
           {var _eU_=[0,h,e,[0]];
            return function(_eV_,_eW_){return caml_js_call(_eU_,_eV_,_eW_)}};
    ...
    function createDiv(doc){return unsafeCreateElement(doc,_b5_)}
         ...
         {var
          ...
          try
           {var
             ...
             _eS_=function(callback){return req(callback)};
            return _eS_}
          catch(_eT_)
       ...
       {try
         ...
         {try
           ...
           {try
            ...
            catch(_eR_){throw [0,Assert_failure,_b9_]}}}}}
    function regexp(s)
     {return new regExp_withFlags(caml_jsbytes_of_string(s),"g")}
    new regExp_withFlags("[$]","g");
    var quote_re=regexp(_b__),Local_exn=[248,_b$_,caml_fresh_oo_id(0)];
    ...
    if(test$0(window.location))
     ...
     var
      t29="",
      t40=function(param,_eJ_){return 0},
      t39=function(param,_eI_){return 0},
    ...
    (function(param)
       {try
         {var _eG_=[0,caml_int_of_string(caml_js_to_byte_string(_cf_.port))];
          return _eG_}
        catch(_eH_)
    ...
    function aux(i)
     {try
       {var _eE_=index_from(s$1,i,47),j=_eE_}
      catch(_eF_)
    ...
    var a$0=aux(0);
    if(a$0)
     if(caml_string_notequal(a$0[1],_ca_))
      var switch$0=0;
     else
      var
       _cb_=a$0[2],
       switch$0=_cb_?caml_string_notequal(_cb_[1],_cc_)?0:_cb_[2]?0:1:1;
    else
     var switch$0=0;
    var
     _ch_=_cf_.search.charAt(0) === "?"?_cf_.search.slice(1):_cf_.search,
     arr=_ch_.split(make$0(1,38).toString()),
     len$0=arr.length;
            ...
            _ex_=
             function(s)
              {function _eC_(param)
               ...
               if(0 <= index)
                var
                 _eA_=s.slice(index + 1 | 0),
                 _eB_=[0,s.slice(0,index),_eA_];
               else
                var _eB_=t37;
    ...
    symbol(s$2,symbol(_c7_,git_version));
     ...
     {var _ev_=p[1];
      switch(_ev_[0])
       {case 0:return p;
        ...
        case 2:return p;
        default:
         var p$0=_ev_[1],p$1=underlying(p$0);
      ...
      if(1 === current_callback_nesting_depth[1])
       for(;;)
        {if(0 !== deferred_callbacks[1])
          {var _en_=deferred_callbacks[2];
           if(_en_)
            {var _eo_=_en_[1],_ep_=_en_[2];
             if(_ep_)
              {deferred_callbacks[1] = deferred_callbacks[1] - 1 | 0;
               deferred_callbacks[2] = _ep_}
             else
              {deferred_callbacks[1] = 0;
               deferred_callbacks[2] = 0;
               deferred_callbacks[3] = 0}
             var result=_eo_[2],callbacks=_eo_[1];
      ...
      switch(_el_[0])
       {case 1:return resolve(_cq_,0,outer_promise,p[1]);
        case 2:
         ...
         var
          _ej_=p_callbacks[2],
          _ek_=outer_callbacks[2],
          cancel_callbacks=
           typeof _ek_ === "number"
            ?_ej_
            :typeof _ej_ === "number"?_ek_:[0,_ek_,_ej_];
       ...
       {var p=new_pending([0,p$0]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
          ...
          try
           {var _ei_=caml_call1(f,v),p$0=_ei_}
       ...
       {case 1:return [0,_eg_];
        case 2:
         var
          ...
          node$0=[1,callback],
          _ef_=p_callbacks[1],
          node=typeof _ef_ === "number"?node$0:[0,node$0,_ef_];
         p_callbacks[1] = node;
         return p$1;
        default:
         var
         ...
         return run_callback_or_defer_it
                 (_cs_,function(param){return caml_call1(f,v)},_eh_)}}
      ...
      switch(_ed_[0])
       {case 1:
        ...
        case 2:
         ...
         return 0;
        default:return 0}}
    var pause_hook=[0,function(_ec_){return 0}],s1=create$0(0),_cv_=[0,0];
    ...
    function put_pixmap(param,x,y,xsrc,ysrc,width,height,_ea_)
     {var p=_ea_[1],c=param[2];
      return c.drawImage(p,xsrc,ysrc,width,height,x,y,width,height)}
    function get_pixmap(pm)
     {var _d$_=pm[1];
      if(_d$_){var p=_d$_[1];return p}
    ...
    function perform_draw(ctx,fill$0,stroke)
     {if(fill$0){var c=fill$0[1];fill(ctx,c)}
      ...
      return 0}
    function _cz_(st,scale,x$2,y$2,x$1,y$1,w,h)
     {var ctx=get_pixmap(st[8])[2];
      ctx.save();
      var
       _d6_=0 === st[1].length - 1?1:0,
       _d7_=_d6_?0 < st[2].length - 1?1:0:_d6_;
      if(_d7_)throw [0,Assert_failure,_cF_];
      ctx.beginPath();
       ...
       {var i$0=_d8_;
        for(;;)
         {var
           ...
           _d2_=x1$0 <= x4?1:0;
          if(_d2_)
           {var _d3_=y1$0 <= y4?1:0;
            if(_d3_)
             var _d4_=x3$0 <= x2$0?1:0,_d5_=_d4_?y3$0 <= y2$0?1:0:_d4_;
            else
             var _d5_=_d3_}
          else
           var _d5_=_d2_;
          ...
          var _d__=i$0 + 1 | 0;
          if(_d9_ !== i$0){var i$0=_d__;continue}
          break}}
      return ctx.restore()}
    var json=JSON;
     ...
     {var opt=[0,0];
      ...
      for(;;)
       {if(param)
         ...
         headers$0=
          function(s)
           {function _dX_(v){return [0,caml_js_to_string(v)]}
            ...
            return case$0
                    (req.getResponseHeader(caml_jsbytes_of_string(s)),_dY_,_dX_)},
         st=[0,382334108],
         do_check_headers=
          function(param)
           {if(382334108 === st[1])
                  ...
                  _dU_=
                   function(param)
                    {var x=req.responseXML;
                     ...
                     var match=case$0(x,function(param){return 0},_dW_);
                     if(match)
                      {var doc=match[1];
        ...
        return symbol_bind(res,_dT_)}}
    function getfile(f)
     {try
       {var _dQ_=return$0(caml_read_file_content(f));return _dQ_}
      catch(_dR_)
       {_dR_ = caml_wrap_exception(_dR_);
        if(_dR_ === Not_found)return http_get(f);
        throw _dR_}}
    if(public_methods === 0)
     ...
     {var i$1=_bT_;
      for(;;)
       {var
        ...
        caml_check_bound(res,i$1)[1 + i$1] = _b0_;
        var _b1_=i$1 + 1 | 0;
        if(_bU_ !== i$1){var i$1=_b1_;continue}
        break}}
    var _bW_=nvals - 1 | 0,_bV_=0;
    if(! (_bW_ < 0))
     {var i$0=_bV_;
      for(;;)
       {var
         _bY_=i$0 + nmeths | 0,
         _bX_=new_variable(table$0,caml_check_bound(vals,i$0)[1 + i$0]);
        caml_check_bound(res,_bY_)[1 + _bY_] = _bX_;
        var _bZ_=i$0 + 1 | 0;
        if(_bW_ !== i$0){var i$0=_bZ_;continue}
        break}}
    var
     _cO_=res[9],
     _cP_=res[10],
     ...
     _cM_=res[7],
     _cN_=res[8];
    function _cU_(self_1,lower,upper,step_incr,page_incr,page_size,param)
     {if(lower){var v=lower[1];self_1[1 + _cP_] = v}
      if(upper){var v$0=upper[1];self_1[1 + _cQ_] = v$0}
      if(step_incr){var v$1=step_incr[1];self_1[1 + _cR_] = v$1}
      if(page_incr){var v$2=page_incr[1];self_1[1 + _cS_] = v$2}
      if(page_size){var v$3=page_size[1];self_1[1 + _cT_] = v$3;return 0}
      return 0}
    function _cV_(self_1,v){self_1[1 + _cO_] = v;return 0}
    function _cW_(self_1){return self_1[1 + _cT_]}
    function _cX_(self_1){return self_1[1 + _cS_]}
    function _cY_(self_1){return self_1[1 + _cR_]}
    function _cZ_(self_1){return self_1[1 + _cQ_]}
    function _c0_(self_1){return self_1[1 + _cP_]}
    var
     methods=
      [0,
       _cG_,
       function(self_1){return self_1[1 + _cO_]},
       _cN_,
       _c0_,
       _cH_,
       _cZ_,
    ...
    for(;;)
     {if(i$2[1] < len)
       {var
         _b3_=i$2[1],
         label=caml_check_bound(methods,_b3_)[1 + _b3_],
         next=
          function(param)
           {i$2[1]++;
            var _dP_=i$2[1];
            return caml_check_bound(methods,_dP_)[1 + _dP_]},
         clo=next(0);
           ...
           case 19:
            var
             ...
             clo$0=
              function(n,m)
                {return function(obj)
                  {var _dN_=caml_call1(obj[1][1 + m],obj);
                   return caml_call2(obj[1][1 + n],obj,_dN_)}}
               (n$15,m$1);
            break;
           case 20:
            var
           ...
           case 22:
            var
             ...
             clo$0=
              function(m,e,n,c)
                {return function(obj)
                  {var _dL_=obj[1 + e][1 + n];
                   return caml_call2(caml_get_public_method(_dL_,m,0),_dL_,c)}}
               (m$4,e$4,n$17,c$1);
            break;
           default:
            var
             ...
             clo$0=
              function(m,n,c)
                {return function(obj)
                  {var _dO_=caml_call1(obj[1][1 + n],obj);
                        ...
                        (doc,
                         ...
                         handler
                          (function(param)
                            {f$11(c1);
                             var _dI_=c2[1];
                             if(1 - (_dI_ == no_handler?1:0))f$11(_dI_);
        ...
        handler
         (function(param)
           {var page=doc.documentElement;
            ...
            var started=[0,0],p=unsafeCreateElement(doc,_b6_);
            ...
            function callback(_dH_){return wakeup(w,_dH_)}
            var id=[0,0];
            function loop(step,param)
             {if(2147483000. < step)
              ...
              var
               cb=
                remain == 0.?callback:function(_dG_){return loop(remain,_dG_)};
            ...
            on_cancel
             (t,
              function(param)
               {var _dF_=id[1];
                if(_dF_)
                 {var x=_dF_[1];id[1] = 0;return window.clearTimeout(x)}
                return 0});
            symbol_bind(t,_c8_);
            function _c9_(s)
             {var
               _c__=json.parse(s.toString()),
               scene=_c__[3],
               bboxes=_c__[2],
               match=_c__[1],
               y2=match[4],
              ...
              var
               hadj=caml_call6(_b2_(0,0),0,0,0,0,0,0),
               vadj=caml_call6(_b2_(0,0),0,0,0,0,0,0),
               sadj=caml_call6(_b2_(0,0),0,_c4_,_c3_,_c2_,_c1_,0);
              function get_scale(param)
               {var _dE_=st[3];
                return Math.pow
                        (2.,
                         caml_call1(caml_get_public_method(sadj,834174833,369),sadj)
                         /
                         8.)
                       /
                       _dE_}
              ...
              function update_view(force)
               {var
                 ...
                 _dp_=[0,min(aw,st[6])];
                caml_call7
                 (caml_get_public_method(hadj,-635267918,370),
                  hadj,
                  0,
                  [0,st[6]],
                  [0,aw / 20.],
                ...
                if
                 (caml_call1(caml_get_public_method(hadj,834174833,372),hadj)
                  ...
                  0.)
                 caml_call2
                  (caml_get_public_method(hadj,-659372076,373),hadj,0.);
                if
                 (mv
                  <
                  caml_call1(caml_get_public_method(hadj,834174833,374),hadj))
                 caml_call2
                  (caml_get_public_method(hadj,-659372076,375),hadj,mv);
                var _dr_=[0,min(ah,st[7])];
                caml_call7
                 (caml_get_public_method(vadj,-635267918,376),
                  vadj,
                  0,
                  [0,st[7]],
                  [0,ah / 20.],
                ...
                if
                 (caml_call1(caml_get_public_method(vadj,834174833,378),vadj)
                  ...
                  0.)
                 caml_call2
                  (caml_get_public_method(vadj,-659372076,379),vadj,0.);
                if
                 (mv$0
                  <
                  caml_call1(caml_get_public_method(vadj,834174833,380),vadj))
                 caml_call2
                  (caml_get_public_method(vadj,-659372076,381),vadj,mv$0);
                var _dt_=1 - redraw_queued[1];
                return _dt_
                        ?(redraw_queued[1]
                          =
                          1,
                            ...
                            caml_js_wrap_callback
                             (function(param)
                               {redraw_queued[1] = 0;
                                   ...
                                   {var
                                    ...
                                    if(1 - _dv_)
                                     {var
                                       ...
                                       _dC_=0 !== dx?1:0,
                                       _dD_=_dC_ || (0 !== dy?1:0);
                                      if(_dD_)put_pixmap(p,dx,dy,0,0,r$1[3],r$1[4],p);
                                      var
                                       offset=
                                        function(p,l,d,m)
                                         {return 0 < ((p + d | 0) + l | 0)
                                      ...
                                      if(0 < height$0)
                                       if(0 < x)
                                        {if(! (width$1 <= (x + width$0 | 0)))
                                         ...
                                         _cz_(st,scale,x0$1,y0$1,0,y,x,height$0)}
                                       else
                                        {if(0 !== x)throw [0,Assert_failure,_cE_];
                                         if(width$0 < width$1)
                                          _cz_
                                           (st,
                                            scale,
                                      ...
                                      if(0 < y)
                                       {if(! (height$1 <= (y + height$0 | 0)))
                                        ...
                                        _cz_(st,scale,x0$1,y0$1,0,0,width$1,y)}
                                      else
                                       {if(0 !== y)throw [0,Assert_failure,_cC_];
                                ...
                                var
                                 r$0=pm[4],
                                 _dA_=r$0[3] < (width$1 | 0)?1:0,
                                 _dy_=_dA_ || (r$0[4] < (height$1 | 0)?1:0);
                                if(_dy_)
                                 {_cz_(st,scale,x0$1,y0$1,0,0,width$1,height$1);
                                  pm[4] = [0,x0$1,y0$1,width$1,height$1]}
                                var _dz_=get_pixmap(pm);
                                return put_pixmap
              ...
              caml_call7
               (caml_get_public_method(sadj,-635267918,368),
                sadj,
                0,
                [0,count],
                0,
              ...
              function points(d)
               {return caml_call1(sprintf(_c5_),d).toString()}
              var
               size_px=points(size),
               pos=[0,height],
               thumb=createDiv(doc),
              ...
              function set_slider_position(pos$0)
               {var _dl_=pos$0 !== pos[1]?1:0;
                if(_dl_)
                 {var _dm_=points(pos$0);
                  thumb.style.top = _dm_;
                  pos[1] = pos$0;
                  caml_call2
               ...
               (window$0,
                function(dx,dy)
                 {var scale=get_scale(0);
                  function offset(a,d)
                   {var
                     _dj_=caml_call1(caml_get_public_method(a,307110897,423),a),
                     _dk_=
              ...
              function bump_scale(x,y,v)
               {var
                 ...
                 _dh_=
                  ...
                  v
                  *
                  caml_call1(caml_get_public_method(sadj,-292814788,428),sadj),
                 _di_=
                  max
                   (caml_call1
                 ...
                 handler
                  (function(e)
                    {function _dd_(param){return 0}
                     var dx=(- get(e.wheelDeltaX,_dd_) | 0) / 40 | 0;
                     function _de_(param){return e.wheelDelta}
                     var dy=(- get(e.wheelDeltaY,_de_) | 0) / 40 | 0;
                     return h$0(e,dx,dy)}),
                 capt);
              else
               addEventListener
               ...
               {var match=ev.keyCode,switcher=match - 37 | 0;
                ...
                switch(switcher)
                 {case 0:
                   var
                    _c$_=
                     caml_call1(caml_get_public_method(hadj,-292814788,435),hadj);
                   caml_call2
                  ...
                  case 1:
                   var
                    _da_=
                     caml_call1(caml_get_public_method(vadj,-292814788,438),vadj);
                   caml_call2
