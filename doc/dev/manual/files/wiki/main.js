...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _P_=[0,caml_new_string("camlinternalFormat.ml"),847,23],
     ___=[0,caml_new_string("camlinternalFormat.ml"),811,21],
     _S_=[0,caml_new_string("camlinternalFormat.ml"),812,21],
     _$_=[0,caml_new_string("camlinternalFormat.ml"),815,21],
     _T_=[0,caml_new_string("camlinternalFormat.ml"),816,21],
     _aa_=[0,caml_new_string("camlinternalFormat.ml"),819,19],
     _U_=[0,caml_new_string("camlinternalFormat.ml"),820,19],
     _ab_=[0,caml_new_string("camlinternalFormat.ml"),823,22],
     _V_=[0,caml_new_string("camlinternalFormat.ml"),824,22],
     _ac_=[0,caml_new_string("camlinternalFormat.ml"),828,30],
     _W_=[0,caml_new_string("camlinternalFormat.ml"),829,30],
     _Y_=[0,caml_new_string("camlinternalFormat.ml"),833,26],
     _Q_=[0,caml_new_string("camlinternalFormat.ml"),834,26],
     _Z_=[0,caml_new_string("camlinternalFormat.ml"),843,28],
     _R_=[0,caml_new_string("camlinternalFormat.ml"),844,28],
     _X_=[0,caml_new_string("camlinternalFormat.ml"),848,23],
     _a$_=caml_new_string("%u"),
     _a9_=[0,caml_new_string("camlinternalFormat.ml"),1556,4],
     _a__=caml_new_string("Printf: bad conversion %["),
     _ba_=[0,caml_new_string("camlinternalFormat.ml"),1624,39],
     _bb_=[0,caml_new_string("camlinternalFormat.ml"),1647,31],
     _bc_=[0,caml_new_string("camlinternalFormat.ml"),1648,31],
     ...
     _bG_=caml_new_string("Js_of_ocaml__Js.Error"),
     _bM_=caml_new_string("iframe"),
     _bL_=caml_new_string("img"),
     _bK_=caml_new_string("a"),
     _bJ_=caml_new_string("br"),
     _bI_=caml_new_string("div"),
     _bH_=caml_new_string("textarea"),
     _bW_=[0,0],
     _bX_=[0,1],
     _bU_=[0,0],
     _bV_=[0,1],
     ...
     _bQ_=[0,[11,caml_new_string("Lwt."),[2,0,0]],caml_new_string("Lwt.%s")],
     _bR_=[0,0],
     _bN_=caml_new_string("Fatal error: exception "),
     _bO_=caml_new_string("Lwt.Resolution_loop.Canceled"),
     _bZ_=caml_new_string("Exception during Lwt.async: "),
     _b3_=[0,caml_new_string("examples/wiki/wikicreole.mll"),207,32],
     _b4_=[0,caml_new_string("examples/wiki/wikicreole.mll"),216,6],
     _b5_=[0,caml_new_string("examples/wiki/wikicreole.mll"),231,6],
     _b7_=[0,caml_new_string("examples/wiki/wikicreole.mll"),285,6],
     _b8_=caml_new_string("*"),
     _b6_=[5,0],
     _b2_=[0,caml_new_string("examples/wiki/wikicreole.mll"),158,6],
     _b1_=caml_new_string("//"),
     _b0_=caml_new_string("**"),
     _cp_=caml_new_string("http://youtube.com/embed/"),
     _cf_=caml_new_string("ul"),
     _cd_=caml_new_string("ol"),
     _b$_=caml_new_string("th"),
     _ca_=caml_new_string("td"),
     _cw_=[0,caml_new_string("examples/wiki/main.ml"),33,70],
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_go_ = caml_wrap_exception(_go_);
              if(_go_[1] !== Sys_error)throw _go_;
              var _gn_=_go_}
            var param$0=l;
            continue}
          return 0}}
    ...
    function engine(tbl,state,buf)
     {var
       ...
       _gk_=0 <= result?1:0,
       _gl_=_gk_?buf[12] !== dummy_pos?1:0:_gk_;
      if(_gl_)
       {buf[11] = buf[12];
        var _gm_=buf[12];
        buf[12] = [0,_gm_[1],_gm_[2],_gm_[3],buf[4] + buf[6] | 0]}
      return result}
    ...
    function add(x,q)
     {var cell=[0,x,0],_gj_=q[3];
      return _gj_
              ?(q[1] = q[1] + 1 | 0,_gj_[2] = cell,q[3] = cell,0)
       ...
       switch(formatting_lit[0])
        {case 0:var str=formatting_lit[1];return str;
         ...
         default:
          ...
          return symbol(_x_,caml_string_of_bytes(make(1,c)))}}
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
         _fV_=function(param){return 0},
         _fW_=function(param){return 0},
         _fX_=function(param){return 0};
        return [0,function(param){return 0},_fX_,_fW_,_fV_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _fY_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_fY_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _fZ_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _f0_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _f1_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _f2_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _f3_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _f4_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _f5_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _f6_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _f7_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _f8_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _f9_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _f__=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _f$_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _ga_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _gb_=function(param){caml_call1(de$12,0);return 0},
           _gc_=function(param){caml_call1(ed$12,0);return 0},
           _gd_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _ge_=function(param){caml_call1(de$13,0);return 0},
           _gf_=function(param){caml_call1(ed$13,0);return 0},
           _gg_=function(param){caml_call1(af$13,0);return 0};
          return [0,
       ...
       switch(ty1[0])
        {case 0:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_fC_,rest2)];
         ...
         case 1:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_fD_,rest2$0)];
         ...
         case 2:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_fE_,rest2$1)];
         ...
         case 3:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_fF_,rest2$2)];
         ...
         case 4:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_fG_,rest2$3)];
         ...
         case 5:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_fH_,rest2$4)];
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_fI_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_fJ_,rest2$6)];
          ...
          break;
         case 8:
          var _fK_=ty1[2],_fL_=ty1[1];
          if(typeof match === "number")
           var switch$9=1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_fM_=trans(_fK_,rest2$7);
              return [8,trans(_fL_,ty2),_fM_];
          ...
          break;
         case 9:
          var _fN_=ty1[3],_fO_=ty1[2],_fP_=ty1[1];
          if(typeof match === "number")
           var switch$10=1;
          else
           switch(match[0])
            {case 8:var switch$0=5,switch$10=0;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_fO_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_fP_,ty22,trans(_fN_,rest2$8)];
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_fQ_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_fR_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_fS_,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_fT_,rest2$12)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$14=0;break;
             ...
             case 14:var rest2$13=match[1];return [14,trans(_fU_,rest2$13)];
      ...
      if(typeof prec === "number")
       {if(0 === prec)
        ...
        if(typeof _fB_ !== "number" && 2 === _fB_[0])
         {var rest$0=_fB_[1],pad$1=match[1];return [0,pad$1,1,rest$0]}
        throw Type_mismatch}
        ...
        {case 0:
         ...
         case 2:
          ...
          if(typeof _e9_ !== "number" && 1 === _e9_[0])
           {var
             ...
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_e__,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _e$_=type_padding(pad$0,fmtty),
           _fa_=_e$_[2],
           _fb_=_e$_[1];
         ...
         case 4:
          var
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _fc_=type_padprec(pad$1,prec,fmtty),
           _fd_=_fc_[3],
           _fe_=_fc_[2],
           _ff_=_fc_[1];
          if(typeof _fd_ !== "number" && 2 === _fd_[0])
           {var
             ...
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_ff_,_fe_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _fg_=type_padprec(pad$2,prec$0,fmtty),
           _fh_=_fg_[3],
           _fi_=_fg_[2],
           _fj_=_fg_[1];
          if(typeof _fh_ !== "number" && 3 === _fh_[0])
           {var
             fmtty_rest$4=_fh_[1],
             match$4=type_format_gen(fmt_rest$4,fmtty_rest$4),
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_fj_,_fi_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _fk_=type_padprec(pad$3,prec$1,fmtty),
           _fl_=_fk_[3],
           _fm_=_fk_[2],
           _fn_=_fk_[1];
          if(typeof _fl_ !== "number" && 4 === _fl_[0])
           {var
             fmtty_rest$5=_fl_[1],
             match$5=type_format_gen(fmt_rest$5,fmtty_rest$5),
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_fn_,_fm_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _fo_=type_padprec(pad$4,prec$2,fmtty),
           _fp_=_fo_[3],
           _fq_=_fo_[2],
           _fr_=_fo_[1];
          if(typeof _fp_ !== "number" && 5 === _fp_[0])
           {var
             fmtty_rest$6=_fp_[1],
             match$6=type_format_gen(fmt_rest$6,fmtty_rest$6),
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_fr_,_fq_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _fs_=type_padprec(pad$5,prec$3,fmtty),
           _ft_=_fs_[3],
           _fu_=_fs_[2],
           _fv_=_fs_[1];
          if(typeof _ft_ !== "number" && 6 === _ft_[0])
           {var
             fmtty_rest$7=_ft_[1],
             match$7=type_format_gen(fmt_rest$7,fmtty_rest$7),
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_fv_,_fu_,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           pad$6=fmt[1],
           _fw_=type_padding(pad$6,fmtty),
           _fx_=_fw_[2],
           _fy_=_fw_[1];
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _fA_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_fA_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_fA_[1];
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _e6_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_e6_))
             throw Type_mismatch;
            var _e7_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_e7_))
             throw Type_mismatch;
            var
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _e5_=2 === padty$0?48:32,res=make(width$0,_e5_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           _e3_=match$0 - 32 | 0,
           switch$0=
            59 < _e3_ >>> 0?33 < (_e3_ - 61 | 0) >>> 0?1:0:2 === _e3_?1:0;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _eW_=caml_ml_bytes_length(s$0) - 1 | 0,
           _eV_=0;
          if(! (_eW_ < 0))
           {var i$0=_eV_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0);
              if(32 <= match)
               {var _e0_=match - 34 | 0;
                if(58 < _e0_ >>> 0)
                 if(93 <= _e0_)var switch$1=0,switch$2=0;else var switch$2=1;
                else
                 if(56 < (_e0_ - 1 | 0) >>> 0)
                  var switch$1=1,switch$2=0;
                 else
                  var switch$2=1;
                if(switch$2)var _e1_=1,switch$1=2}
              else
               var switch$1=11 <= match?13 === match?1:0:8 <= match?1:0;
              switch(switch$1)
               {case 0:var _e1_=4;break;case 1:var _e1_=2;break}
              n[1] = n[1] + _e1_ | 0;
              var _e2_=i$0 + 1 | 0;
              if(_eW_ !== i$0){var i$0=_e2_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _eY_=caml_ml_bytes_length(s$0) - 1 | 0,_eX_=0;
            if(! (_eY_ < 0))
             {var i=_eX_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i);
                ...
                break}}
            var _e4_=s}
          var str$0=caml_string_of_bytes(_e4_)}
        var l=caml_ml_string_length(str$0),res=make(l + 2 | 0,34);
        caml_blit_string(str$0,0,res,1,l);
        return caml_string_of_bytes(res)}}
    function transform_int_alt(iconv,s)
     {if(13 <= iconv)
       {var n=[0,0],_eQ_=caml_ml_string_length(s) - 1 | 0,_eP_=0;
        if(! (_eQ_ < 0))
         {var i$0=_eP_;
          for(;;)
           {var match=caml_string_unsafe_get(s,i$0),switcher$0=match - 48 | 0;
            ...
            var _eU_=i$0 + 1 | 0;
            if(_eQ_ !== i$0){var i$0=_eU_;continue}
            break}}
        var
         digits=n[1],
         buf=
         ...
         _eS_=caml_ml_string_length(s) - 1 | 0,
         _eR_=0;
        if(! (_eS_ < 0))
         {var i=_eR_;
          for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _eO_=_af_;break;
        case 2:var _eO_=_ag_;break;
        case 4:var _eO_=_ai_;break;
        case 5:var _eO_=_aj_;break;
        case 6:var _eO_=_ak_;break;
        case 7:var _eO_=_al_;break;
        case 8:var _eO_=_am_;break;
        case 9:var _eO_=_an_;break;
        case 10:var _eO_=_ao_;break;
        case 11:var _eO_=_ap_;break;
        case 0:
        case 13:var _eO_=_ae_;break;
        case 3:
        case 14:var _eO_=_ah_;break;
        default:var _eO_=_aq_}
      return transform_int_alt(iconv,caml_format_int(_eO_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _eN_=_aF_;break;
        case 2:var _eN_=_aG_;break;
        case 4:var _eN_=_aI_;break;
        case 5:var _eN_=_aJ_;break;
        case 6:var _eN_=_aK_;break;
        case 7:var _eN_=_aL_;break;
        case 8:var _eN_=_aM_;break;
        case 9:var _eN_=_aN_;break;
        case 10:var _eN_=_aO_;break;
        case 11:var _eN_=_aP_;break;
        case 0:
        case 13:var _eN_=_aE_;break;
        case 3:
        case 14:var _eN_=_aH_;break;
        default:var _eN_=_aQ_}
      return transform_int_alt(iconv,caml_format_int(_eN_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _eM_=_aS_;break;
        case 2:var _eM_=_aT_;break;
        case 4:var _eM_=_aV_;break;
        case 5:var _eM_=_aW_;break;
        case 6:var _eM_=_aX_;break;
        case 7:var _eM_=_aY_;break;
        case 8:var _eM_=_aZ_;break;
        case 9:var _eM_=_a0_;break;
        case 10:var _eM_=_a1_;break;
        case 11:var _eM_=_a2_;break;
        case 0:
        case 13:var _eM_=_aR_;break;
        case 3:
        case 14:var _eM_=_aU_;break;
        default:var _eM_=_a3_}
      return transform_int_alt(iconv,caml_format_int(_eM_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _eL_=_as_;break;
        case 2:var _eL_=_at_;break;
        case 4:var _eL_=_av_;break;
        case 5:var _eL_=_aw_;break;
        case 6:var _eL_=_ax_;break;
        case 7:var _eL_=_ay_;break;
        case 8:var _eL_=_az_;break;
        case 9:var _eL_=_aA_;break;
        case 10:var _eL_=_aB_;break;
        case 11:var _eL_=_aC_;break;
        case 0:
        case 13:var _eL_=_ar_;break;
        case 3:
        case 14:var _eL_=_au_;break;
        default:var _eL_=_aD_}
      return transform_int_alt(iconv,caml_int64_format(_eL_,n))}
        ...
        if(19 <= fconv)
         {var s=caml_bytes_of_string(s$0),l=caml_ml_bytes_length(s);
          if(0 === l)
           ...
           {var r=caml_create_bytes(l),_eE_=l - 1 | 0,_eD_=0;
            if(! (_eE_ < 0))
             {var i=_eD_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s,i);
                if(97 <= c)
                 if(122 < c)
                  ...
                  var _eF_=c - 32 | 0,switch$1=1;
                else
                 var switch$1=0;
                if(! switch$1)var _eF_=c;
                caml_bytes_unsafe_set(r,i,_eF_);
                var _eG_=i + 1 | 0;
                if(_eE_ !== i){var i=_eG_;continue}
                break}}
            var _eH_=r}
          return caml_string_of_bytes(_eH_)}
        return s$0}
      if(15 === fconv)
       var _eI_=_a4_;
      else
        ...
        for(;;)
         {if(i$0 === len)
           ...
           {var
            ...
            var _eK_=1}
          return _eK_?str:symbol(str,_a8_)}}
      return str}
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _ew_=pad$5[2],_ex_=pad$5[1];
               if(typeof prec$3 === "number")
                return 0 === prec$3
                        ?function(x)
                          {var
                            str=convert_float(fconv,default_float_precision,x),
                            str$0=fix_padding(_ex_,_ew_,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)}
                        :function(p,x)
                          {var str=fix_padding(_ex_,_ew_,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_ex_,_ew_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _ey_=pad$5[1];
             if(typeof prec$3 === "number")
              return 0 === prec$3
                      ?function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision,x),
                          str$0=fix_padding(_ey_,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)}
                      :function(w,p,x)
                        {var str=fix_padding(_ey_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_ey_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _ez_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _ez_[2] === "number")
              {var fmt=_ez_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_ev_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_ev_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _es_=[8,acc,_bd_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_es_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_es_,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_er_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_er_,rest])}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_em_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_em_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bl_;
      var _ek_=other_fields(x,i + 1 | 0),_el_=field(x,i);
      return caml_call2(sprintf(_bm_),_el_,_ek_)}
    function fields(x)
     {var match=x.length - 1;
      if(2 < match >>> 0)
       {var _eh_=other_fields(x,2),_ei_=field(x,1);
        return caml_call2(sprintf(_bn_),_ei_,_eh_)}
      switch(match)
       {case 0:return _bo_;
        case 1:return _bp_;
        default:var _ej_=field(x,1);return caml_call1(sprintf(_bq_),_ej_)}}
        ...
        for(;;)
         {if(param$0)
           {var tl=param$0[2],hd=param$0[1];
            try {var _ef_=caml_call1(hd,x),_ee_=_ef_}catch(_eg_){var _ee_=0}
            if(_ee_){var s=_ee_[1];return s}
            var param$0=tl;
            continue}
          if(x === Out_of_memory)return _br_;
          if(x === Stack_overflow)return _bs_;
    ...
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _ec_=a.length - 1 - 1 | 0,_eb_=0;
        if(! (_ec_ < 0))
         {var i=_eb_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _d7_=slot[4],
              _d8_=slot[3],
              _d9_=slot[6]?_bA_:_bC_,
              _d__=slot[2],
              _d$_=info(slot[1]),
              match=
               [0,caml_call6(sprintf(_bB_),_d$_,_d__,_d9_,_d8_,_d7_,_d6_)];
            else
             if(slot[1])
              var match=0;
             else
              var _ea_=info(0),match=[0,caml_call1(sprintf(_bD_),_ea_)];
    ...
    var
     ...
     Error=[248,_bG_,caml_fresh_oo_id(0)],
     exn=[0,Error,{}],
    ...
    function unsafeCreateElementEx(type,name,doc$0,elt)
     {for(;;)
       {if(0 === type)if(0 === name)return createElement(doc$0,elt);
        ...
        if(785140586 === _d0_)
         {try
           {var
             ...
             _d3_=el.tagName.toLowerCase() === "input"?1:0,
             _d4_=_d3_?el.name === "x"?1:0:_d3_,
             _d1_=_d4_}
          catch(_d5_){var _d1_=0}
          var _d2_=_d1_?982028505:-1003883683;
        ...
        return res}}
    function createDiv(doc){return unsafeCreateElement(doc,_bI_)}
    caml_fresh_oo_id(0);
     ...
     {var _dZ_=p[1];
      switch(_dZ_[0])
       {case 0:return p;
        ...
        case 2:return p;
        default:
         var p$0=_dZ_[1],p$1=underlying(p$0);
    ...
    function handle_with_async_exception_hook(f,v)
     {try
       {var _dY_=caml_call1(f,v);return _dY_}
      catch(exn)
       {exn = caml_wrap_exception(exn);
        return caml_call1(async_exception_hook[1],exn)}}
    var Canceled=[248,_bO_,caml_fresh_oo_id(0)];
    function run_callbacks(callbacks,result)
     {if(1 === result[0])
       var _dW_=result[1] === Canceled?1:0,is_canceled=_dW_;
      else
       var is_canceled=0;
      if(is_canceled)
       {var
        ...
        iter_callback_list(_dU_,0)}
      var _dV_=callbacks[1];
      ...
      return iter_callback_list$0(_dV_,0)}
    var
      ...
      if(1 === current_callback_nesting_depth[1])
       for(;;)
        {if(0 !== deferred_callbacks[1])
          {var _dR_=deferred_callbacks[2];
           if(_dR_)
            {var _dS_=_dR_[1],_dT_=_dR_[2];
             if(_dT_)
              {deferred_callbacks[1] = deferred_callbacks[1] - 1 | 0;
               deferred_callbacks[2] = _dT_}
             else
              {deferred_callbacks[1] = 0;
               deferred_callbacks[2] = 0;
               deferred_callbacks[3] = 0}
             var result=_dS_[2],callbacks=_dS_[1];
    ...
    function wakeup(r,v)
     {var p=underlying(r),_dQ_=p[1];
      switch(_dQ_[0])
       {case 1:
         return _dQ_[1] === Canceled
                 ?0
                 :caml_call1(ksprintf(invalid_arg,_bQ_),api_function_name);
        case 2:var result=[0,v];resolve(_bR_,0,p,result);return 0;
        default:
         return caml_call1(ksprintf(invalid_arg,_bP_),api_function_name)}}
    ...
    function make_into_proxy(outer_promise,user_provided_promise)
     {var p=underlying(user_provided_promise);
      ...
      var _dP_=p[1];
      switch(_dP_[0])
       {case 1:return resolve(_bT_,0,outer_promise,p[1]);
        case 2:
         var
          p_callbacks=_dP_[1],
         ...
         var
          _dN_=p_callbacks[2],
          _dO_=outer_callbacks[2],
          cancel_callbacks=
           typeof _dO_ === "number"
            ?_dN_
            :typeof _dN_ === "number"?_dO_:[0,_dO_,_dN_];
        ...
        default:return resolve(_bS_,0,outer_promise,p[1])}}
      ...
      function create_result_promise_and_callback_if_deferred(param)
       {var p=new_pending([0,p$0]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
           {var p$2=underlying(p);resolve(_bU_,0,p$2,p_result);return 0}
          var v=p_result[1];
          current_storage[1] = saved_storage;
          try
           {var _dM_=caml_call1(f,v),p$0=_dM_}
       ...
       {case 1:return [0,_dK_];
        case 2:
         var
          ...
          node$0=[1,callback],
          _dJ_=p_callbacks[1],
          node=typeof _dJ_ === "number"?node$0:[0,node$0,_dJ_];
         p_callbacks[1] = node;
         return p$1;
        default:
         var
         ...
         return run_callback_or_defer_it
                 (_bV_,function(param){return caml_call1(f,v)},_dL_)}}
    var pause_hook=[0,function(_dI_){return 0}],s1=create(0),_bY_=[0,0];
    function wakeup_paused(param)
     {if(s1[2] === s1){_bY_[1] = 0;return 0}
      var seq=create(0);
      seq[1][2] = s1[2];
      s1[2][1] = seq[1];
      seq[1] = s1[1];
    ...
    function sleep(d)
     {var t=new_pending(1),d$0=d * 1000.;
      function callback(_dG_){return wakeup(t,_dG_)}
      var id=[0,0];
      function loop(step,param)
       {if(2147483000. < step)
        ...
        var cb=remain == 0.?callback:function(_dF_){return loop(remain,_dF_)};
        id[1] = [0,window.setTimeout(caml_js_wrap_callback(cb),step$0)];
        return 0}
      loop(d$0,0);
      function f(param)
       {var _dE_=id[1];
        if(_dE_){var x=_dE_[1];id[1] = 0;return window.clearTimeout(x)}
        return 0}
    ...
    function count(c,s)
     {var n=[0,0],_dA_=caml_ml_string_length(s) - 1 | 0,_dz_=0;
      if(! (_dA_ < 0))
       {var i=_dz_;
        for(;;)
    ...
    function push(c,v)
     {var _dx_=c[12];
      ...
      var _dy_=c[7];
      c[7] = [0,caml_call1(c[1][21],v),_dy_];
      return 0}
    ...
    function style_change(c,style)
     {var _dv_=0 === style?c[3]:c[2];
      if(_dv_)
       {var _dw_=c[12];
        if(typeof _dw_ !== "number" && 0 === _dw_[0])
         {var stack=_dw_[3],inline=_dw_[2],s=_dw_[1];
          if(s === style)return pop_style(c,style,inline,stack)}
        return 0 === style?push_string(c,_b0_):push_string(c,_b1_)}
      c[12] = [0,style,c[7],c[12]];
      c[7] = 0;
      return set_style(c,style,1)}
    function pop_link(c,addr,stack)
     {c[12] = stack;
      var _dt_=c[7],_du_=rev(c[8]);
      c[7] = [0,caml_call2(c[1][7],addr,_du_),_dt_];
      c[8] = 0;
      c[5] = 0;
      return 0}
     ...
     {var _dq_=c[12];
      if(typeof _dq_ !== "number")
       switch(_dq_[0])
        {case 5:
          var _dr_=c[12];
          c[12] = [6,[0,[0,0,rev(c[7])],0],_dr_];
          c[7] = 0;
          return 1;
         case 6:return 1;
         case 7:
          var _ds_=_dq_[2];
          if(typeof _ds_ !== "number" && 6 === _ds_[0])
           {var stack=_ds_[2],entries=_ds_[1],heading=_dq_[1];
        ...
        if(typeof _do_ !== "number")
         switch(_do_[0])
          {case 5:return 1;
           case 6:
            var _dp_=_do_[2];
            if(typeof _dp_ !== "number" && 5 === _dp_[0])
             {var rows=_dp_[1],entries=_do_[1];
     ...
     {for(;;)
       {var _de_=c[12];
        if(typeof _de_ === "number")
         {if(0 !== c[7])
           {var _df_=c[11],_dg_=rev(c[7]);
            c[11] = [0,caml_call1(c[1][9],_dg_),_df_];
            c[7] = 0}
          c[12] = 0;
          return 0}
        else
         switch(_de_[0])
          {case 0:
            var stack=_de_[3],inline=_de_[2],style=_de_[1];
            pop_style(c,style,inline,stack);
            continue;
           case 1:
            var stack$0=_de_[2],addr=_de_[1];
            pop_link(c,addr,stack$0);
            continue;
           case 2:
            var l=_de_[1],switcher=l - 1 | 0;
            if(4 < switcher >>> 0)
             var f=c[1][16];
            else
             switch(switcher)
            ...
            var _dh_=c[11];
            c[11] = [0,caml_call1(f,rev(c[7])),_dh_];
            c[7] = 0;
            c[4] = 0;
            c[12] = 0;
            return 0;
           case 3:
            var stack$1=_de_[1],_di_=c[10];
            c[10] = [0,[0,rev(c[7]),0],_di_];
            c[12] = stack$1;
            c[7] = 0;
            continue;
           case 4:
            var stack$2=_de_[3],lst=_de_[2],kind=_de_[1],_dj_=lev < c[6]?1:0;
            if(_dj_)
             {c[6] = c[6] - 1 | 0;
              var
               ...
               {if(lst)
                 {var _dk_=lst[1];
                  if(_dk_[2])
                   ...
                   {var rem=lst[2],l$0=_dk_[1];
                    c[10] = [0,[0,l$0,[0,cur_lst]],rem];
                    var switch$0=1}}
                else
                 var switch$0=0;
                if(! switch$0)throw [0,Assert_failure,_b3_]}
              c[12] = stack$2;
              continue}
            return _dj_;
           case 5:
            var rows=_de_[1],_dl_=c[11],_dm_=rev(rows);
            c[11] = [0,caml_call1(c[1][20],_dm_),_dl_];
            c[12] = 0;
            return 0;
           case 6:throw [0,Assert_failure,_b4_];
           default:close_row(c);continue}}}
    function start_list_item(c,kind,lev)
     {var _db_=lev === (c[6] + 1 | 0)?1:0;
      if(_db_)
       var _dc_=_db_,switch$0=0;
      else
       {var _dd_=lev <= c[6]?1:0;
        if(_dd_)
             ...
             switch(stack[0])
              {case 0:var stack$0=stack[3],stack=stack$0;continue;
               ...
               case 4:
                ...
                break;
               default:var switch$1=1}
            if(switch$1)throw [0,Assert_failure,_b5_];
            break}}
        else
         var _dc_=_dd_,switch$0=0}
      if(! switch$0)var correct=_dc_;
    ...
    function start_table_row(c,heading)
     {if(1 - close_row(c)){end_paragraph(c,0);c[12] = _b6_}
          ...
          switch(ocaml_lex_state$0)
           {case 0:end_paragraph(c,0);continue a;
            ...
            case 4:
             end_paragraph(c,0);
             var _c8_=c[11];
             c[11] = [0,caml_call1(c[1][19],0),_c8_];
             continue a;
            case 5:
             end_paragraph(c,0);
             b:
               ...
               for(;;)
                {var
                 ...
                 switch(ocaml_lex_state$2)
                  {case 0:
                    var s$0=lexeme(lexbuf),_c9_=c[9];
                    c[9]
                    =
                    [0,sub$0(s$0,1,caml_ml_string_length(s$0) - 1 | 0),_c9_];
                    continue b;
                   case 1:
                    var _c__=c[11],_c$_=rev(c[9]);
                    c[11] = [0,caml_call1(c[1][10],_c$_),_c__];
                    c[9] = 0;
                    if(counter < 50)
                     {var counter$6=counter + 1 | 0;
                   ...
                   default:
                    var _da_=c[9];c[9] = [0,lexeme(lexbuf),_da_];continue b}}}
            case 6:
             start_table_row(c,0);
             if(counter < 50)
              {var counter$3=counter + 1 | 0;
           ...
           {case 0:
            ...
            case 4:
             ...
             var
              ...
              _cW_=c[7],
              _cX_=[0,caml_call1(c[1][1],addr),0];
             c[7] = [0,caml_call2(c[1][7],addr,_cX_),_cW_];
             continue a;
            case 5:
             if(c[5])return push_chars(c,lexbuf);
             var
              ...
              _cY_=c[7],
              _cZ_=[0,caml_call1(c[1][1],addr$0),0];
             c[7] = [0,caml_call2(c[1][8],addr$0,_cZ_),_cY_];
             continue a;
            case 6:
             if(c[5])
              push_chars(c,lexbuf);
            ...
            case 7:
             ...
             if(typeof _c0_ === "number")
              ...
              if(1 === _c0_[0])
               {var stack=_c0_[2],addr$2=_c0_[1];
            ...
            case 8:
             ...
             var
              ...
              _c1_=c[7],
              _c2_=[0,caml_call1(c[1][1],addr$3),0];
             c[7] = [0,caml_call2(c[1][7],addr$3,_c2_),_c1_];
             continue a;
            ...
            case 11:
             var
              ...
              _c3_=caml_call1(c[1][1],txt),
              _c4_=[0,caml_call1(c[1][21],_c3_),0];
             push(c,caml_call1(c[1][6],_c4_));
             continue a;
            case 12:
        ...
        map
         (function(param)
           {var l=param[2],c=param[1];
            if(l)var v=l[1],_cU_=[0,v,0];else var _cU_=0;
            var _cV_=append(c,_cU_);
            return symbol$0(d.createElement("li"),_cV_)},
          c);
      return symbol$0(d.createElement(tag.toString()),_cT_)}
    function _b9_(x){return x}
    function _b__(rows)
     {var
       rows$0=
        map
         (function(entries)
           {var
             _cS_=
              map
               (function(param)
                 {var c=param[2],h=param[1],kind=h?_b$_:_ca_;
                  return symbol$0(doc.createElement(kind.toString()),c)},
                entries);
            return symbol$0(doc.createElement("tr"),_cS_)},
          rows),
       _cR_=[0,symbol$0(doc.createElement("tbody"),rows$0),0];
      return symbol$0(doc.createElement("table"),_cR_)}
    function _cb_(param){return doc.createElement("hr")}
    function _cc_(s){return list_builder(doc,_cd_,s)}
    function _ce_(s){return list_builder(doc,_cf_,s)}
    function _cg_(s){return symbol$0(doc.createElement("h6"),s)}
    function _ch_(s){return symbol$0(doc.createElement("h5"),s)}
    function _ci_(s){return symbol$0(doc.createElement("h4"),s)}
    function _cj_(s){return symbol$0(doc.createElement("h3"),s)}
    function _ck_(s){return symbol$0(doc.createElement("h2"),s)}
    function _cl_(s){return symbol$0(doc.createElement("h1"),s)}
    function _cm_(s)
           ...
           {var _cL_=param[2],_cM_=param[1];
            if(_cL_)
             {var
               ...
               param=_cL_;
              continue}
            var _cP_=caml_ml_string_length(_cM_) + acc | 0}
          else
           var _cP_=acc;
          var dst=caml_create_bytes(_cP_),pos=pos$1,param$0=s;
          for(;;)
           {if(param$0)
             {var _cN_=param$0[2],_cO_=param$0[1];
              if(_cN_)
               {caml_blit_string(_cO_,0,dst,pos,caml_ml_string_length(_cO_));
                caml_blit_string
                 (sep,0,dst,pos + caml_ml_string_length(_cO_) | 0,0);
                var
                 pos$0=pos + caml_ml_string_length(_cO_) | 0 | 0,
                 pos=pos$0,
                 param$0=_cN_;
                continue}
              caml_blit_string(_cO_,0,dst,pos,caml_ml_string_length(_cO_))}
            var _cQ_=caml_string_of_bytes(dst);
            break}
          break}}
      else
       var _cQ_=_o_;
      appendChild(p,doc.createTextNode(_cQ_.toString()));
      return p}
    function _cn_(s){return symbol$0(doc.createElement("p"),s)}
    function _co_(addr,s)
     {var i=unsafeCreateElement(doc,_bM_);
      i.width = "480";
      i.height = "360";
      var
       s$0=addr.toString(),
       video_link=symbol(_cp_,caml_js_to_string(window.encodeURI(s$0)));
      i.src = video_link.toString();
      i.frameBorder = "0";
      return i}
    function _cq_(addr,s)
     {var a=unsafeCreateElement(doc,_bK_);
      a.href = addr.toString();
      return symbol$0(a,s)}
    function _cr_(s){return symbol$0(doc.createElement("tt"),s)}
    function _cs_(addr,alt)
     {var i=unsafeCreateElement(doc,_bL_);
      i.src = addr.toString();
      i.alt = alt.toString();
      return i}
    function _ct_(param){return doc.createElement("br")}
    function _cu_(s){return symbol$0(doc.createElement("em"),s)}
    function _cv_(s){return symbol$0(doc.createElement("strong"),s)}
    var
     b=
      [0,
    ...
    function xml_of_wiki(s)
     {var
       ...
       _cH_=0,
       _cI_=0,
       _cJ_=caml_ml_string_length(s),
       _cB_=copy(caml_bytes_of_string(s)),
       lexbuf=
        [0,
      ...
      parse_bol(c,lexbuf);
      var _cK_=rev(c[11]);
      return symbol$0(createDiv(doc),_cK_)}
    ...
    function f$0(param)
     {var body=doc.getElementById("wiki_demo");
      if(body == no_handler)throw [0,Assert_failure,_cw_];
      var textbox=unsafeCreateElementEx(0,0,doc,_bH_);
      textbox.rows = 20;
      textbox.cols = 80;
      textbox.value
      =
      ...
      appendChild(body,unsafeCreateElement(doc,_bJ_));
      ...
      function dyn_preview(old_text,n)
       {var text=caml_js_to_string(textbox.value);
        if(caml_string_notequal(text,old_text))
         ...
         var n$0=max(0,n - 1 | 0);
        function _cy_(param){return dyn_preview(text,n$0)}
        var _cz_=0 === n$0?0.5:0.1;
        return symbol_bind(sleep(_cz_),_cy_)}
      dyn_preview(_cx_,0);
      return false$0}
    window.onload
    =
