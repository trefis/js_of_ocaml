...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _cr_=caml_new_string("http://youtube.com/embed/"),
     _ch_=caml_new_string("ul"),
     _cf_=caml_new_string("ol"),
     _cb_=caml_new_string("th"),
     _cc_=caml_new_string("td"),
     _cy_=[0,caml_new_string("examples/wiki/main.ml"),33,70],
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_gh_ = caml_wrap_exception(_gh_);
              if(_gh_[1] !== Sys_error)throw _gh_}
            var param$0=l;
            continue}
          return 0}}
    ...
    function engine(tbl,state,buf)
     {var result=caml_lex_engine(tbl,state,buf);
      if(0 <= result)
       {buf[11] = buf[12];
        var _gg_=buf[12];
        buf[12] = [0,_gg_[1],_gg_[2],_gg_[3],buf[4] + buf[6] | 0]}
      return result}
       ...
       switch(formatting_lit[0])
        {case 0:var str=formatting_lit[1];return str;
         ...
         default:
          ...
          return _a_(_y_,caml_string_of_bytes(make(1,c)))}}
       ...
       switch(ty1[0])
        {case 0:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_fy_,rest2)];
         ...
         case 1:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_fz_,rest2$0)];
         ...
         case 2:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_fA_,rest2$1)];
         ...
         case 3:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_fB_,rest2$2)];
         ...
         case 4:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_fC_,rest2$3)];
         ...
         case 5:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_fD_,rest2$4)];
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_fE_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_fF_,rest2$6)];
         ...
         case 8:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_fI_=trans(_fG_,rest2$7);
              return [8,trans(_fH_,ty2),_fI_];
            ...
            {case 8:var switch$0=5,switch$10=0;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_fK_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_fL_,ty22,trans(_fJ_,rest2$8)];
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_fM_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_fN_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_fO_,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_fP_,rest2$12)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$14=0;break;
             ...
             case 14:var rest2$13=match[1];return [14,trans(_fQ_,rest2$13)];
        ...
        {case 0:
         ...
         case 2:
          ...
          if(typeof _e5_ !== "number" && 1 === _e5_[0])
           {var
             ...
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_e6_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _e7_=type_padding(pad$0,fmtty),
           _e8_=_e7_[2],
           _e9_=_e7_[1];
         ...
         case 4:
          var
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _e__=type_padprec(pad$1,prec,fmtty),
           _e$_=_e__[3],
           _fa_=_e__[2],
           _fb_=_e__[1];
          if(typeof _e$_ !== "number" && 2 === _e$_[0])
           {var
             fmtty_rest$3=_e$_[1],
             match$3=type_format_gen(fmt_rest$3,fmtty_rest$3),
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_fb_,_fa_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _fc_=type_padprec(pad$2,prec$0,fmtty),
           _fd_=_fc_[3],
           _fe_=_fc_[2],
           _ff_=_fc_[1];
          if(typeof _fd_ !== "number" && 3 === _fd_[0])
           {var
             fmtty_rest$4=_fd_[1],
             match$4=type_format_gen(fmt_rest$4,fmtty_rest$4),
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_ff_,_fe_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _fg_=type_padprec(pad$3,prec$1,fmtty),
           _fh_=_fg_[3],
           _fi_=_fg_[2],
           _fj_=_fg_[1];
          if(typeof _fh_ !== "number" && 4 === _fh_[0])
           {var
             fmtty_rest$5=_fh_[1],
             match$5=type_format_gen(fmt_rest$5,fmtty_rest$5),
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_fj_,_fi_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _fk_=type_padprec(pad$4,prec$2,fmtty),
           _fl_=_fk_[3],
           _fm_=_fk_[2],
           _fn_=_fk_[1];
          if(typeof _fl_ !== "number" && 5 === _fl_[0])
           {var
             fmtty_rest$6=_fl_[1],
             match$6=type_format_gen(fmt_rest$6,fmtty_rest$6),
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_fn_,_fm_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _fo_=type_padprec(pad$5,prec$3,fmtty),
           _fp_=_fo_[3],
           _fq_=_fo_[2],
           _fr_=_fo_[1];
          if(typeof _fp_ !== "number" && 6 === _fp_[0])
           {var
             fmtty_rest$7=_fp_[1],
             match$7=type_format_gen(fmt_rest$7,fmtty_rest$7),
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_fr_,_fq_,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           pad$6=fmt[1],
           _fs_=type_padding(pad$6,fmtty),
           _ft_=_fs_[2],
           _fu_=_fs_[1];
          if(typeof _ft_ !== "number" && 7 === _ft_[0])
           {var
             fmtty_rest$8=_ft_[1],
             match$8=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$8[2],
             fmt$9=match$8[1];
            return [0,[9,_fu_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _fv_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_fv_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _fw_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_fw_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_fw_[1];
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _e1_=2 === padty$0?48:32,res=make(width$0,_e1_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           _eZ_=match$0 - 32 | 0,
           switch$0=
            59 < _eZ_ >>> 0?33 < (_eZ_ - 61 | 0) >>> 0?1:0:2 === _eZ_?1:0;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _eS_=caml_ml_bytes_length(s$0) - 1 | 0,
           _eR_=0;
          if(! (_eS_ < 0))
           {var i$0=_eR_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0);
              if(32 <= match)
               {var _eW_=match - 34 | 0;
                if(58 < _eW_ >>> 0)
                 if(93 <= _eW_)var switch$1=0,switch$2=0;else var switch$2=1;
                else
                 if(56 < (_eW_ - 1 | 0) >>> 0)
                  var switch$1=1,switch$2=0;
                 else
                  var switch$2=1;
                if(switch$2)var _eX_=1,switch$1=2}
              else
               var switch$1=11 <= match?13 === match?1:0:8 <= match?1:0;
              switch(switch$1)
               {case 0:var _eX_=4;break;case 1:var _eX_=2;break}
              n[1] = n[1] + _eX_ | 0;
              var _eY_=i$0 + 1 | 0;
              if(_eS_ !== i$0){var i$0=_eY_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _eU_=caml_ml_bytes_length(s$0) - 1 | 0,_eT_=0;
            if(! (_eU_ < 0))
             {var i=_eT_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i);
                ...
                break}}
            var _e0_=s}
          var str$0=caml_string_of_bytes(_e0_)}
        var l=caml_ml_string_length(str$0),res=make(l + 2 | 0,34);
        caml_blit_string(str$0,0,res,1,l);
        return caml_string_of_bytes(res)}}
    function convert_int(iconv,n)
     {switch(iconv)
       {case 0:var _eQ_=_af_;break;
        case 1:var _eQ_=_ag_;break;
        case 2:var _eQ_=_ah_;break;
        case 3:var _eQ_=_ai_;break;
        case 4:var _eQ_=_aj_;break;
        case 5:var _eQ_=_ak_;break;
        case 6:var _eQ_=_al_;break;
        case 7:var _eQ_=_am_;break;
        case 8:var _eQ_=_an_;break;
        case 9:var _eQ_=_ao_;break;
        case 10:var _eQ_=_ap_;break;
        case 11:var _eQ_=_aq_;break;
        default:var _eQ_=_ar_}
      return caml_format_int(_eQ_,n)}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 0:var _eP_=_aF_;break;
        case 1:var _eP_=_aG_;break;
        case 2:var _eP_=_aH_;break;
        case 3:var _eP_=_aI_;break;
        case 4:var _eP_=_aJ_;break;
        case 5:var _eP_=_aK_;break;
        case 6:var _eP_=_aL_;break;
        case 7:var _eP_=_aM_;break;
        case 8:var _eP_=_aN_;break;
        case 9:var _eP_=_aO_;break;
        case 10:var _eP_=_aP_;break;
        case 11:var _eP_=_aQ_;break;
        default:var _eP_=_aR_}
      return caml_format_int(_eP_,n)}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 0:var _eO_=_aS_;break;
        case 1:var _eO_=_aT_;break;
        case 2:var _eO_=_aU_;break;
        case 3:var _eO_=_aV_;break;
        case 4:var _eO_=_aW_;break;
        case 5:var _eO_=_aX_;break;
        case 6:var _eO_=_aY_;break;
        case 7:var _eO_=_aZ_;break;
        case 8:var _eO_=_a0_;break;
        case 9:var _eO_=_a1_;break;
        case 10:var _eO_=_a2_;break;
        case 11:var _eO_=_a3_;break;
        default:var _eO_=_a4_}
      return caml_format_int(_eO_,n)}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 0:var _eN_=_as_;break;
        case 1:var _eN_=_at_;break;
        case 2:var _eN_=_au_;break;
        case 3:var _eN_=_av_;break;
        case 4:var _eN_=_aw_;break;
        case 5:var _eN_=_ax_;break;
        case 6:var _eN_=_ay_;break;
        case 7:var _eN_=_az_;break;
        case 8:var _eN_=_aA_;break;
        case 9:var _eN_=_aB_;break;
        case 10:var _eN_=_aC_;break;
        case 11:var _eN_=_aD_;break;
        default:var _eN_=_aE_}
      return caml_int64_format(_eN_,n)}
        ...
        if(19 <= fconv)
         {var s=caml_bytes_of_string(s$0),l=caml_ml_bytes_length(s);
          if(0 === l)
           ...
           {var r=caml_create_bytes(l),_eG_=l - 1 | 0,_eF_=0;
            if(! (_eG_ < 0))
             {var i=_eF_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s,i);
                if(97 <= c)
                 if(122 < c)
                  ...
                  var _eH_=c - 32 | 0,switch$1=1;
                else
                 var switch$1=0;
                if(! switch$1)var _eH_=c;
                caml_bytes_unsafe_set(r,i,_eH_);
                var _eI_=i + 1 | 0;
                if(_eG_ !== i){var i=_eI_;continue}
                break}}
            var _eJ_=r}
          return caml_string_of_bytes(_eJ_)}
        return s$0}
      if(15 === fconv)
       var _eK_=_a5_;
      else
       {var prec=abs(prec$0);
        ...
        var _eK_=buffer_contents(buf)}
      var str=caml_format_float(_eK_,x);
      if(15 === fconv)
        ...
        for(;;)
         {if(i$0 === len)
           ...
           {var
             ...
             _eL_=match - 46 | 0,
             switch$2=
              23 < _eL_ >>> 0?55 === _eL_?1:0:21 < (_eL_ - 1 | 0) >>> 0?1:0;
            if(! switch$2){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
            var _eM_=1}
          return _eM_?str:_a_(str,_a9_)}}
      return str}
    function make_int_padding_precision(k,o,acc,fmt,pad,match,trans,iconv)
     {if(typeof pad === "number")
       ...
       {if(0 === pad[0])
         {var _eC_=pad[2],_eD_=pad[1];
          if(typeof match === "number")
           return 0 === match
                   ?function(x)
                     {var str=fix_padding(_eD_,_eC_,caml_call2(trans,iconv,x));
                      return make_printf(k,o,[4,acc,str],fmt)}
                   :function(p,x)
                     {var
                       str=
                        fix_padding
                         (_eD_,_eC_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,o,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_eD_,_eC_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,o,[4,acc,str],fmt)}}
        var _eE_=pad[1];
        if(typeof match === "number")
         return 0 === match
                 ?function(w,x)
                   {var str=fix_padding(_eE_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,o,[4,acc,str],fmt)}
                 :function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_eE_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,o,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_eE_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,o,[4,acc,str],fmt)}}}
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _ey_=pad$5[2],_ez_=pad$5[1];
               if(typeof prec$3 === "number")
                return 0 === prec$3
                        ?function(x)
                          {var
                            str=convert_float(fconv,default_float_precision,x),
                            str$0=fix_padding(_ez_,_ey_,str);
                           return make_printf(k$0,o,[4,acc$0,str$0],rest$7)}
                        :function(p,x)
                          {var str=fix_padding(_ez_,_ey_,convert_float(fconv,p,x));
                           return make_printf(k$0,o,[4,acc$0,str],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_ez_,_ey_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,o,[4,acc$0,str],rest$7)}}
             var _eA_=pad$5[1];
             if(typeof prec$3 === "number")
              return 0 === prec$3
                      ?function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision,x),
                          str$0=fix_padding(_eA_,w,str);
                         return make_printf(k$0,o,[4,acc$0,str$0],rest$7)}
                      :function(w,p,x)
                        {var str=fix_padding(_eA_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,o,[4,acc$0,str],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_eA_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,o,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _eB_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _eB_[2] === "number")
              {var fmt=_eB_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,o,acc$0,rest$19,arity,_ex_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,o,acc$0,rest$19,arity,_ex_])}}
    ...
    function make_invalid_arg(counter,k,o,acc,fmt)
     {var _eu_=[8,acc,_be_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_eu_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_eu_,fmt])}
    function make_custom$0(counter,k,o,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_et_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_et_,rest])}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_eo_=0;
      return make_printf
              (function(o,acc){output_acc(o,acc);return 0},oc,_eo_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bm_;
      var _em_=other_fields(x,i + 1 | 0),_en_=field(x,i);
      return caml_call2(sprintf(_bn_),_en_,_em_)}
    function fields(x)
     {var match=x.length - 1;
      if(2 < match >>> 0)
       {var _ej_=other_fields(x,2),_ek_=field(x,1);
        return caml_call2(sprintf(_bo_),_ek_,_ej_)}
      switch(match)
       {case 0:return _bp_;
        case 1:return _bq_;
        default:var _el_=field(x,1);return caml_call1(sprintf(_br_),_el_)}}
        ...
        for(;;)
         {if(param$0)
           {var tl=param$0[2],hd=param$0[1];
            try {var _eh_=caml_call1(hd,x),_eg_=_eh_}catch(_ei_){var _eg_=0}
            if(_eg_){var s=_eg_[1];return s}
            var param$0=tl;
            continue}
    ...
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _ee_=a.length - 1 - 1 | 0,_ed_=0;
        if(! (_ee_ < 0))
         {var i=_ed_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _d9_=slot[4],
              _d__=slot[3],
              _d$_=slot[6]?_bB_:_bD_,
              _ea_=slot[2],
              _eb_=info(slot[1]),
              match=
               [0,caml_call6(sprintf(_bC_),_eb_,_ea_,_d$_,_d__,_d9_,_d8_)];
            else
             if(slot[1])
              var match=0;
             else
              var _ec_=info(0),match=[0,caml_call1(sprintf(_bE_),_ec_)];
    ...
    function unsafeCreateElementEx(type,name,doc$0,elt)
     {for(;;)
       {if(0 === type)if(0 === name)return createElement(doc$0,elt);
        var _d2_=createElementSyntax[1];
        if(785140586 === _d2_)
         {try
           {var
             el=doc.createElement('<input name="x">'),
             _d5_=el.tagName.toLowerCase() === "input"?1:0,
             _d6_=_d5_?el.name === "x"?1:0:_d5_,
             _d3_=_d6_}
          catch(_d7_){var _d3_=0}
          var _d4_=_d3_?982028505:-1003883683;
          createElementSyntax[1] = _d4_;
          continue}
        if(982028505 <= _d2_)
     ...
     {var _d1_=p[1];
      switch(_d1_[0])
       {case 0:return p;
        ...
        case 2:return p;
        default:
         var p$0=_d1_[1],p$1=underlying(p$0);
    ...
    function handle_with_async_exception_hook(f,v)
     {try
       {var _d0_=caml_call1(f,v);return _d0_}
      catch(exn)
     ...
     {if(1 === result[0])
      ...
      if(is_canceled)
       {var
        ...
        iter_callback_list(_dW_,0)}
      var _dX_=callbacks[1];
      ...
      return iter_callback_list$0(_dX_,0)}
    var
      ...
      if(1 === current_callback_nesting_depth[1])
       for(;;)
        {if(0 !== deferred_callbacks[1])
          {var _dT_=deferred_callbacks[2];
           if(_dT_)
            {var _dU_=_dT_[1],_dV_=_dT_[2];
             if(_dV_)
              {deferred_callbacks[1] = deferred_callbacks[1] - 1 | 0;
               deferred_callbacks[2] = _dV_}
             else
              {deferred_callbacks[1] = 0;
               deferred_callbacks[2] = 0;
               deferred_callbacks[3] = 0}
             var result=_dU_[2],callbacks=_dU_[1];
    ...
    function wakeup(r,v)
     {var p=underlying(r),_dS_=p[1];
      switch(_dS_[0])
       {case 1:
         return _dS_[1] === Canceled
                 ?0
      ...
      switch(_dR_[0])
       {case 1:return resolve(_bU_,0,outer_promise,p[1]);
        case 2:
         ...
         var
          _dP_=p_callbacks[2],
          _dQ_=outer_callbacks[2],
          cancel_callbacks=
           typeof _dQ_ === "number"
            ?_dP_
            :typeof _dP_ === "number"?_dQ_:[0,_dQ_,_dP_];
       ...
       {var p=new_pending([0,p$0]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
          ...
          try
           {var _dO_=caml_call1(f,v),p$0=_dO_}
       ...
       {case 1:return [0,_dM_];
        case 2:
         var
          ...
          node$0=[1,callback],
          _dL_=p_callbacks[1],
          node=typeof _dL_ === "number"?node$0:[0,node$0,_dL_];
         p_callbacks[1] = node;
         return p$1;
        default:
         var
         ...
         return run_callback_or_defer_it
                 (_bW_,function(param){return caml_call1(f,v)},_dN_)}}
    var pause_hook=[0,function(_dK_){return 0}],s1=create(0),_bZ_=[0,0];
        ...
        map
         (function(param)
           {var l=param[2],c=param[1];
            ...
            return _b__(d.createElement("li"),_cX_)},
          c);
      return _b__(d.createElement(tag.toString()),_cV_)}
    function _b$_(x){return x}
    function _ca_(rows)
     {var
       rows$0=
        map
         (function(entries)
           {var
             _cU_=
              map
               (function(param)
                 {var c=param[2],h=param[1],kind=h?_cb_:_cc_;
                  return _b__(doc.createElement(kind.toString()),c)},
                entries);
            return _b__(doc.createElement("tr"),_cU_)},
          rows),
       _cT_=[0,_b__(doc.createElement("tbody"),rows$0),0];
      return _b__(doc.createElement("table"),_cT_)}
    function _cd_(param){return doc.createElement("hr")}
    function _ce_(s){return list_builder(doc,_cf_,s)}
    function _cg_(s){return list_builder(doc,_ch_,s)}
    function _ci_(s){return _b__(doc.createElement("h6"),s)}
    function _cj_(s){return _b__(doc.createElement("h5"),s)}
    function _ck_(s){return _b__(doc.createElement("h4"),s)}
    function _cl_(s){return _b__(doc.createElement("h3"),s)}
    function _cm_(s){return _b__(doc.createElement("h2"),s)}
    function _cn_(s){return _b__(doc.createElement("h1"),s)}
    function _co_(s)
     {var p=doc.createElement("pre");
      if(s)
       {var acc=0,param=s,pos$1=0;
        for(;;)
         {if(param)
           {var _cN_=param[2],_cO_=param[1];
            if(_cN_)
             {var
               x=(caml_ml_string_length(_cO_) | 0) + acc | 0,
               acc$0=acc <= x?x:invalid_arg(_o_),
               acc=acc$0,
               param=_cN_;
              continue}
            var _cR_=caml_ml_string_length(_cO_) + acc | 0}
          else
           var _cR_=acc;
          var dst=caml_create_bytes(_cR_),pos=pos$1,param$0=s;
          for(;;)
           {if(param$0)
             {var _cP_=param$0[2],_cQ_=param$0[1];
              if(_cP_)
               {caml_blit_string(_cQ_,0,dst,pos,caml_ml_string_length(_cQ_));
                caml_blit_string
                 (sep,0,dst,pos + caml_ml_string_length(_cQ_) | 0,0);
                var
                 pos$0=pos + caml_ml_string_length(_cQ_) | 0 | 0,
                 pos=pos$0,
                 param$0=_cP_;
                continue}
              caml_blit_string(_cQ_,0,dst,pos,caml_ml_string_length(_cQ_))}
            var _cS_=caml_string_of_bytes(dst);
            break}
          break}}
      else
       var _cS_=_p_;
      ...
      return p}
    function _cp_(s){return _b__(doc.createElement("p"),s)}
    function _cq_(addr,s)
     {var i=unsafeCreateElement(doc,_bN_);
      ...
      var
       s$0=addr.toString(),
       video_link=_a_(_cr_,caml_js_to_string(window.encodeURI(s$0)));
      i.src = video_link.toString();
      i.frameBorder = "0";
      return i}
    function _cs_(addr,s)
     {var a=unsafeCreateElement(doc,_bL_);
      a.href = addr.toString();
      return _b__(a,s)}
    function _ct_(s){return _b__(doc.createElement("tt"),s)}
    function _cu_(addr,alt)
     {var i=unsafeCreateElement(doc,_bM_);
      i.src = addr.toString();
      i.alt = alt.toString();
      return i}
    function _cv_(param){return doc.createElement("br")}
    function _cw_(s){return _b__(doc.createElement("em"),s)}
    function _cx_(s){return _b__(doc.createElement("strong"),s)}
    var
     b=
      [0,
    ...
    function xml_of_wiki(s)
     {var
       ...
       _cJ_=0,
       _cK_=0,
       _cL_=caml_ml_string_length(s),
       _cD_=copy(caml_bytes_of_string(s)),
       lexbuf=
        [0,
      ...
      parse_bol(c,lexbuf);
      var _cM_=rev(c[11]);
      return _b__(createDiv(doc),_cM_)}
    ...
    function f$0(param)
     {var body=doc.getElementById("wiki_demo");
      if(body == no_handler)throw [0,Assert_failure,_cy_];
      ...
      function dyn_preview(old_text,n)
       {var text=caml_js_to_string(textbox.value);
        if(caml_string_notequal(text,old_text))
         ...
         var n$0=max(0,n - 1 | 0);
        function _cA_(param){return dyn_preview(text,n$0)}
        var _cB_=0 === n$0?0.5:0.1;
        return bind(sleep(_cB_),_cA_)}
      dyn_preview(_cz_,0);
      return false$0}
    window.onload
    =
