...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _x_=caml_new_string("%c"),
     _y_=caml_new_string("%s"),
     _z_=caml_new_string("%i"),
     _A_=caml_new_string("%li"),
     _B_=caml_new_string("%ni"),
     _C_=caml_new_string("%Li"),
     _D_=caml_new_string("%f"),
     _E_=caml_new_string("%B"),
     _F_=caml_new_string("%{"),
     _G_=caml_new_string("%}"),
     _H_=caml_new_string("%("),
     _I_=caml_new_string("%)"),
     _J_=caml_new_string("%a"),
     _K_=caml_new_string("%t"),
     _L_=caml_new_string("%?"),
     _M_=caml_new_string("%r"),
     _N_=caml_new_string("%_r"),
     _O_=[0,caml_new_string("camlinternalFormat.ml"),847,23],
     _Z_=[0,caml_new_string("camlinternalFormat.ml"),811,21],
     _R_=[0,caml_new_string("camlinternalFormat.ml"),812,21],
     ___=[0,caml_new_string("camlinternalFormat.ml"),815,21],
     _S_=[0,caml_new_string("camlinternalFormat.ml"),816,21],
     _$_=[0,caml_new_string("camlinternalFormat.ml"),819,19],
     _T_=[0,caml_new_string("camlinternalFormat.ml"),820,19],
     _aa_=[0,caml_new_string("camlinternalFormat.ml"),823,22],
     _U_=[0,caml_new_string("camlinternalFormat.ml"),824,22],
     _ab_=[0,caml_new_string("camlinternalFormat.ml"),828,30],
     _V_=[0,caml_new_string("camlinternalFormat.ml"),829,30],
     _X_=[0,caml_new_string("camlinternalFormat.ml"),833,26],
     _P_=[0,caml_new_string("camlinternalFormat.ml"),834,26],
     _Y_=[0,caml_new_string("camlinternalFormat.ml"),843,28],
     _Q_=[0,caml_new_string("camlinternalFormat.ml"),844,28],
     _W_=[0,caml_new_string("camlinternalFormat.ml"),848,23],
     _a__=caml_new_string("%u"),
     _a8_=[0,caml_new_string("camlinternalFormat.ml"),1556,4],
     _a9_=caml_new_string("Printf: bad conversion %["),
     _a$_=[0,caml_new_string("camlinternalFormat.ml"),1624,39],
     _ba_=[0,caml_new_string("camlinternalFormat.ml"),1647,31],
     _bb_=[0,caml_new_string("camlinternalFormat.ml"),1648,31],
     _bc_=caml_new_string("Printf: bad conversion %_"),
     _bd_=caml_new_string("@{"),
     _be_=caml_new_string("@["),
     _bf_=caml_new_string("@{"),
     _bg_=caml_new_string("@["),
     _a6_=caml_new_string("nan"),
     _a7_=caml_new_string("."),
     _a4_=caml_new_string("neg_infinity"),
     _a5_=caml_new_string("infinity"),
     _a3_=caml_new_string("%.12g"),
     ...
     _v_=caml_new_string("@%"),
     _w_=caml_new_string("@"),
     _ac_=caml_new_string("CamlinternalFormat.Type_mismatch"),
     _bk_=caml_new_string(""),
     _bl_=
      [0,[11,caml_new_string(", "),[2,0,[2,0,0]]],caml_new_string(", %s%s")],
     _bD_=[0,[2,0,[12,10,0]],caml_new_string("%s\n")],
     _bE_=
      [0,
       [11,
        caml_new_string
       ...
       caml_new_string
        ("(Program not linked with -g, cannot print stack backtrace)\n")],
     _bv_=caml_new_string("Raised at"),
     _bw_=caml_new_string("Re-raised at"),
     _bx_=caml_new_string("Raised by primitive operation at"),
     _by_=caml_new_string("Called from"),
     _bz_=caml_new_string(" (inlined)"),
     ...
     _bq_=caml_new_string("Out of memory"),
     _br_=caml_new_string("Stack overflow"),
     _bs_=caml_new_string("Pattern matching failed"),
     _bt_=caml_new_string("Assertion failed"),
     _bu_=caml_new_string("Undefined recursive module"),
     ...
     _bh_=[0,[3,0,0],caml_new_string("%S")],
     _bi_=caml_new_string("_"),
     _bQ_=caml_new_string("Random.int"),
     ...
     _bR_=
      [0,
       ...
       409934019,
       801085050],
     _bS_=caml_new_string("Js_of_ocaml__Js.Error"),
     _bT_=caml_new_string("Js_of_ocaml__Dom_html.Canvas_not_available"),
     _b3_=[0,0],
     _b4_=[0,1],
     _b1_=[0,0],
     _b2_=[0,1],
     _bZ_=[0,0],
     _b0_=[0,0],
     _bW_=[0,[11,caml_new_string("Lwt."),[2,0,0]],caml_new_string("Lwt.%s")],
     _bX_=[0,[11,caml_new_string("Lwt."),[2,0,0]],caml_new_string("Lwt.%s")],
     _bY_=[0,0],
     _bU_=caml_new_string("Fatal error: exception "),
     _bV_=caml_new_string("Lwt.Resolution_loop.Canceled"),
     _b6_=caml_new_string("Exception during Lwt.async: ");
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_e__ = caml_wrap_exception(_e__);
              if(_e__[1] !== Sys_error)throw _e__;
              var _e9_=_e__}
            var param$0=l;
            continue}
          return 0}}
       ...
       if(0 <= len)
        if((caml_ml_bytes_length(b) - len | 0) < ofs)
         ...
         {var r=caml_create_bytes(len);
          ...
          var _e8_=r,switch$0=1}
       else
        var switch$0=0;
      else
       var switch$0=0;
      if(! switch$0)var _e8_=invalid_arg(_k_);
      return caml_string_of_bytes(_e8_)}
    ...
    function init(l,f)
     {if(0 === l)return [0];
      if(0 <= l)
       {var res=caml_make_vect(l,caml_call1(f,0)),_e6_=l - 1 | 0,_e5_=1;
        if(! (_e6_ < 1))
         {var i=_e5_;
          for(;;)
    ...
    function add(x,q)
     {var cell=[0,x,0],_e4_=q[3];
      return _e4_
              ?(q[1] = q[1] + 1 | 0,_e4_[2] = cell,q[3] = cell,0)
       ...
       switch(formatting_lit[0])
        {case 0:var str=formatting_lit[1];return str;
         ...
         default:
          ...
          return symbol(_w_,caml_string_of_bytes(make(1,c)))}}
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
        ...
        return [0,function(param){return 0},_eG_,_eF_,_eE_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _eH_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_eH_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _eI_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _eJ_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _eK_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _eL_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _eM_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _eN_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _eO_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _eP_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _eQ_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _eR_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _eS_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _eT_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _eU_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _eV_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _eW_=function(param){caml_call1(de$12,0);return 0},
           _eX_=function(param){caml_call1(ed$12,0);return 0},
           _eY_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _eZ_=function(param){caml_call1(de$13,0);return 0},
           _e0_=function(param){caml_call1(ed$13,0);return 0},
           _e1_=function(param){caml_call1(af$13,0);return 0};
          return [0,
       ...
       switch(ty1[0])
        {case 0:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_el_,rest2)];
         ...
         case 1:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_em_,rest2$0)];
         ...
         case 2:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_en_,rest2$1)];
         ...
         case 3:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_eo_,rest2$2)];
         ...
         case 4:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_ep_,rest2$3)];
         ...
         case 5:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_eq_,rest2$4)];
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_er_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_es_,rest2$6)];
          ...
          break;
         case 8:
          var _et_=ty1[2],_eu_=ty1[1];
          if(typeof match === "number")
           var switch$9=1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_ev_=trans(_et_,rest2$7);
              return [8,trans(_eu_,ty2),_ev_];
          ...
          break;
         case 9:
          var _ew_=ty1[3],_ex_=ty1[2],_ey_=ty1[1];
          if(typeof match === "number")
           var switch$10=1;
          else
           switch(match[0])
            {case 8:var switch$0=5,switch$10=0;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_ex_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_ey_,ty22,trans(_ew_,rest2$8)];
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_ez_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_eA_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_eB_,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_eC_,rest2$12)];
     ...
     {var match=type_padding(pad,fmtty);
      if(typeof prec === "number")
       {if(0 === prec)
        ...
        var _ek_=match[2];
        if(typeof _ek_ !== "number" && 2 === _ek_[0])
         {var rest$0=_ek_[1],pad$1=match[1];return [0,pad$1,1,rest$0]}
        throw Type_mismatch}
        ...
        {case 0:
         ...
         case 4:
          var
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _dX_=type_padprec(pad$1,prec,fmtty),
           _dY_=_dX_[3],
           _dZ_=_dX_[2],
           _d0_=_dX_[1];
          if(typeof _dY_ !== "number" && 2 === _dY_[0])
           {var
             ...
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_d0_,_dZ_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _d1_=type_padprec(pad$2,prec$0,fmtty),
           _d2_=_d1_[3],
           _d3_=_d1_[2],
           _d4_=_d1_[1];
          if(typeof _d2_ !== "number" && 3 === _d2_[0])
           {var
             fmtty_rest$4=_d2_[1],
             match$4=type_format_gen(fmt_rest$4,fmtty_rest$4),
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_d4_,_d3_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _d5_=type_padprec(pad$3,prec$1,fmtty),
           _d6_=_d5_[3],
           _d7_=_d5_[2],
           _d8_=_d5_[1];
          if(typeof _d6_ !== "number" && 4 === _d6_[0])
           {var
             fmtty_rest$5=_d6_[1],
             match$5=type_format_gen(fmt_rest$5,fmtty_rest$5),
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_d8_,_d7_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _d9_=type_padprec(pad$4,prec$2,fmtty),
           _d__=_d9_[3],
           _d$_=_d9_[2],
           _ea_=_d9_[1];
          if(typeof _d__ !== "number" && 5 === _d__[0])
           {var
             fmtty_rest$6=_d__[1],
             match$6=type_format_gen(fmt_rest$6,fmtty_rest$6),
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_ea_,_d$_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _eb_=type_padprec(pad$5,prec$3,fmtty),
           _ec_=_eb_[3],
           _ed_=_eb_[2],
           _ee_=_eb_[1];
          if(typeof _ec_ !== "number" && 6 === _ec_[0])
           {var
             fmtty_rest$7=_ec_[1],
             match$7=type_format_gen(fmt_rest$7,fmtty_rest$7),
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_ee_,_ed_,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           pad$6=fmt[1],
           _ef_=type_padding(pad$6,fmtty),
           _eg_=_ef_[2],
           _eh_=_ef_[1];
          if(typeof _eg_ !== "number" && 7 === _eg_[0])
           {var
             fmtty_rest$8=_eg_[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _ei_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_ei_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _ej_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_ej_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_ej_[1];
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _dP_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_dP_))
             throw Type_mismatch;
            var _dQ_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_dQ_))
             throw Type_mismatch;
            var
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           _dM_=match$0 - 32 | 0,
           switch$0=
            59 < _dM_ >>> 0?33 < (_dM_ - 61 | 0) >>> 0?1:0:2 === _dM_?1:0;
            ...
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0);
              if(32 <= match)
               {var _dJ_=match - 34 | 0;
                if(58 < _dJ_ >>> 0)
                 if(93 <= _dJ_)var switch$1=0,switch$2=0;else var switch$2=1;
                else
                 if(56 < (_dJ_ - 1 | 0) >>> 0)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _dx_=_ae_;break;
        case 2:var _dx_=_af_;break;
        case 4:var _dx_=_ah_;break;
        case 5:var _dx_=_ai_;break;
        case 6:var _dx_=_aj_;break;
        case 7:var _dx_=_ak_;break;
        case 8:var _dx_=_al_;break;
        case 9:var _dx_=_am_;break;
        case 10:var _dx_=_an_;break;
        case 11:var _dx_=_ao_;break;
        case 0:
        case 13:var _dx_=_ad_;break;
        case 3:
        case 14:var _dx_=_ag_;break;
        default:var _dx_=_ap_}
      return transform_int_alt(iconv,caml_format_int(_dx_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _dw_=_aE_;break;
        case 2:var _dw_=_aF_;break;
        case 4:var _dw_=_aH_;break;
        case 5:var _dw_=_aI_;break;
        case 6:var _dw_=_aJ_;break;
        case 7:var _dw_=_aK_;break;
        case 8:var _dw_=_aL_;break;
        case 9:var _dw_=_aM_;break;
        case 10:var _dw_=_aN_;break;
        case 11:var _dw_=_aO_;break;
        case 0:
        case 13:var _dw_=_aD_;break;
        case 3:
        case 14:var _dw_=_aG_;break;
        default:var _dw_=_aP_}
      return transform_int_alt(iconv,caml_format_int(_dw_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _dv_=_aR_;break;
        case 2:var _dv_=_aS_;break;
        case 4:var _dv_=_aU_;break;
        case 5:var _dv_=_aV_;break;
        case 6:var _dv_=_aW_;break;
        case 7:var _dv_=_aX_;break;
        case 8:var _dv_=_aY_;break;
        case 9:var _dv_=_aZ_;break;
        case 10:var _dv_=_a0_;break;
        case 11:var _dv_=_a1_;break;
        case 0:
        case 13:var _dv_=_aQ_;break;
        case 3:
        case 14:var _dv_=_aT_;break;
        default:var _dv_=_a2_}
      return transform_int_alt(iconv,caml_format_int(_dv_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _du_=_ar_;break;
        case 2:var _du_=_as_;break;
        case 4:var _du_=_au_;break;
        case 5:var _du_=_av_;break;
        case 6:var _du_=_aw_;break;
        case 7:var _du_=_ax_;break;
        case 8:var _du_=_ay_;break;
        case 9:var _du_=_az_;break;
        case 10:var _du_=_aA_;break;
        case 11:var _du_=_aB_;break;
        case 0:
        case 13:var _du_=_aq_;break;
        case 3:
        case 14:var _du_=_at_;break;
        default:var _du_=_aC_}
     ...
     {if(16 <= fconv)
               ...
               {var c=caml_bytes_unsafe_get(s,i);
                if(97 <= c)
                 if(122 < c)
                  ...
                  var _do_=c - 32 | 0,switch$1=1;
                else
                 var switch$1=0;
                if(! switch$1)var _do_=c;
      ...
      if(15 === fconv)
       ...
       {var prec=abs(prec$0);
        ...
        var _dr_=buffer_contents(buf)}
      var str=caml_format_float(_dr_,x);
      if(15 === fconv)
       {var len=caml_ml_string_length(str),match$0=caml_classify_float(x);
        if(3 === match$0)return x < 0.?_a4_:_a5_;
        if(4 <= match$0)return _a6_;
        var i$0=0;
        for(;;)
         {if(i$0 === len)
           var _dt_=0;
           ...
           {var
             ...
             _ds_=match - 46 | 0,
             switch$2=
              23 < _ds_ >>> 0?55 === _ds_?1:0:21 < (_ds_ - 1 | 0) >>> 0?1:0;
            if(! switch$2){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
            var _dt_=1}
          return _dt_?str:symbol(str,_a7_)}}
      return str}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bk_;
      ...
      return caml_call2(sprintf(_bl_),_c6_,_c5_)}
    function fields(x)
     {var match=x.length - 1;
      if(2 < match >>> 0)
       {var _c2_=other_fields(x,2),_c3_=field(x,1);
        return caml_call2(sprintf(_bm_),_c3_,_c2_)}
      switch(match)
       {case 0:return _bn_;
        case 1:return _bo_;
        default:var _c4_=field(x,1);return caml_call1(sprintf(_bp_),_c4_)}}
        ...
        for(;;)
         {if(param$0)
           {var tl=param$0[2],hd=param$0[1];
            try {var _c0_=caml_call1(hd,x),_cZ_=_c0_}catch(_c1_){var _cZ_=0}
            if(_cZ_){var s=_cZ_[1];return s}
            var param$0=tl;
            continue}
          if(x === Out_of_memory)return _bq_;
          if(x === Stack_overflow)return _br_;
    ...
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _cX_=a.length - 1 - 1 | 0,_cW_=0;
        if(! (_cX_ < 0))
         {var i=_cW_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _cQ_=slot[4],
              _cR_=slot[3],
              _cS_=slot[6]?_bz_:_bB_,
              _cT_=slot[2],
              _cU_=info(slot[1]),
              match=
               [0,caml_call6(sprintf(_bA_),_cU_,_cT_,_cS_,_cR_,_cQ_,_cP_)];
            else
             if(slot[1])
              var match=0;
             else
              var _cV_=info(0),match=[0,caml_call1(sprintf(_bC_),_cV_)];
            if(match){var str=match[1];caml_call1(fprintf(outchan,_bD_),str)}
            var _cY_=i + 1 | 0;
            if(_cX_ !== i){var i=_cY_;continue}
            break}}
        return 0}
      return fprintf(outchan,_bE_)}
    function register_printer(fn){printers[1] = [0,fn,printers[1]];return 0}
    var s$0=[0,_bR_.slice(),0];
    ...
    var
     d="2d",
     Canvas_not_available=[248,_bT_,caml_fresh_oo_id(0)],
    ...
    var Canceled=[248,_bV_,caml_fresh_oo_id(0)];
      ...
      if(1 === current_callback_nesting_depth[1])
       for(;;)
        {if(0 !== deferred_callbacks[1])
          {var _cD_=deferred_callbacks[2];
           if(_cD_)
            {var _cE_=_cD_[1],_cF_=_cD_[2];
             if(_cF_)
              {deferred_callbacks[1] = deferred_callbacks[1] - 1 | 0;
               deferred_callbacks[2] = _cF_}
             else
              {deferred_callbacks[1] = 0;
               deferred_callbacks[2] = 0;
               deferred_callbacks[3] = 0}
             var result=_cE_[2],callbacks=_cE_[1];
    ...
    function wakeup(r,v)
     {var p=underlying(r),_cC_=p[1];
      switch(_cC_[0])
       {case 1:
         return _cC_[1] === Canceled
                 ?0
                 :caml_call1(ksprintf(invalid_arg,_bX_),api_function_name);
        case 2:var result=[0,v];resolve(_bY_,0,p,result);return 0;
        default:
         return caml_call1(ksprintf(invalid_arg,_bW_),api_function_name)}}
    ...
    function make_into_proxy(outer_promise,user_provided_promise)
     {var p=underlying(user_provided_promise);
      ...
      var _cB_=p[1];
      switch(_cB_[0])
       {case 1:return resolve(_b0_,0,outer_promise,p[1]);
        case 2:
         var
          p_callbacks=_cB_[1],
         ...
         var
          _cz_=p_callbacks[2],
          _cA_=outer_callbacks[2],
          cancel_callbacks=
           typeof _cA_ === "number"
            ?_cz_
            :typeof _cz_ === "number"?_cA_:[0,_cA_,_cz_];
        ...
        default:return resolve(_bZ_,0,outer_promise,p[1])}}
    var pause_hook=[0,function(_cy_){return 0}],s1=create(0),_b5_=[0,0];
    ...
    for(;;)
     {caml_check_bound(s$0[1],i$0)[1 + i$0] = i$0;
      var _bP_=i$0 + 1 | 0;
      if(54 !== i$0){var i$0=_bP_;continue}
      var accu=[0,_bJ_],_bL_=54 + max(55,l) | 0,_bK_=0;
      if(! (_bL_ < 0))
       {var i=_bK_;
        for(;;)
         {var
          ...
          var
           _bM_=accu[1],
           _bF_=caml_string_get(_bM_,3) << 24,
           _bG_=caml_string_get(_bM_,2) << 16,
           _bH_=caml_string_get(_bM_,1) << 8,
           _bI_=((caml_string_get(_bM_,0) + _bH_ | 0) + _bG_ | 0) + _bF_ | 0,
           _bN_=(caml_check_bound(s$0[1],j)[1 + j] ^ _bI_) & 1073741823;
          caml_check_bound(s$0[1],j)[1 + j] = _bN_;
          var _bO_=i + 1 | 0;
          if(_bL_ !== i){var i=_bO_;continue}
          break}}
      s$0[2] = 0;
      var
       get=
              ...
              {if(0 <= j$1[1])
                {var _co_=j$1[1];
                 if
                  (!
                   caml_check_bound
                     (caml_check_bound(caml_check_bound(a,i$1)[1 + i$1],_co_)
                       [1 + _co_],
                      k$1)
                    [1 + k$1])
                  {j$1[1] += -1;continue}}
               ...
               var _cp_=k$1 + 1 | 0;
               if(11 !== k$1){var k$1=_cp_;continue b}
               var _cn_=i$1 + 1 | 0;
               if(11 !== i$1){var i$1=_cn_;continue a}
               var j$0=0;
               c:
               for(;;)
                {var i$0=[0,11],k$0=0;
                   ...
                   {if(0 <= i$0[1])
                     {var _cl_=i$0[1];
                      if
                       (!
                        caml_check_bound
                          (caml_check_bound(caml_check_bound(a,_cl_)[1 + _cl_],j$0)
                            [1 + j$0],
                           k$0)
                         [1 + k$0])
                       {i$0[1] += -1;continue}}
                    ...
                    var _cm_=k$0 + 1 | 0;
                    if(11 !== k$0){var k$0=_cm_;continue d}
                    var _ck_=j$0 + 1 | 0;
                    if(11 !== j$0){var j$0=_ck_;continue c}
                    var i=0;
                    e:
                    for(;;)
                     {var k=[0,11],j=0;
                      ...
                      for(;;)
                       for(;;)
                        {if(0 <= k[1])
                         ...
                         var _cj_=j + 1 | 0;
                         if(11 !== j){var j=_cj_;continue f}
                         var _ch_=i + 1 | 0;
                         if(11 !== i){var i=_ch_;continue e}
                         return 0}}}}}}},
       create_canvas=
        function(param)
             ...
             {var i=int$0(n),j=int$0(n),k=int$0(n);
              if
               ...
               {if(get(a,i - 1 | 0,j,k))
                 ...
                 var switch$1=0;
                if(! switch$1)var _ce_=0}
              var _cf_=_ce_ || need_redraw[1];
              need_redraw[1] = _cf_;
              var _cg_=i$0 + 1 | 0;
              if(99 !== i$0){var i$0=_cg_;continue}
              if(need_redraw[1])redraw(c$0,c,a);
              return loop(c$0,c,a)}}
          var t=new_pending(1),d=200.;
          function callback$0(_cd_){return wakeup(t,_cd_)}
          var id=[0,0];
           ...
           {if(2147483000. < step)
            ...
            var
             cb=
              remain == 0.
               ?callback$0
               :function(_cc_){return loop$0(remain,_cc_)};
            id[1] = [0,window.setTimeout(caml_js_wrap_callback(cb),step$0)];
            return 0}
          loop$0(d,0);
          function f(param)
           {var _cb_=id[1];
            if(_cb_){var x=_cb_[1];id[1] = 0;return window.clearTimeout(x)}
            return 0}
          var p$1=underlying(t),_b__=p$1[1];
          switch(_b__[0])
           {case 1:
             if(_b__[1] === Canceled)
              {var
          ...
          function create_result_promise_and_callback_if_deferred(param)
           {var p$0=new_pending([0,p]),saved_storage=current_storage[1];
            function callback(p_result)
             {if(1 === p_result[0])
               {var p$2=underlying(p$0);resolve(_b1_,0,p$2,p_result);return 0}
              var v=p_result[1];
              current_storage[1] = saved_storage;
              try
               {var _ca_=f$0(v),p=_ca_}
           ...
           {case 1:return [0,_b8_];
            case 2:
             var
              ...
              node$0=[1,callback],
              _b7_=p_callbacks[1],
              node=typeof _b7_ === "number"?node$0:[0,node$0,_b7_];
             p_callbacks[1] = node;
             return p$0;
            default:
             var
             ...
             return run_callback_or_defer_it
                     (_b2_,function(param){return f$0(v)},_b9_)}},
       f$0=
        function(param)
