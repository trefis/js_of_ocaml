...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _c_=
      [0,
       ...
       409934019,
       801085050],
     _d_=caml_new_string("Js_of_ocaml__Js.Error"),
     _h_=caml_new_string("img"),
     _g_=caml_new_string("br"),
     _f_=caml_new_string("div"),
     _e_=caml_new_string("input"),
     _j_=caml_new_string("sprites/flag.png"),
     _k_=caml_new_string("sprites/bomb.png"),
     _l_=caml_new_string("sprites/empty.png"),
     _m_=caml_new_string(".png"),
     _n_=caml_new_string("sprites/"),
     _o_=caml_new_string("sprites/normal.png"),
     _i_=[0,0,0],
     _p_=[0,caml_new_string("examples/minesweeper/main.ml"),40,65],
     _q_=caml_new_string("Number of columns"),
     _r_=caml_new_string("Number of rows"),
     _s_=caml_new_string("Number of mines");
    ...
    var
     ...
     Error=[248,_d_,caml_fresh_oo_id(0)],
     exn=[0,Error,{}],
    ...
    function createInput(type,name,doc)
     {return unsafeCreateElementEx(type,name,doc,_e_)}
    function createBr(doc){return unsafeCreateElement(doc,_g_)}
    function createImg(doc){return unsafeCreateElement(doc,_h_)}
    caml_fresh_oo_id(0);
       ...
       _az_=
        bd[3]
         ...
         :bd[1]
           ?_k_
           :bd[2]
             ?0 === bd[4]?_l_:_a_(_n_,_a_(caml_new_string("" + bd[4]),_m_))
             :_o_;
    ...
    function onload(param)
     {var main=doc.getElementById("main");
      if(main == no_handler)throw [0,Assert_failure,_p_];
      var nbm=[0,15],nbc=[0,12],nbr=[0,10];
      appendChild(main,int_input(_q_,nbr));
      appendChild(main,createBr(doc));
      appendChild(main,int_input(_r_,nbc));
      appendChild(main,createBr(doc));
      appendChild(main,int_input(_s_,nbm));
      appendChild(main,createBr(doc));
      function callback(param$5)
       {var div=unsafeCreateElement(doc,_f_);
        ...
        for(;;)
         {caml_check_bound(s$0[1],i$2)[i$2 + 1] = i$2;
          ...
          var accu$1=[0,_b_],_A_=54 + max(55,l$0) | 0,_z_=0;
          if(! (_A_ < 0))
           {var i$1=_z_;
            for(;;)
             {var
              ...
              var
               ...
               _C_=(caml_check_bound(s$0[1],j)[j + 1] ^ _y_) & 1073741823;
              caml_check_bound(s$0[1],j)[j + 1] = _C_;
              var _D_=i$1 + 1 | 0;
                 ...
                 if(0 < lc)
                  for(;;)
                   {s$0[2] = (s$0[2] + 1 | 0) % 55 | 0;
                    var
                     _F_=s$0[2],
                     curval=caml_check_bound(s$0[1],_F_)[_F_ + 1],
                     _G_=(s$0[2] + 24 | 0) % 55 | 0,
                     newval=
                      caml_check_bound(s$0[1],_G_)[_G_ + 1]
                      +
                     ...
                     r=newval & 1073741823,
                     _H_=s$0[2];
                    caml_check_bound(s$0[1],_H_)[_H_ + 1] = r;
                    var n=caml_mod(r,lc);
              ...
              iter$0
               (function(n)
                 {var _ah_=caml_mod(n,cf[2]),_ai_=caml_div(n,cf[2]);
                  caml_check_bound(caml_check_bound(b,_ai_)[_ai_ + 1],_ah_)
                    [_ah_ + 1]
                   [1]
                  =
                  1;
                ...
                for(;;)
                 {var imgs=[0,0],_T_=d[3][1] - 1 | 0,_S_=0;
                                        ...
                                        for(;;)
                                         {if(param$0)
                                           {var
                                             ...
                                             x=c[1],
                                             cell=
                                              caml_check_bound(caml_check_bound(_$_,x)[x + 1],y)[y + 1];
                                            if(! cell[1])
                                             if(! cell[3])
                                              if(! cell[2])
                                               if
                                       ...
                                       {if(param)
                                         {var l=param[2],c=param[1],y=c[2],x=c[1];
                                          if
                                           (0
                                            ===
                                            caml_check_bound(caml_check_bound(_$_,x)[x + 1],y)[y + 1][4])
                                           {var
                  ...
                  if(l$1)
                   ...
                   var _U_=[0];
                  caml_check_bound(d[2],j$0)[j$0 + 1] = _U_;
                  var _V_=j$0 + 1 | 0;
       ...
       {if(param$0)
         {var l=param$0[2],a=param$0[1];
          try
           ...
           {_t_ = caml_wrap_exception(_t_);if(_t_[1] !== Sys_error)throw _t_}
          var param$0=l;
          continue}
        return 0}}
